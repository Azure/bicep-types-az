import { Dictionary, keys, orderBy, values } from 'lodash';
import { ArrayType, BuiltInType, BuiltInTypeKind, DiscriminatedObjectType, getBuiltInTypeKindLabel, getObjectPropertyFlagsLabels, getScopeTypeLabels, ObjectProperty, ObjectPropertyFlags, ObjectType, ResourceType, ScopeType, StringLiteralType, TypeBase, TypeBaseKind, TypeReference, UnionType } from './types';
...
let output = '';
export function write(types: TypeBase[], providerNamespace: string, apiVersion: string) {
  output = '';
