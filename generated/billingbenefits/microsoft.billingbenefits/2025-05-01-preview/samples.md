...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/conditionalCredits@2025-05-01-preview' = {
  name: 'example'
  location: 'global'
  properties: {
...
CreditCreate
```bicep
resource exampleResource 'Microsoft.BillingBenefits/credits@2025-05-01-preview' = {
  name: 'example'
  location: 'global'
  properties: {
    credit: {
...
CreditSourceCreate
```bicep
resource exampleResource 'Microsoft.BillingBenefits/credits/sources@2025-05-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/discounts@2025-05-01-preview' = {
  name: 'example'
  location: 'global'
  properties: {
...
Contributor_Create
```bicep
resource exampleResource 'Microsoft.BillingBenefits/maccs@2025-05-01-preview' = {
  name: 'example'
  location: 'global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/reservationOrderAliases@2025-05-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/savingsPlanOrderAliases@2025-05-01-preview' = {
  name: 'example'
  properties: {
    appliedScopeProperties: {
    }
