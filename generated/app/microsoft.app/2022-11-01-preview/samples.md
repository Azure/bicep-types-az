...
```bicep
resource exampleResource 'Microsoft.App/containerApps/authConfigs@2022-11-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments@2022-11-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/certificates@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/daprComponents@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/storages@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps@2022-11-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
    configuration: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments@2022-11-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/certificates@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/managedCertificates@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/daprComponents@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    componentType: 'state.azure.cosmosdb'
...
Create or update environments storage
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/storages@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps/sourcecontrols@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    branch: 'master'
