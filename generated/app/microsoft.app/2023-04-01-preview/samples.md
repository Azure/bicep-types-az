...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments@2023-04-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/certificates@2023-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/daprComponents@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/storages@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps@2023-04-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
    configuration: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps/authConfigs@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    globalValidation: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps/sourcecontrols@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    branch: 'master'
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments@2023-04-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/certificates@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/daprComponents@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    componentType: 'state.azure.cosmosdb'
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/managedCertificates@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
Create or update environments storage
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/storages@2023-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
