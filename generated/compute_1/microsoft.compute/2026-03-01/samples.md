...
```bicep
resource exampleResource 'Microsoft.Compute/availabilitySets@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups/capacityReservations@2026-03-01' = {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups/hosts@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/images@2026-03-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    storageProfile: {
...
```bicep
resource exampleResource 'Microsoft.Compute/interconnectBlocks@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    interconnectGroup: {
...
```bicep
resource exampleResource 'Microsoft.Compute/proximityPlacementGroups@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    intent: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections@2026-03-01' = {
  name: 'example'
  location: 'norwayeast'
  properties: {
    source: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections/restorePoints@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    sourceRestorePoint: {
...
```bicep
resource exampleResource 'Microsoft.Compute/sshPublicKeys@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    hardwareProfile: {
...
Create a vm with ephemeral os disk and enableFullCaching set to true.
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-03-01' = {
  name: 'example'
  location: 'westus'
...
Create a vm with resiliency profile and zone movement enabled.
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-03-01' = {
  name: 'example'
  location: 'westus'
...
Create or update a VM with Interconnect Block
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-03-01' = {
  name: 'example'
  location: 'westus'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/extensions@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/runCommands@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2026-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    overprovision: true
...
Create a scale set with automatic SKU migration policy
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2026-03-01' = {
  name: 'example'
  location: 'westus'
...
Create or update a scale set with Interconnect Block.
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2026-03-01' = {
  name: 'example'
  location: 'westus'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/extensions@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  name: '{extension-name}'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  plan: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/extensions@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'extType'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/runCommands@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
