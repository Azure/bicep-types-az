...
```bicep
resource exampleResource 'Microsoft.Compute/diskAccesses@2026-03-02' = {
  name: 'example'
  location: 'West US'
}
```
...
```bicep
resource exampleResource 'Microsoft.Compute/diskAccesses/privateEndpointConnections@2026-03-02' = {
...
```bicep
resource exampleResource 'Microsoft.Compute/diskEncryptionSets@2026-03-02' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Compute/disks@2026-03-02' = {
  name: 'example'
  location: 'West US'
  properties: {
    creationData: {
...
```bicep
resource exampleResource 'Microsoft.Compute/snapshots@2026-03-02' = {
  name: 'example'
  location: 'West US'
  properties: {
    creationData: {
