...
```bicep
resource exampleResource 'Microsoft.Compute/availabilitySets@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
Create or update an open capacity reservation group.
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups@2026-04-01' = {
  name: 'example'
  location: 'westus'
...
Create or update a block capacity reservation.
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups/capacityReservations@2026-04-01' = {
...
Create or update a Future capacity reservation.
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups/capacityReservations@2026-04-01' = {
  parent: parentResource 
  name: 'example'
...
Create or update a targeted capacity reservation.
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups/capacityReservations@2026-04-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups/hosts@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/images@2026-04-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    storageProfile: {
...
Create or update an Interconnect Block with a specific zone.
```bicep
resource exampleResource 'Microsoft.Compute/interconnectBlocks@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    interconnectGroup: {
...
Create or update an Interconnect Block with automatic zone placement
```bicep
resource exampleResource 'Microsoft.Compute/interconnectBlocks@2026-04-01' = {
  name: 'example'
  location: 'westus'
...
```bicep
resource exampleResource 'Microsoft.Compute/proximityPlacementGroups@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    intent: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections@2026-04-01' = {
  name: 'example'
  location: 'norwayeast'
  properties: {
    source: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections/restorePoints@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    sourceRestorePoint: {
...
```bicep
resource exampleResource 'Microsoft.Compute/sshPublicKeys@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    hardwareProfile: {
...
Create a vm with additional disk properties (network access policy and tier).
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-04-01' = {
  name: 'example'
  location: 'westus'
...
Create a VM with capacity reservation assignment disabled
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-04-01' = {
  name: 'example'
  location: 'westus'
...
Create a vm with SpotPlus priority
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2026-04-01' = {
  name: 'example'
  location: 'westus'
...
Create or update a diagnostic run command.
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/diagnosticRunCommands@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/extensions@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/runCommands@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2026-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    overprovision: true
...
Create a scale set with SpotPlus priority (Flexible)
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2026-04-01' = {
  name: 'example'
  location: 'westus'
...
Create a scale set with SpotPlus priority (Uniform)
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2026-04-01' = {
  name: 'example'
  location: 'westus'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/extensions@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  name: '{extension-name}'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  plan: {
...
Create VirtualMachineScaleSet VM diagnostic run command.
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/diagnosticRunCommands@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/extensions@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'extType'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/runCommands@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
