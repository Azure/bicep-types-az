...
```bicep
resource exampleResource 'Microsoft.Compute/availabilitySets@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups/capacityReservations@2025-11-01' = {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups/hosts@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/images@2025-11-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    storageProfile: {
...
```bicep
resource exampleResource 'Microsoft.Compute/proximityPlacementGroups@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    intent: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections@2025-11-01' = {
  name: 'example'
  location: 'norwayeast'
  properties: {
    source: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections/restorePoints@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    sourceRestorePoint: {
...
```bicep
resource exampleResource 'Microsoft.Compute/sshPublicKeys@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    hardwareProfile: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/extensions@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/runCommands@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    overprovision: true
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/extensions@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  name: '{extension-name}'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  plan: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/extensions@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'extType'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/runCommands@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
