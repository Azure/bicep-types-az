# Microsoft.Compute @ 2026-03-03

## Resource Microsoft.Compute/galleries@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/applications@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/applications/versions@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/images@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/images/versions@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/inVMAccessControlProfiles@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/inVMAccessControlProfiles/versions@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/scripts@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/scripts/versions@2026-03-03
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function accept (Microsoft.Compute/locations/tenantLevelSharedGallerySubscriptions/sharedGalleries@2026-03-03)
* **Resource**: Microsoft.Compute/locations/tenantLevelSharedGallerySubscriptions/sharedGalleries
* **ApiVersion**: 2026-03-03
* **Output**: any

## Function accept (Microsoft.Compute/locations/sharedGallerySubscriptions/sharedGalleries@2026-03-03)
* **Resource**: Microsoft.Compute/locations/sharedGallerySubscriptions/sharedGalleries
* **ApiVersion**: 2026-03-03
* **Output**: any

## Function reject (Microsoft.Compute/locations/tenantLevelSharedGallerySubscriptions/sharedGalleries@2026-03-03)
* **Resource**: Microsoft.Compute/locations/tenantLevelSharedGallerySubscriptions/sharedGalleries
* **ApiVersion**: 2026-03-03
* **Output**: any

## Function reject (Microsoft.Compute/locations/sharedGallerySubscriptions/sharedGalleries@2026-03-03)
* **Resource**: Microsoft.Compute/locations/sharedGallerySubscriptions/sharedGalleries
* **ApiVersion**: 2026-03-03
* **Output**: any

## Function share (Microsoft.Compute/galleries@2026-03-03)
...
* **securityProfile**: [DataDiskImageSecurityProfile](#datadiskimagesecurityprofile): This property specifies the security profile of a data disk image.

## DataDiskImageSecurityProfile
### Properties
* **confidentialVMEncryptionType**: 'DataDiskEncryptedWithCmk' | 'EncryptedVMGuestStateOnlyWithPmk' | 'EncryptedWithCmk' | 'EncryptedWithPmk' | 'NonPersistedTPM' | string: confidential VM encryption types
...
### Properties
* **imageMetadataProfiles**: [ImageMetadataProfile](#imagemetadataprofile)[] (ReadOnly): The image metadata profiles associated with the gallery image version.
* **provisioningState**: 'Creating' | 'Deleting' | 'Failed' | 'Migrating' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state, which only appears in the response.
...
### Properties
* **internalMetadataList**: [MetadataKeyValue](#metadatakeyvalue)[]: The list of internal metadata key-value pairs. Contains non-sensitive service-internal metadata for diagnostics and tracking. No secret material is emitted in this list.
* **publicMetadataList**: [MetadataKeyValue](#metadatakeyvalue)[]: The list of public metadata key-value pairs. Contains non-sensitive image capability metadata such as supported OS, component names, and versions. No secret material is emitted in this list.
* **type**: 'SecretsProvisioningImageMetadata' | 'UserProvidedSecretsProvisioningMetadata' | string (Required): The type of metadata.
...
### Properties
* **secretsProvisioningSettings**: [SecretsProvisioningSettings](#secretsprovisioningsettings): Specifies the secrets provisioning settings for the gallery image version. Used on create or update to configure secrets provisioning.
...
## MetadataKeyValue
### Properties
* **metadataKey**: string (Required): The metadata key. Known keys emitted by the service include 'Linux.AzureSecretsProvisioning.Enabled', 'OS.Name', and '{componentName}.Version' (e.g., 'AzureGuestAgent.Version'). All values are non-sensitive configuration; no secrets, credentials, or cryptographic material transit this field.
* **metadataValue**: string: The metadata value. Contains non-sensitive configuration such as capability flags ('true'/'false'), OS names ('Linux', 'Windows'), and version strings (e.g., '1.0.0').
...
### Properties
* **name**: 'AzureGuestAgent' | 'CloudInit' | 'OS' | 'SecretsProvisioningLibrary' | string: The name of the component.
* **version**: string: The version of the component.

## SecretsProvisioningSettings
### Properties
* **components**: [SecretsProvisioningComponent](#secretsprovisioningcomponent)[]: The list of component versions involved in secrets provisioning.
* **isSupported**: bool: Specifies whether the image version supports secrets provisioning.
* **osName**: string: The name of the operating system (e.g., "mariner").
...
## SoftDeletePolicy
### Properties
* **gracePeriodInDays**: int: The grace period in days for a simulated hard-deleted resource. During this period the gallery image version is unusable but can still be recovered if required. After this period elapses, the gallery image version is permanently (hard) deleted.
...
* **retentionPeriodInDays**: int: The retention period in days for a soft-deleted resource. After this period elapses, the soft-deleted gallery image version transitions to a simulated hard-deleted state.
