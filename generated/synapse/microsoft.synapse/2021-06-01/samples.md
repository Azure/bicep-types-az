...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/firewallRules@2021-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/keys@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isActiveCMK: true
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/privateEndpointConnections@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/privateLinkHubs@2021-06-01' = {
  name: 'example'
  location: 'East US'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools@2021-06-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/metadataSync@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/geoBackupPolicies@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/transparentDataEncryption@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    status: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/auditingSettings@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/schemas/tables/columns/sensitivityLabels@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/vulnerabilityAssessments@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/securityAlertPolicies@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/vulnerabilityAssessments/rules/baselines@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    baselineResults: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/extendedAuditingSettings@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isAzureMonitorTargetEnabled: true
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/dataMaskingPolicies@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/dataMaskingPolicies/rules@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aliasName: 'nickname'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/workloadGroups@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    importance: 'normal'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/auditingSettings@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    auditActionsAndGroups: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/extendedAuditingSettings@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    auditActionsAndGroups: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/securityAlertPolicies@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/vulnerabilityAssessments@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/encryptionProtector@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/dedicatedSQLminimalTlsSettings@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces@2021-06-01' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/administrators@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create or update workspace active directory admin
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlAdministrators@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    administratorType: 'ActiveDirectory'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/managedIdentitySqlControlSettings@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/bigDataPools@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US 2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/integrationRuntimes@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'SelfHosted'
