...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/bigDataPools@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US 2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/firewallRules@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/integrationRuntimes@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'SelfHosted'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/keys@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isActiveCMK: true
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/privateEndpointConnections@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/dataMaskingPolicies@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/dataMaskingPolicies/rules@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aliasName: 'nickname'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/workloadGroups@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    importance: 'normal'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/vulnerabilityAssessments@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
