...
* **properties**: [schemas:128_properties](#schemas128properties): Sql Control Settings for workspace managed identity
...
### Properties
* **grantSqlControlToManagedIdentity**: [schemas:128_properties_grantSqlControlToManagedIdentity](#schemas128propertiesgrantsqlcontroltomanagedidentity): Grant sql control to managed identity
...
* **storageAccountType**: 'GRS' | 'LRS' | 'ZRS': The storage account type used to store backups for this sql pool. Possible values include: 'GRS', 'LRS', 'ZRS'
