...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/bigDataPools@2020-12-01' = {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/firewallRules@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools@2020-12-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/metadataSync@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/geoBackupPolicies@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/transparentDataEncryption@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    status: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/auditingSettings@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/schemas/tables/columns/sensitivityLabels@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/vulnerabilityAssessments@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/securityAlertPolicies@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/vulnerabilityAssessments/rules/baselines@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    baselineResults: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/extendedAuditingSettings@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isAzureMonitorTargetEnabled: true
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/dataMaskingPolicies@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/dataMaskingPolicies/rules@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aliasName: 'nickname'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/workloadGroups@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    importance: 'normal'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces@2020-12-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/administrators@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create or update workspace active directory admin
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/sqlAdministrators@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    administratorType: 'ActiveDirectory'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/managedIdentitySqlControlSettings@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/integrationRuntimes@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'SelfHosted'
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/privateEndpointConnections@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/privateLinkHubs@2020-12-01' = {
  name: 'example'
  location: 'East US'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/auditingSettings@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    auditActionsAndGroups: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/extendedAuditingSettings@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    auditActionsAndGroups: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/securityAlertPolicies@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/vulnerabilityAssessments@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/encryptionProtector@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Synapse/workspaces/keys@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isActiveCMK: true
