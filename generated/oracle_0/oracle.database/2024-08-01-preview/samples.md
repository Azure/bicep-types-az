...
```bicep
resource exampleResource 'Oracle.Database/autonomousDatabases@2024-08-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    adminPassword: '********'
...
```bicep
resource exampleResource 'Oracle.Database/autonomousDatabases/autonomousDatabaseBackups@2024-08-01-preview' = {
...
```bicep
resource exampleResource 'Oracle.Database/cloudExadataInfrastructures@2024-08-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    computeCount: 100
...
Create VM Cluster
```bicep
resource exampleResource 'Oracle.Database/cloudVmClusters@2024-08-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/cloudVmClusters/virtualNetworkAddresses@2024-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/oracleSubscriptions@2024-08-01-preview' = {
  name: 'example'
  plan: {
    name: 'plan1'
    product: 'product1'
