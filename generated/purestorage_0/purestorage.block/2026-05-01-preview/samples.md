...
Reservations_Create
```bicep
resource exampleResource 'PureStorage.Block/reservations@2026-05-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    marketplace: {
...
StoragePools_Create
```bicep
resource exampleResource 'PureStorage.Block/storagePools@2026-05-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
VolumeGroups_Create
```bicep
resource exampleResource 'PureStorage.Block/storagePools/volumeGroups@2026-05-01-preview' = {
...
## purestorage.block/storagepools/volumegroups/snapshots

VolumeGroupSnapshots_Create
```bicep
resource exampleResource 'PureStorage.Block/storagePools/volumeGroups/snapshots@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Volumes_Create
```bicep
resource exampleResource 'PureStorage.Block/storagePools/volumeGroups/volumes@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
