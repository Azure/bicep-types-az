...
### Properties
* **transferAllDetails**: [schemas:90_transferAllDetails](#schemas90transferalldetails): Map of filter type and the details to transfer all data. This field is required only if the TransferConfigurationType is given as TransferAll
* **transferConfigurationType**: 'TransferAll' | 'TransferUsingFilter' (Required): Type of the configuration for transfer.
* **transferFilterDetails**: [schemas:90_transferFilterDetails](#schemas90transferfilterdetails): Map of filter type and the details to filter. This field is required only if the TransferConfigurationType is given as TransferUsingFilter.

## schemas:90_transferAllDetails
### Properties
...
## schemas:90_transferFilterDetails
### Properties
