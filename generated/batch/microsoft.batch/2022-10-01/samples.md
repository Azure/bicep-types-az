...
```bicep
resource exampleResource 'Microsoft.Batch/batchAccounts@2022-10-01' = {
  name: 'example'
  location: 'japaneast'
  properties: {
    autoStorage: {
...
ApplicationCreate
```bicep
resource exampleResource 'Microsoft.Batch/batchAccounts/applications@2022-10-01' = {
...
```bicep
resource exampleResource 'Microsoft.Batch/batchAccounts/certificates@2022-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'Pfx'
...
```bicep
resource exampleResource 'Microsoft.Batch/batchAccounts/pools@2022-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
