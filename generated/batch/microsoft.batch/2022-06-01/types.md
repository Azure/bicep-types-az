...
* **networkProfile**: [NetworkProfile](#networkprofile): Network profile for Batch account, which contains network rule settings for each endpoint.
...
## NetworkProfile
### Properties
* **accountAccess**: [EndpointAccessProfile](#endpointaccessprofile): Network access profile for Batch endpoint.
* **nodeManagementAccess**: [EndpointAccessProfile](#endpointaccessprofile): Network access profile for Batch endpoint.
