...
Accounts_Create
```bicep
resource exampleResource 'Microsoft.DataShare/accounts@2020-09-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
Shares_Create
```bicep
resource exampleResource 'Microsoft.DataShare/accounts/shares@2020-09-01' = {
...
DataSets_Create
```bicep
resource exampleResource 'Microsoft.DataShare/accounts/shares/dataSets@2020-09-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'Blob'
  properties: {
...
Invitations_Create
```bicep
resource exampleResource 'Microsoft.DataShare/accounts/shares/invitations@2020-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DataShare/accounts/shares/synchronizationSettings@2020-09-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'ScheduleBased'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DataShare/accounts/shareSubscriptions@2020-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    expirationDate: '2020-08-26T22:33:24.5785265Z'
...
```bicep
resource exampleResource 'Microsoft.DataShare/accounts/shareSubscriptions/dataSetMappings@2020-09-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'Blob'
  properties: {
...
Triggers_Create
```bicep
resource exampleResource 'Microsoft.DataShare/accounts/shareSubscriptions/triggers@2020-09-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'ScheduleBased'
  properties: {
