...
```bicep
resource exampleResource 'Microsoft.Monitor/accounts@2025-10-03-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    metrics: {
...
```bicep
resource exampleResource 'Microsoft.Monitor/accounts/issues@2025-10-03-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Monitor/accounts/metricsContainers@2025-10-03-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    limits: {
