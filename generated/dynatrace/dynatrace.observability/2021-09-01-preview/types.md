...
* **type**: 'SystemAndUserAssigned' | 'SystemAssigned' | 'UserAssigned' (Required): The kind of managed identity assigned to this resource.
...
* **liftrResourceCategory**: 'MonitorLogs' | 'Unknown' (ReadOnly): Liftr resource category
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleted' | 'Deleting' | 'Failed' | 'NotSpecified' | 'Succeeded' | 'Updating' (ReadOnly): Provisioning state of the monitoring resource
...
* **sendAadLogs**: 'Disabled' | 'Enabled': Indicates whether AAD logs are being sent.
* **sendActivityLogs**: 'Disabled' | 'Enabled': Indicates whether activity logs are being sent.
* **sendSubscriptionLogs**: 'Disabled' | 'Enabled': Indicates whether subscription logs are being sent.
...
## AppServiceInfo
### Properties
* **autoUpdateSetting**: 'DISABLED' | 'ENABLED' (ReadOnly): Update settings of OneAgent.
* **availabilityState**: 'CRASHED' | 'LOST' | 'MONITORED' | 'PRE_MONITORED' | 'SHUTDOWN' | 'UNEXPECTED_SHUTDOWN' | 'UNKNOWN' | 'UNMONITORED' (ReadOnly): The availability state of OneAgent.
* **hostGroup**: string (ReadOnly): The name of the host group
* **hostName**: string (ReadOnly): The name of the host
* **logModule**: 'DISABLED' | 'ENABLED' (ReadOnly): Tells whether log modules are enabled or not
* **monitoringType**: 'CLOUD_INFRASTRUCTURE' | 'FULL_STACK' (ReadOnly): The monitoring mode of OneAgent
* **resourceId**: string (ReadOnly): App service resource ID
* **updateStatus**: 'INCOMPATIBLE' | 'OUTDATED' | 'SCHEDULED' | 'SUPPRESSED' | 'UNKNOWN' | 'UP2DATE' | 'UPDATE_IN_PROGRESS' | 'UPDATE_PENDING' | 'UPDATE_PROBLEM' (ReadOnly): The current update status of OneAgent.
...
* **sendingLogs**: 'Disabled' | 'Enabled' (ReadOnly): Indicates whether logs are being sent.
* **sendingMetrics**: 'Disabled' | 'Enabled' (ReadOnly): Indicates whether metrics are being sent.
