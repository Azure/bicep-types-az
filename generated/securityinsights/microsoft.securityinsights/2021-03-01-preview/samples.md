...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/dataConnectors@2021-03-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  kind: 'Dynamics365'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/entityQueries@2021-03-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  kind: 'Activity'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/metadata@2021-03-01-preview' = {
  name: 'example'
  properties: {
    author: {
      name: 'User Name'
