...
## Function listRepositories (Microsoft.SecurityInsights@2025-06-01)
...
## RepoList
### Properties
* **nextLink**: string (ReadOnly): URL to fetch the next set of repositories.
* **value**: [Repo](#repo)[] (Required): Array of repositories.
