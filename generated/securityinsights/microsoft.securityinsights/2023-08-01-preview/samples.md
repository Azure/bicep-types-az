...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/alertRules@2023-08-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/alertRules/actions@2023-08-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/bookmarks@2023-08-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/bookmarks/relations@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/contentPackages@2023-08-01-preview' = {
  name: 'example'
  properties: {
...
Get a template.
```bicep
resource exampleResource 'Microsoft.SecurityInsights/contentTemplates@2023-08-01-preview' = {
  name: 'example'
  properties: {
    author: {
      name: 'Microsoft'
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/dataConnectorDefinitions@2023-08-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  kind: 'Customizable'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/dataConnectors@2023-08-01-preview' = {
  name: 'example'
  kind: 'APIPolling'
  properties: {
    connectorUiConfig: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/entityQueries@2023-08-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  kind: 'Activity'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/fileImports@2023-08-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/hunts@2023-08-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/hunts/comments@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/hunts/relations@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    labels: [
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/incidents@2023-08-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/incidents/comments@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/incidents/relations@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/incidents/tasks@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/metadata@2023-08-01-preview' = {
  name: 'example'
  properties: {
    author: {
      name: 'User Name'
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/onboardingStates@2023-08-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/securityMLAnalyticsSettings@2023-08-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/settings@2023-08-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  kind: 'EyesOn'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/sourcecontrols@2023-08-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/watchlists@2023-08-01-preview' = {
  name: 'example'
  etag: '"0300bf09-0000-0000-0000-5c37296e0000"'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/watchlists/watchlistItems@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  etag: '0300bf09-0000-0000-0000-5c37296e0000'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/workspaceManagerAssignments@2023-08-01-preview' = {
  name: 'example'
  properties: {
    items: [
      {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/workspaceManagerConfigurations@2023-08-01-preview' = {
  name: 'example'
  properties: {
    mode: 'Enabled'
  }
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/workspaceManagerGroups@2023-08-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SecurityInsights/workspaceManagerMembers@2023-08-01-preview' = {
  name: 'example'
  properties: {
