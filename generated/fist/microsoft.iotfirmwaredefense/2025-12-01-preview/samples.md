...
```bicep
resource exampleResource 'Microsoft.IoTFirmwareDefense/workspaces@2025-12-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.IoTFirmwareDefense/workspaces/firmwares@2025-12-01-preview' = {
