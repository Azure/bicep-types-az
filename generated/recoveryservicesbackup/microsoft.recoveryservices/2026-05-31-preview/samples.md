...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupconfig@2026-05-31-preview' = {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupEncryptionConfigs@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/backupProtectionIntent@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupPolicies@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    backupManagementType: 'AzureStorage'
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupResourceGuardProxies@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupstorageconfig@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/privateEndpointConnections@2026-05-31-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupIds: [
