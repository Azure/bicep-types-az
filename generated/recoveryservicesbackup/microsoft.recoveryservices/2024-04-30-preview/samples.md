...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupconfig@2024-04-30-preview' = {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupEncryptionConfigs@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/backupProtectionIntent@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupPolicies@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    backupManagementType: 'AzureStorage'
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupResourceGuardProxies@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupstorageconfig@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/privateEndpointConnections@2024-04-30-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupIds: [
