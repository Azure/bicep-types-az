...
CreateEdgeAction
```bicep
resource exampleResource 'Microsoft.Cdn/edgeActions@2025-09-01-preview' = {
  name: 'example'
  location: 'global'
  sku: {
    name: 'Standard'
...
```bicep
resource exampleResource 'Microsoft.Cdn/edgeActions/executionFilters@2025-09-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Cdn/edgeActions/versions@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'global'
  properties: {
