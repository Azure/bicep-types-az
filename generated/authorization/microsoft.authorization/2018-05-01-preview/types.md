...
* **status**: 'Applied' | 'Applying' | 'AutoReviewed' | 'AutoReviewing' | 'Completed' | 'Completing' | 'Initializing' | 'InProgress' | 'NotStarted' | 'Scheduled' | 'Starting' (ReadOnly, WriteOnly): This read-only field specifies the status of an accessReview.
...
* **status**: 'Applied' | 'Applying' | 'AutoReviewed' | 'AutoReviewing' | 'Completed' | 'Completing' | 'Initializing' | 'InProgress' | 'NotStarted' | 'Scheduled' | 'Starting' (ReadOnly, WriteOnly): This read-only field specifies the status of an access review instance.
...
* **status**: 'Applied' | 'Applying' | 'AutoReviewed' | 'AutoReviewing' | 'Completed' | 'Completing' | 'Initializing' | 'InProgress' | 'NotStarted' | 'Scheduled' | 'Starting' (ReadOnly): This read-only field specifies the status of an accessReview.
...
## AccessReviewScope
### Properties
* **principalType**: 'servicePrincipal' | 'user' (ReadOnly, WriteOnly): The identity type user/servicePrincipal to review.
