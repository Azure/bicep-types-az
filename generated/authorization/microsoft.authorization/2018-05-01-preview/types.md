...
## AccessReviewScope
### Properties
* **principalType**: 'servicePrincipal' | 'user' (ReadOnly, WriteOnly): The identity type user/servicePrincipal to review. Possible values include: 'user', 'servicePrincipal'
