...
* **health**: 'Critical' | 'None' | 'Normal' | 'Warning' | string (ReadOnly): The health of the DRA.
* **healthErrors**: [HealthError](#healtherror)[] (ReadOnly): The health errors.
* **historicHealth**: 'Critical' | 'None' | 'Normal' | 'Warning' | string (ReadOnly): The health of the DRA.
...
* **hasFibreChannelAdapter**: 'NotPresent' | 'Present' | 'Unknown' | string (ReadOnly): A value indicating whether the VM has a physical disk attached. String value of {SrsDataContract.PresenceStatus} enum.
* **hasPhysicalDisk**: 'NotPresent' | 'Present' | 'Unknown' | string (ReadOnly): A value indicating whether the VM has a physical disk attached. String value of {SrsDataContract.PresenceStatus} enum.
* **hasSharedVhd**: 'NotPresent' | 'Present' | 'Unknown' | string (ReadOnly): A value indicating whether the VM has a physical disk attached. String value of {SrsDataContract.PresenceStatus} enum.
