...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationAlertSettings@2026-05-01' = {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    customDetails: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationNetworks/replicationNetworkMappings@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Enables migration.
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Enables protection.
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectedItems@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectionClusters@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    policyId: '/Subscriptions/c183865e-6077-46f2-a3b1-deb0f4f4650a/resourceGroups/resourceGroupPS1/providers/Microsoft.RecoveryServices/vaults/vault1/replicationPolicies/protectionprofile1'
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationRecoveryServicesProviders@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Add vCenter.
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationFabrics/replicationvCenters@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    friendlyName: 'esx-78'
...
Creates the policy.
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationPolicies@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    providerSpecificInput: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationProtectionIntents@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    providerSpecificDetails: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationRecoveryPlans@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/replicationVaultSettings@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
