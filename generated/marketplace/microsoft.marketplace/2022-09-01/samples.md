...
```bicep
resource exampleResource 'Microsoft.Marketplace/privateStores@2022-09-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Marketplace/privateStores/adminRequestApprovals@2022-09-01' = {
...
```bicep
resource exampleResource 'Microsoft.Marketplace/privateStores/collections@2022-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Marketplace/privateStores/collections/offers@2022-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
