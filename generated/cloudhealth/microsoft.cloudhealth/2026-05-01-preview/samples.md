...
HealthModels_Create
```bicep
resource exampleResource 'Microsoft.CloudHealth/healthmodels@2026-05-01-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.CloudHealth/healthmodels/authenticationsettings@2026-05-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.CloudHealth/healthmodels/discoveryrules@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CloudHealth/healthmodels/entities@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    alerts: {
...
```bicep
resource exampleResource 'Microsoft.CloudHealth/healthmodels/relationships@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CloudHealth/healthmodels/signaldefinitions@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aggregationType: 'None'
