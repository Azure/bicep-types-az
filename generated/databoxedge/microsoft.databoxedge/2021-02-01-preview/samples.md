...
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices@2021-02-01-preview' = {
  name: 'example'
  location: 'WUS'
  sku: {
    name: 'Edge'
...
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules@2021-02-01-preview' = {
...
OrderPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/orders@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contactInformation: {
...
RolePut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  kind: 'IOT'
  properties: {
...
PutAddons
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/addons@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
...
PutMonitoringConfig
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/monitoringConfig@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
SharePut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: ''
...
SACPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    accountKey: {
...
StorageAccountPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
ContainerPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/containers@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dataFormat: 'BlockBlob'
...
TriggerPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/triggers@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  kind: 'FileEvent'
  properties: {
...
UserPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/users@2021-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    encryptedPassword: {
