...
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules@2020-05-01-preview' = {
...
OrderPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/orders@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contactInformation: {
...
RolePut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  kind: 'IOT'
  properties: {
...
SharePut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: ''
...
SACPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    accountKey: {
...
StorageAccountPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
ContainerPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/containers@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dataFormat: 'BlockBlob'
...
TriggerPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/triggers@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  kind: 'FileEvent'
  properties: {
...
UserPut
```bicep
resource exampleResource 'Microsoft.DataBoxEdge/dataBoxEdgeDevices/users@2020-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    encryptedPassword: {
