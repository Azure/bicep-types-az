...
### Properties
* **computeVersionInformation**: [ComputeVersionInformation](#computeversioninformation) (ReadOnly): This contains the compute information
...
### Properties
* **componentType**: 'CNI' | 'Cluster' | 'Etcd' | 'Invalid' | 'LoadBalancer' | 'Node' (ReadOnly): ComponentType of the Kubernetes node.
...
* **type**: 'ControlPlane' | 'Invalid' | 'ManagementCluster' | 'Master' | 'NodePool' | 'Worker' (ReadOnly): Node type - Master/Worker
