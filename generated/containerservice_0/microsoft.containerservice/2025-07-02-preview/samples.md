...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters@2025-07-02-preview' = {
  name: 'example'
  location: 'location1'
  properties: {
    addonProfiles: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/agentPools@2025-07-02-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/agentPools/machines@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hardware: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/identityBindings@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    managedIdentity: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/jwtAuthenticators@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    claimMappings: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/loadBalancers@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    notAllowedTime: [
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/managedNamespaces@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/privateEndpointConnections@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2025-07-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    roles: [
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedclustersnapshots@2025-07-02-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    creationData: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/snapshots@2025-07-02-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    creationData: {
