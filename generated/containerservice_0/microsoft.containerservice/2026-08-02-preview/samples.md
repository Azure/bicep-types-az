...
Creates or updates an AI Manager resource attached to an existing AKS cluster (bring-your-own).
```bicep
resource exampleResource 'Microsoft.ContainerService/aiManagers@2026-08-02-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.ContainerService/aiManagers/modelSources@2026-08-02-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/aiManagers/namespaces@2026-08-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    annotations: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/aiManagers/namespaces/modelDeployments@2026-08-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
