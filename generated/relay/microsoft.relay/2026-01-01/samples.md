...
```bicep
resource exampleResource 'Microsoft.Relay/namespaces@2026-01-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Relay/namespaces/authorizationRules@2026-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.Relay/namespaces/hybridConnections@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Relay/namespaces/hybridConnections/authorizationRules@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
```bicep
resource exampleResource 'Microsoft.Relay/namespaces/networkRuleSets@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    defaultAction: 'Deny'
...
```bicep
resource exampleResource 'Microsoft.Relay/namespaces/privateEndpointConnections@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
RelayCreate
```bicep
resource exampleResource 'Microsoft.Relay/namespaces/wcfRelays@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    relayType: 'NetTcp'
...
```bicep
resource exampleResource 'Microsoft.Relay/namespaces/wcfRelays/authorizationRules@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
