...
ScopeMapCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/scopeMaps@2019-05-01-preview' = {
...
TokenCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/tokens@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    credentials: {
