...
```bicep
resource exampleResource 'Microsoft.ManagedServices/registrationDefinitions@2018-06-01-preview' = {
  name: 'example'
  plan: {
    name: 'addesai-plan'
    product: 'test'
...
```bicep
resource exampleResource 'Microsoft.ManagedServices/registrationAssignments@2018-06-01-preview' = {
  name: 'example'
  properties: {
