...
```bicep
resource exampleResource 'Microsoft.ManagedServices/registrationDefinitions@2020-02-01-preview' = {
  name: 'example'
  plan: {
    name: 'addesai-plan'
    product: 'test'
...
```bicep
resource exampleResource 'Microsoft.ManagedServices/registrationAssignments@2020-02-01-preview' = {
  name: 'example'
  properties: {
