...
Dashboard_Create
```bicep
resource exampleResource 'Microsoft.Dashboard/dashboards@2025-09-01-preview' = {
  name: 'example'
  location: 'West US'
  tags: {
    Environment: 'Dev'
...
```bicep
resource exampleResource 'Microsoft.Dashboard/dashboards/dashboardDefinitions@2025-09-01-preview' = {
...
Grafana_Create
```bicep
resource exampleResource 'Microsoft.Dashboard/grafana@2025-09-01-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Dashboard/grafana/integrationFabrics@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Dashboard/grafana/managedPrivateEndpoints@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
