...
```bicep
resource exampleResource 'Microsoft.Network/frontDoors@2021-06-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    backendPools: [
...
```bicep
resource exampleResource 'Microsoft.Network/frontDoors/rulesEngines@2021-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.Network/FrontDoorWebApplicationFirewallPolicies@2021-06-01' = {
  name: 'example'
  properties: {
    customRules: {
      rules: [
