...
```bicep
resource exampleResource 'Microsoft.Network/frontDoors@2020-04-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    backendPools: [
...
```bicep
resource exampleResource 'Microsoft.Network/frontDoors/rulesEngines@2020-04-01' = {
...
```bicep
resource exampleResource 'Microsoft.Network/FrontDoorWebApplicationFirewallPolicies@2020-04-01' = {
  name: 'example'
  properties: {
    customRules: {
      rules: [
