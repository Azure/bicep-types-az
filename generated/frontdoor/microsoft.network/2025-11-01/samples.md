...
```bicep
resource exampleResource 'Microsoft.Network/frontDoors@2025-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    backendPools: [
...
```bicep
resource exampleResource 'Microsoft.Network/frontDoors/rulesEngines@2025-11-01' = {
...
```bicep
resource exampleResource 'Microsoft.Network/FrontDoorWebApplicationFirewallPolicies@2025-11-01' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    customRules: {
...
```bicep
resource exampleResource 'Microsoft.Network/NetworkExperimentProfiles@2025-11-01' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    enabledState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Network/NetworkExperimentProfiles/Experiments@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
