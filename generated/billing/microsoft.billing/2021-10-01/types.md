...
* **family**: 'CheckWire' | 'CreditCard' | string (ReadOnly): The family of payment method.
...
### Properties
* **autoRenew**: 'Off' | 'On' | string (ReadOnly): Indicates whether auto renewal is turned on or off for a subscription.
