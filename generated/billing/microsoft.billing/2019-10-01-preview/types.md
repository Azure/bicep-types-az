...
* **rebillDocumentType**: 'Credit' | 'Original' | 'Rebill' | string (ReadOnly): The type of the document generated when an Enterprise Agreement invoice is rebilled.
...
* **kind**: 'all' | 'reservation' | string (ReadOnly): The kind of transaction. Options are all or reservation.
...
* **transactionType**: 'Purchase' | 'Usage Charge' | string (ReadOnly): The type of transaction.
