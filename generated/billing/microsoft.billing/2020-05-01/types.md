...
### Properties
* **accountStatus**: 'Active' | 'Deleted' | 'Disabled' | 'Expired' | 'Extended' | 'Terminated' | 'Transferred' (ReadOnly): The current status of the billing account.
...
* **documentType**: 'CreditNote' | 'Invoice' (ReadOnly): The type of the document.
...
* **source**: 'DRS' | 'ENF' (ReadOnly): The source of the document. ENF for Brazil and DRS for rest of the world.
...
## ProductProperties
### Properties
* **autoRenew**: 'Off' | 'On' (ReadOnly): Indicates whether auto renewal is turned on or off for a product.
