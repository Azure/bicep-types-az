...
* **billingProfiles**: [BillingProfilesOnExpand](#billingprofilesonexpand) (ReadOnly): The billing profiles associated with the billing account. By default this is not populated, unless it's specified in $expand.
...
* **notificationEmailAddress**: string (ReadOnly): Notification email address, only for legacy accounts
* **soldTo**: [AddressDetails](#addressdetails) (ReadOnly): Address details.
...
* **value**: [BillingProfile](#billingprofile)[] (ReadOnly): The billing profiles associated with the billing account.
...
* **accountOwnerEmail**: string (ReadOnly): The enrollment account owner email address.
...
* **billingProfileInfo**: [BillingProfileInfo](#billingprofileinfo) (ReadOnly): Details about billing profile associated with agreement and available only for specific agreements.
...
* **billingProfileId**: string (ReadOnly): The unique identifier for the billing profile.
* **indirectRelationshipOrganizationName**: string (ReadOnly): Billing account name. This property is available for a specific type of agreement.
...
* **principalId**: string (ReadOnly): The principal id of the user to whom the role was assigned.
* **principalTenantId**: string (ReadOnly): The principal tenant id of the user to whom the role was assigned.
* **roleDefinitionId**: string (ReadOnly): The ID of the role definition.
* **scope**: string (ReadOnly): The scope at which the role was assigned.
* **userAuthenticationType**: string (ReadOnly): The authentication type.
* **userEmailAddress**: string (ReadOnly): The email address of the user.
...
* **subscriptionBillingStatus**: 'Abandoned' | 'Active' | 'Deleted' | 'Inactive' | 'Warning' | string (ReadOnly): The current billing status of the subscription.
...
* **paymentMethodFamily**: 'CheckWire' | 'CreditCard' | 'Credits' | 'None' | string (ReadOnly): The family of payment method.
...
## ProductProperties
### Properties
* **autoRenew**: 'Off' | 'On' | string (ReadOnly): Indicates whether auto renewal is turned on or off for a product.
* **availabilityId**: string (ReadOnly): The availability of the product.
* **billingFrequency**: 'Monthly' | 'OneTime' | 'UsageBased' | string (ReadOnly): The frequency at which the product will be billed.
...
* **status**: 'Active' | 'AutoRenew' | 'Cancelled' | 'Disabled' | 'Expired' | 'Expiring' | 'Inactive' | 'PastDue' | string (ReadOnly): The current status of the product.
