...
* **subscriptionBillingStatus**: 'Abandoned' | 'Active' | 'Deleted' | 'Inactive' | 'Warning' | string (ReadOnly): Subscription billing status.
...
* **billingFrequency**: 'Monthly' | 'OneTime' | 'UsageBased' | string (ReadOnly): Billing frequency.
* **billingProfileId**: string (ReadOnly): Billing Profile id to which this product belongs.
* **billingProfileName**: string (ReadOnly): Billing Profile name to which this product belongs.
...
* **status**: 'Active' | 'AutoRenew' | 'Cancelled' | 'Disabled' | 'Expired' | 'Expiring' | 'Inactive' | 'PastDue' | string (ReadOnly): Product status.
