...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/conditionalCredits@2026-06-01' = {
  name: 'example'
  location: 'global'
  properties: {
...
CreditCreate
```bicep
resource exampleResource 'Microsoft.BillingBenefits/credits@2026-06-01' = {
  name: 'example'
  location: 'global'
  properties: {
    credit: {
...
resource exampleResource 'Microsoft.BillingBenefits/credits@2026-06-01' = {
  ...
  properties: {
    ...
    displayName: 'Test Credit'
    endAt: '2024-01-12T00:00:00Z'
    fundingSystemId: 'e21611dc-a314-4aa7-b590-1ab159b7b41b'
    invitationId: 'sampleInvitationId'
    productCode: '0002d726-0000-0160-330f-a0b98cdbbdc4'
    startAt: '2023-12-12T00:00:00Z'
  }
  tags: {
...
resource exampleResource 'Microsoft.BillingBenefits/credits@2026-06-01' = {
  ...
  properties: {
    ...
    displayName: 'Investment Fund Credit'
    endAt: '2025-08-31T23:59:59.999Z'
...
resource exampleResource 'Microsoft.BillingBenefits/credits@2026-06-01' = {
  ...
  location: 'global'
  properties: {
    displayName: 'Promotional Credit'
    policies: {
...
CreditSourceCreate
```bicep
resource exampleResource 'Microsoft.BillingBenefits/credits/sources@2026-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/discounts@2026-06-01' = {
  name: 'example'
  location: 'global'
  properties: {
...
DiscountsCreatePrimaryWithAzurePromotion
```bicep
resource exampleResource 'Microsoft.BillingBenefits/discounts@2026-06-01' = {
  name: 'example'
  location: 'global'
  properties: {
    appliedScopeType: 'BillingAccount'
    discountTypeProperties: {
      applyDiscountOn: 'Consume'
      discountCombinationRule: 'BestOf'
      discountPercentage: 10
      discountType: 'AzurePromotion'
      productFamilyName: 'Azure'
    }
    displayName: 'ConsumptionPromo20percent <sku title>'
    endAt: '2024-07-01T23:59:59Z'
    entityType: 'Primary'
    productCode: '0001d726-0000-0160-330f-a0b98cdbbdc4'
    startAt: '2023-07-01T00:00:00Z'
...
FreeServicesCreate
```bicep
resource exampleResource 'Microsoft.BillingBenefits/freeServices@2026-06-01' = {
  name: 'example'
  location: 'global'
  properties: {
    displayName: 'Test Free Service'
...
Contributor_Create
```bicep
resource exampleResource 'Microsoft.BillingBenefits/maccs@2026-06-01' = {
  name: 'example'
  location: 'global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/reservationOrderAliases@2026-06-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    ...
    benefitStartTime: '2023-01-15T00:00:00Z'
    billingPlan: 'P1M'
...
ReservationOrderAliasCreateWithRenewProperties
```bicep
resource exampleResource 'Microsoft.BillingBenefits/reservationOrderAliases@2026-06-01' = {
  name: 'example'
  location: 'eastus'
...
```bicep
resource exampleResource 'Microsoft.BillingBenefits/savingsPlanOrderAliases@2026-06-01' = {
  name: 'example'
  properties: {
    appliedScopeProperties: {
    }
