...
* **properties**: [PlaywrightQuotaProperties](#playwrightquotaproperties): The resource-specific properties for this resource.
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'ExecutionMinutes' | string (Required, DeployTimeConstant): The resource name
* **properties**: [PlaywrightWorkspaceQuotaProperties](#playwrightworkspacequotaproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Failed' | 'Succeeded' | string | 'Creating' | 'Deleting' (ReadOnly): The status of the last resource operation.
...
* **percentageUsed**: int (Required, ReadOnly): The percentage of the free trial quota used.
