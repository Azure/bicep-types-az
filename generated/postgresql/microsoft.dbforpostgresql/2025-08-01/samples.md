...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers@2025-08-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/administrators@2025-08-01' = {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/advancedThreatProtectionSettings@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/configurations@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a database.
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/databases@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    charset: 'utf8'
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/firewallRules@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/migrations@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/privateEndpointConnections@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/virtualendpoints@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
