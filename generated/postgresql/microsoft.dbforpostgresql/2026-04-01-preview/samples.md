...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/administrators@2026-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/advancedThreatProtectionSettings@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/configurations@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a database.
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/databases@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    charset: 'utf8'
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/firewallRules@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/migrations@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/privateEndpointConnections@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforPostgreSQL/flexibleServers/virtualendpoints@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
