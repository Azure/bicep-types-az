...
```bicep
resource exampleResource 'Microsoft.DurableTask/schedulers@2026-02-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DurableTask/schedulers/privateEndpointConnections@2026-02-01' = {
...
```bicep
resource exampleResource 'Microsoft.DurableTask/schedulers/taskHubs@2026-02-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
