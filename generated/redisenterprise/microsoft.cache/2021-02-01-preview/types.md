...
* **geoReplication**: [schemas:9_geoReplication](#schemas9georeplication): Optional set of properties to configure geo replication for this database.
...
* **state**: 'Linked' | 'LinkFailed' | 'Linking' | 'UnlinkFailed' | 'Unlinking' (ReadOnly): State of the link between the database resources. Possible values include: 'Linked', 'Linking', 'Unlinking', 'LinkFailed', 'UnlinkFailed'
