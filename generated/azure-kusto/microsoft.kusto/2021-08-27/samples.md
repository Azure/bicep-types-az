...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters@2021-08-27' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/attachedDatabaseConfigurations@2021-08-27' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/principalAssignments@2021-08-27' = {
  parent: parentResource 
  name: 'example'
  properties: {
    principalId: '87654321-1234-1234-1234-123456789123'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/scripts@2021-08-27' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/privateEndpointConnections@2021-08-27' = {
  parent: parentResource 
  name: 'example'
  properties: {
