...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters@2025-02-14' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/attachedDatabaseConfigurations@2025-02-14' = {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases@2025-02-14' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/dataConnections@2025-02-14' = {
  parent: parentResource 
  name: 'example'
  kind: 'CosmosDb'
  location: 'westus'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/principalAssignments@2025-02-14' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/scripts@2025-02-14' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
KustoScriptsCreateOrUpdateWithManagedIdentity
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/scripts@2025-02-14' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/managedPrivateEndpoints@2025-02-14' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupId: 'blob'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/principalAssignments@2025-02-14' = {
  parent: parentResource 
  name: 'example'
  properties: {
    principalId: '87654321-1234-1234-1234-123456789123'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/privateEndpointConnections@2025-02-14' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/sandboxCustomImages@2025-02-14' = {
  parent: parentResource 
  name: 'example'
  properties: {
