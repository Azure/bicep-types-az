...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters@2023-08-15' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/principalAssignments@2023-08-15' = {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases@2023-08-15' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/attachedDatabaseConfigurations@2023-08-15' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/managedPrivateEndpoints@2023-08-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupId: 'blob'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/principalAssignments@2023-08-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    principalId: '87654321-1234-1234-1234-123456789123'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/scripts@2023-08-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/sandboxCustomImages@2023-08-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/privateEndpointConnections@2023-08-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/dataConnections@2023-08-15' = {
  parent: parentResource 
  name: 'example'
  kind: 'CosmosDb'
  location: 'westus'
