...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters@2020-02-15' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases@2020-02-15' = {
  parent: parentResource 
  name: 'example'
  kind: 'ReadWrite'
  location: 'westus'
...
```bicep
resource exampleResource 'Microsoft.Kusto/clusters/databases/principalAssignments@2020-02-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
