...
```bicep
resource exampleResource 'Microsoft.KeyVault/vaults@2021-04-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    accessPolicies: [
...
```bicep
resource exampleResource 'Microsoft.KeyVault/vaults/accessPolicies@2021-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.KeyVault/vaults/privateEndpointConnections@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  etag: ''
  properties: {
...
Create a secret
```bicep
resource exampleResource 'Microsoft.KeyVault/vaults/secrets@2021-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    value: 'secret-value'
