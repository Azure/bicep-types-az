...
* **properties**: [DeletedManagedHsmProperties](#deletedmanagedhsmproperties): Properties of the deleted managed HSM
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [DeletedVaultProperties](#deletedvaultproperties): Properties of the vault
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [ManagedHsmKeyProperties](#managedhsmkeyproperties) (Required): The properties of the key.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [Record](#record): Resource tags
...
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [Record](#record): Tags assigned to the key vault resource.
...
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [Record](#record) (ReadOnly): Resource tags
...
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [Record](#record) (ReadOnly): Tags assigned to the key vault resource.
...
* **tags**: [Record](#record) (ReadOnly): Tags of the original managed HSM.
...
* **scheduledPurgeDate**: string (ReadOnly): The scheduled purged date.
* **tags**: [Record](#record) (ReadOnly): Tags of the original vault.
...
* **Additional Properties Type**: [UserAssignedIdentity](#userassignedidentity) | null
...
## SecretAttributes
### Properties
* **created**: string (ReadOnly): Creation time in seconds since 1970-01-01T00:00:00Z.
* **enabled**: bool: Determines whether the object is enabled.
* **exp**: string: Expiry date in seconds since 1970-01-01T00:00:00Z.
* **nbf**: string: Not before date in seconds since 1970-01-01T00:00:00Z.
* **updated**: string (ReadOnly): Last updated time in seconds since 1970-01-01T00:00:00Z.
...
* **enableRbacAuthorizationOld**: bool: Property that controls how data actions are authorized. When true, the key vault will use Role Based Access Control (RBAC) for authorization of data actions, and the access policies specified in vault properties will be  ignored. When false, the key vault will use the access policies specified in vault properties, and any policy stored on Azure Resource Manager will be ignored. If null or not specified, the vault is created with the default value of false. Note that management actions are always authorized with RBAC.
