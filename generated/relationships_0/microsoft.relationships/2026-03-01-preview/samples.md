...
```bicep
resource exampleResource 'Microsoft.Relationships/dependencyOf@2026-03-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Relationships/serviceGroupMember@2026-03-01-preview' = {
  name: 'example'
  properties: {
