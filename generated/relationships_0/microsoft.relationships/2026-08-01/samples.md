...
```bicep
resource exampleResource 'Microsoft.Relationships/dependencyOf@2026-08-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Relationships/serviceGroupMember@2026-08-01' = {
  name: 'example'
  properties: {
