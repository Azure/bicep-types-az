...
* **properties**: [ComponentProperties](#componentproperties) (ReadOnly): Model for properties of a component.
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [MonitorInstanceProperties](#monitorinstanceproperties) (ReadOnly): Model for properties of a monitor instance.
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [MonitorProperties](#monitorproperties) (ReadOnly): Model for properties of a Monitor.
...
* **healthStateCategory**: 'CustomGroup' | 'Identity' (ReadOnly): Category of component's health state.
...
* **workloadType**: 'Apache' | 'BaseOS' | 'IIS' | 'SQL' (ReadOnly): Type of the workload.
...
* **alertGeneration**: 'Disabled' | 'Enabled' (ReadOnly): Generates alerts or not
