...
```bicep
resource exampleResource 'Microsoft.App/builders@2025-02-02-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.App/builders/builds@2025-02-02-preview' = {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments@2025-02-02-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/certificates@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/daprComponents@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/storages@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps@2025-02-02-preview' = {
  name: 'example'
  kind: 'workflowapp'
  location: 'East Us'
...
```bicep
resource exampleResource 'Microsoft.App/containerApps/authConfigs@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    encryptionSettings: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps/resiliencyPolicies@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps/sourcecontrols@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    branch: 'master'
...
```bicep
resource exampleResource 'Microsoft.App/logicApps@2025-02-02-preview' = {
  name: 'example'
  properties: {
  }
}
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments@2025-02-02-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/certificates@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/daprComponents@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    componentType: 'state.azure.cosmosdb'
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/daprComponents/resiliencyPolicies@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    inboundPolicy: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/daprSubscriptions@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    bulkSubscribe: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/dotNetComponents@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/httpRouteConfigs@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    customDomains: [
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/javaComponents@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/maintenanceConfigurations@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    scheduledEntries: [
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/managedCertificates@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/privateEndpointConnections@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create or update environments storage
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/storages@2025-02-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
...
```bicep
resource exampleResource 'Microsoft.App/sessionPools@2025-02-02-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
