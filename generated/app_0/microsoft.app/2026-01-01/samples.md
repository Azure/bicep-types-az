...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments@2026-01-01' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/certificates@2026-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/daprComponents@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/connectedEnvironments/storages@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
...
```bicep
resource exampleResource 'Microsoft.App/containerApps/sourcecontrols@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    branch: 'master'
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments@2026-01-01' = {
  name: 'example'
  location: 'East US'
  properties: {
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/certificates@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/daprComponents@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    componentType: 'state.azure.cosmosdb'
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/httpRouteConfigs@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    customDomains: [
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/javaComponents@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/maintenanceConfigurations@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    scheduledEntries: [
...
Create or Update Certificate
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/managedCertificates@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/privateEndpointConnections@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create or update environments storage
```bicep
resource exampleResource 'Microsoft.App/managedEnvironments/storages@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureFile: {
