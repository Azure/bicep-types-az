...
* **location**: string: The resource location.
* **name**: string {minLength: 3, maxLength: 24, pattern: "^[a-z0-9][a-z0-9\-]*[a-z0-9]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [AnalyticsConnectorProperties](#analyticsconnectorproperties): Analytics Connector configuration.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Metadata pertaining to creation and last modification of the resource.
* **tags**: [ResourceTags](#resourcetags): Resource tags.
...
### Base Properties
* **name**: string: Name of data destination.

### AnalyticsConnectorDataLakeDataDestination
#### Properties
* **dataLakeName**: string (Required): The name for the Data Lake.
* **type**: 'datalake' (Required): Type of data destination.
...
#### Properties
* **kind**: 'R4' | 'STU3' | string (Required): The kind of FHIR Service.
* **type**: 'fhirservice' (Required): Type of data source.
* **url**: string (Required): The URL of FHIR service.
...
#### Properties
* **extensionSchemaReference**: string: Artifact reference for extension schema.
* **filterConfigurationReference**: string: Artifact reference for filter configurations.
* **type**: 'fhirToParquet' (Required): Type of data mapping.


## AnalyticsConnectorProperties
### Properties
* **dataDestinationConfiguration**: [AnalyticsConnectorDataDestination](#analyticsconnectordatadestination) (Required): Data destination configuration for Analytics Connector.
