...
RegistryCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries@2021-12-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/connectedRegistries@2021-12-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/exportPipelines@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/importPipelines@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/pipelineRuns@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    request: {
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/privateEndpointConnections@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
ReplicationCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/replications@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  tags: {
...
ScopeMapCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/scopeMaps@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
TokenCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/tokens@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    credentials: {
...
WebhookCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/webhooks@2021-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
