...
RegistryCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries@2025-05-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
...
CacheRuleCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/cacheRules@2025-05-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/connectedRegistries@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clientTokenIds: [
...
CredentialSetCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/credentialSets@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/exportPipelines@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/importPipelines@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
ArchiveCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/packages/archives@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    packageSource: {
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/pipelineRuns@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    request: {
...
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/privateEndpointConnections@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
ReplicationCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/replications@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  tags: {
...
ScopeMapCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/scopeMaps@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
TokenCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/tokens@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    credentials: {
...
WebhookCreate
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/webhooks@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
