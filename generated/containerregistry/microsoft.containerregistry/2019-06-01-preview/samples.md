...
AgentPools_Create
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/agentPools@2019-06-01-preview' = {
...
TaskRuns_Create
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/taskRuns@2019-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    forceUpdateTag: 'test'
...
Tasks_Create
```bicep
resource exampleResource 'Microsoft.ContainerRegistry/registries/tasks@2019-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
