...
* **buildType**: 'AutoBuild' | 'QuickBuild' (ReadOnly): The type of build.
...
* **status**: 'Canceled' | 'Error' | 'Failed' | 'Queued' | 'Running' | 'Started' | 'Succeeded' | 'Timeout' (ReadOnly): The current status of the build.
