...
* **tags**: [Dictionary<string,String>](#dictionarystringstring): The tags that will be assigned to the attestation service instance.
...
* **status**: 'Error' | 'NotReady' | 'Ready' (ReadOnly): Status of attestation service. Possible values include: 'Ready', 'NotReady', 'Error'
