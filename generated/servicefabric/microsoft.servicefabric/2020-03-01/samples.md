...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters@2020-03-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    addOnFeatures: [
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applicationTypes@2020-03-01' = {
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applicationTypes/versions@2020-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applications@2020-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    maximumNodes: 3
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applications/services@2020-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    correlationScheme: [
