...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters@2026-03-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    addOnFeatures: [
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applications@2026-03-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applications/services@2026-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    correlationScheme: [
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applicationTypes@2026-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  tags: {
  }
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applicationTypes/versions@2026-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
