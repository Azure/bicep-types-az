...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters@2021-06-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    addOnFeatures: [
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applications@2021-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applications/services@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    correlationScheme: [
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applicationTypes@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  tags: {
  }
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/clusters/applicationTypes/versions@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
