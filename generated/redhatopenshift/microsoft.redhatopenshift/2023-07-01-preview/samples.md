...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openShiftClusters@2023-07-01-preview' = {
  name: 'example'
  location: 'location'
  properties: {
    apiserverProfile: {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/machinePool@2023-07-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/secret@2023-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/syncIdentityProvider@2023-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/syncSet@2023-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
