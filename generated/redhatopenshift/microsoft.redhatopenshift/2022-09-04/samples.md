...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openShiftClusters@2022-09-04' = {
  name: 'example'
  location: 'location'
  properties: {
    apiserverProfile: {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/machinePool@2022-09-04' = {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/secret@2022-09-04' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/syncIdentityProvider@2022-09-04' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/openshiftclusters/syncSet@2022-09-04' = {
  parent: parentResource 
  name: 'example'
  properties: {
