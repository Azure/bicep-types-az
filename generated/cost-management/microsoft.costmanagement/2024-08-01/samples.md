...
```bicep
resource exampleResource 'Microsoft.CostManagement/budgets@2024-08-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.CostManagement/costAllocationRules@2024-08-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CostManagement/exports@2024-08-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.CostManagement/scheduledActions@2024-08-01' = {
  name: 'example'
  kind: 'Email'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CostManagement/settings@2024-08-01' = {
  name: 'example'
  kind: 'taginheritance'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CostManagement/views@2024-08-01' = {
  name: 'example'
