...
* **format**: 'Csv': The format of the export being delivered. Currently only 'Csv' is supported. Possible values include: 'Csv'
...
* **type**: 'ActualCost' | 'AmortizedCost' | 'Usage' (Required): The type of the export. Note that 'Usage' is equivalent to 'ActualCost' and is applicable to exports that do not yet provide data for charges or amortization for service reservations. Possible values include: 'Usage', 'ActualCost', 'AmortizedCost'
...
* **granularity**: 'Daily': The granularity of rows in the export. Currently only 'Daily' is supported. Possible values include: 'Daily'
...
* **executionType**: 'OnDemand' | 'Scheduled': The type of the export execution. Possible values include: 'OnDemand', 'Scheduled'
...
* **status**: 'Completed' | 'DataNotAvailable' | 'Failed' | 'InProgress' | 'NewDataNotAvailable' | 'Queued' | 'Timeout': The last known status of the export execution. Possible values include: 'Queued', 'InProgress', 'Completed', 'Failed', 'Timeout', 'NewDataNotAvailable', 'DataNotAvailable'
...
## ExportSchedule
### Properties
* **recurrence**: 'Annually' | 'Daily' | 'Monthly' | 'Weekly': The schedule recurrence. Possible values include: 'Daily', 'Weekly', 'Monthly', 'Annually'
* **recurrencePeriod**: [ExportRecurrencePeriod](#exportrecurrenceperiod): The start and end date for recurrence schedule.
* **status**: 'Active' | 'Inactive': The status of the export's schedule. If 'Inactive', the export's schedule is paused. Possible values include: 'Active', 'Inactive'
