...
```bicep
resource exampleResource 'Microsoft.CostManagement/budgets@2023-04-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.CostManagement/exports@2023-04-01-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.CostManagement/scheduledActions@2023-04-01-preview' = {
  name: 'example'
  kind: 'Email'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CostManagement/views@2023-04-01-preview' = {
  name: 'example'
