...
* **instanceFlexibility**: 'NotSupported' | 'Off' | 'On' (ReadOnly): Allows reservation discount to be applied across skus within the same Autofit group. Not all skus support instance size flexibility.
...
* **reservedResourceType**: 'CosmosDb' | 'RedHat' | 'SqlDatabases' | 'SuseLinux' | 'VirtualMachines' (ReadOnly): The type of the resource that is being reserved.
