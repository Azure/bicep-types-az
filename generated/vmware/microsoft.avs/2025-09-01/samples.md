...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds@2025-09-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/addons@2025-09-01' = {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/authorizations@2025-09-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/cloudLinks@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/clusters@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clusterSize: 3
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/clusters/datastores@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    netAppVolume: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/clusters/placementPolicies@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'VmHost'
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/globalReachConnections@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/hcxEnterpriseSites@2025-09-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/iscsiPaths@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/licenses@2025-09-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/pureStoragePolicies@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/scriptExecutions@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hiddenParameters: [
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/workloadNetworks/dhcpConfigurations@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dhcpType: 'SERVER'
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/workloadNetworks/dnsServices@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/workloadNetworks/dnsZones@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/workloadNetworks/portMirroringProfiles@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/workloadNetworks/publicIPs@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/workloadNetworks/segments@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AVS/privateClouds/workloadNetworks/vmGroups@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
