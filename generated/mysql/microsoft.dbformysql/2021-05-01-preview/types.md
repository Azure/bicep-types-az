...
## Resource Microsoft.DBforMySQL/flexibleServers@2021-05-01-preview (Async)
...
## Resource Microsoft.DBforMySQL/flexibleServers/databases@2021-05-01-preview (Async)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2021-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforMySQL/flexibleServers/firewallRules@2021-05-01-preview (Async)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2021-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **isConfigPendingRestart**: 'False' | 'True' (ReadOnly): If is the configuration pending restart or not.
* **isDynamicConfig**: 'False' | 'True' (ReadOnly): If is the configuration dynamic.
* **isReadOnly**: 'False' | 'True' (ReadOnly): If is the configuration read only.
* **source**: 'system-default' | 'user-override' (ReadOnly): Source of the configuration.
