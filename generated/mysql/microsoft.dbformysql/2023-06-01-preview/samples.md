...
Create a new server
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers@2023-06-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/administrators@2023-06-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/configurations@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a database
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/databases@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    charset: 'utf8'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/firewallRules@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
