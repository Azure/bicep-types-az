...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/cacheNodes@2023-05-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    error: {
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/enterpriseCustomers@2023-05-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/enterpriseMccCustomers@2023-05-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/enterpriseMccCustomers/enterpriseMccCacheNodes@2023-05-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/ispCustomers@2023-05-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    additionalCustomerProperties: {
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/ispCustomers/ispCacheNodes@2023-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
