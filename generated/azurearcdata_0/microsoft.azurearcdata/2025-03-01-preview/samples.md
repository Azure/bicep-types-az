...
```bicep
resource exampleResource 'Microsoft.AzureArcData/dataControllers@2025-03-01-preview' = {
  name: 'example'
  extendedLocation: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/dataControllers/activeDirectoryConnectors@2025-03-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/postgresInstances@2025-03-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/arclocation'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlManagedInstances@2025-03-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/arclocation'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlManagedInstances/failoverGroups@2025-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerEsuLicenses@2025-03-01-preview' = {
  name: 'example'
  location: 'northeurope'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerInstances@2025-03-01-preview' = {
  name: 'example'
  location: 'northeurope'
  properties: {
    authentication: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerInstances/availabilityGroups@2025-03-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerInstances/databases@2025-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'southeastasia'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerLicenses@2025-03-01-preview' = {
  name: 'example'
  location: 'northeurope'
  properties: {
