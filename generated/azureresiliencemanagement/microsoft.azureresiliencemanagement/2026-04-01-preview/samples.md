...
```bicep
resource exampleResource 'Microsoft.AzureResilienceManagement/drills@2026-04-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Microsoft.AzureResilienceManagement/goalAssignments@2026-04-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureResilienceManagement/goalTemplates@2026-04-01-preview' = {
  name: 'example'
  properties: {
    goalType: 'Resiliency'
...
```bicep
resource exampleResource 'Microsoft.AzureResilienceManagement/recoveryPlans@2026-04-01-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.AzureResilienceManagement/usagePlans@2026-04-01-preview' = {
  name: 'example'
  location: 'global'
  properties: {
    planType: 'Standard'
...
```bicep
resource exampleResource 'Microsoft.AzureResilienceManagement/usagePlans/enrollments@2026-04-01-preview' = {
