...
```bicep
resource exampleResource 'Microsoft.Solutions/applications@2018-03-01' = {
  name: 'example'
  kind: 'ServiceCatalog'
  location: 'East US 2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Solutions/applicationDefinitions@2018-03-01' = {
  name: 'example'
  location: 'East US 2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Solutions/jitRequests@2018-03-01' = {
  name: 'example'
  properties: {
