# Microsoft.Billing @ 2019-04-01-preview

## Resource Microsoft.Billing/billingPeriods/Microsoft.Consumption@2019-04-01-preview (ReadOnly)
...
* **children**: [ManagementGroupAggregatedCostResult](#managementgroupaggregatedcostresult)[] (ReadOnly): Children of a management group
* **currency**: string (ReadOnly): The ISO currency in which the meter is charged, for example, USD.
* **excludedSubscriptions**: string[] (ReadOnly): List of subscription Guids excluded from the calculation of aggregated cost
* **includedSubscriptions**: string[] (ReadOnly): List of subscription Guids included in the calculation of aggregated cost
