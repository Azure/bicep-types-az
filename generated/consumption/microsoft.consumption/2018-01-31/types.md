...
## Resource Microsoft.Consumption/pricesheets@2018-01-31 (ReadOnly)
...
## Filters
### Properties
* **meters**: string[] {maxLength: 10}: The list of filters on meters, mandatory for budgets of usage category.
...
* **meterId**: string (ReadOnly): The meter id
