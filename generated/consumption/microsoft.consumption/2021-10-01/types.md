...
## Resource Microsoft.Consumption/credits@2021-10-01 (ReadOnly)
...
## Resource Microsoft.Consumption/pricesheets@2021-10-01 (ReadOnly)
...
* **locale**: 'cs-cz' | 'da-dk' | 'de-de' | 'en-gb' | 'en-us' | 'es-es' | 'fr-fr' | 'hu-hu' | 'it-it' | 'ja-jp' | 'ko-kr' | 'nb-no' | 'nl-nl' | 'pl-pl' | 'pt-br' | 'pt-pt' | 'ru-ru' | 'sv-se' | 'tr-tr' | 'zh-cn' | 'zh-tw': Language in which the recipient will receive the notification
...
* **eTag**: string (ReadOnly): The eTag for the resource.
* **expiredCredit**: [Amount](#amount) (ReadOnly): The amount plus currency .
* **pendingCreditAdjustments**: [Amount](#amount) (ReadOnly): The amount plus currency .
* **pendingEligibleCharges**: [Amount](#amount) (ReadOnly): The amount plus currency .
* **reseller**: [Reseller](#reseller) (ReadOnly): The reseller properties.

## CreditBalanceSummary
### Properties
* **currentBalance**: [Amount](#amount) (ReadOnly): The amount plus currency .
* **estimatedBalance**: [Amount](#amount) (ReadOnly): The amount plus currency .
* **estimatedBalanceInBillingCurrency**: [AmountWithExchangeRate](#amountwithexchangerate) (ReadOnly): The amount with exchange rate.
...
## PriceSheetModel
### Properties
* **download**: [MeterDetails](#meterdetails) (ReadOnly): The properties of the meter detail.
