...
```bicep
resource exampleResource 'Informatica.DataManagement/organizations@2024-11-29-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Informatica.DataManagement/organizations/serverlessRuntimes@2024-11-29-preview' = {
