...
```bicep
resource exampleResource 'Informatica.DataManagement/organizations@2023-08-20-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Informatica.DataManagement/organizations/serverlessRuntimes@2023-08-20-preview' = {
