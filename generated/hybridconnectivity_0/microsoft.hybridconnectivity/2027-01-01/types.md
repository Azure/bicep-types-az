...
## Resource Microsoft.HybridConnectivity/solutionConfigurations/inventory@2027-01-01
* **Readable Scope(s)**: Tenant, ManagementGroup, Subscription, ResourceGroup, Extension
...
## Resource Microsoft.HybridConnectivity/solutionTypes@2027-01-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2027-01-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function generateAwsTemplate (Microsoft.HybridConnectivity@2027-01-01)
* **Resource**: Microsoft.HybridConnectivity
* **ApiVersion**: 2027-01-01
* **Input**: [GenerateAwsTemplateRequest](#generateawstemplaterequest)
* **Output**: any

## Function generateGcpTemplate (Microsoft.HybridConnectivity@2027-01-01)
* **Resource**: Microsoft.HybridConnectivity
* **ApiVersion**: 2027-01-01
* **Input**: [GenerateGcpTemplateRequest](#generategcptemplaterequest)
* **Output**: any
...
## Function syncNow (Microsoft.HybridConnectivity/solutionConfigurations@2027-01-01)
* **Resource**: Microsoft.HybridConnectivity/solutionConfigurations
* **ApiVersion**: 2027-01-01
* **Output**: [OperationStatusResult](#operationstatusresult)

## Function testPermissions (Microsoft.HybridConnectivity/publicCloudConnectors@2027-01-01)
...
### Properties
* **connectorId**: string (Required): The name of public cloud connector
* **gcpCloudProfile**: [GcpCloudProfile](#gcpcloudprofile): The GCP cloud profile.
* **gcpTemplateFormat**: 'shellscript' | 'terraform' | string: Optional template output format. Defaults to 'terraform' if not provided
* **solutionTypes**: [SolutionTypeSettings](#solutiontypesettings)[]: The list of solution types and their settings
