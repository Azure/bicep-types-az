...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/connections@2025-03-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/connections/flows@2025-03-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/pipelines@2025-03-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
    remoteCloud: 'testdc'
