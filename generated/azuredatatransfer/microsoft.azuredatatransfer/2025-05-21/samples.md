...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/connections@2025-05-21' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/connections/flows@2025-05-21' = {
...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/pipelines@2025-05-21' = {
  name: 'example'
  location: 'East US'
  properties: {
    remoteCloud: 'testdc'
