...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects@2024-01-15' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/aksAssessments@2024-01-15' = {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/groups@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/groups/assessments@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/groups/avsAssessments@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/groups/sqlAssessments@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/groups/webAppAssessments@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/hypervcollectors@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    agentProperties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/importcollectors@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/privateEndpointConnections@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/servercollectors@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    agentProperties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/sqlcollectors@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    agentProperties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/vmwarecollectors@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    agentProperties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/assessmentProjects/webAppCollectors@2024-01-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    agentProperties: {
