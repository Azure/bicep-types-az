...
SearchCreateAutoGeneratedDomainNameLabel
```bicep
resource exampleResource 'Microsoft.Search/searchServices@2025-10-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Search/searchServices/privateEndpointConnections@2025-10-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Search/searchServices/sharedPrivateLinkResources@2025-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupId: 'blob'
