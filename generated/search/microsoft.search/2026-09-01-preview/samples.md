...
```bicep
resource exampleResource 'Microsoft.Search/searchServices@2026-09-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    computeType: 'Default'
...
SearchCreateOrUpdateServiceWithAutoGeneratedDomainNameLabelScope
```bicep
resource exampleResource 'Microsoft.Search/searchServices@2026-09-01-preview' = {
  name: 'example'
  location: 'westus'
...
```bicep
resource exampleResource 'Microsoft.Search/searchServices/privateEndpointConnections@2026-09-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Search/searchServices/sharedPrivateLinkResources@2026-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupId: 'blob'
