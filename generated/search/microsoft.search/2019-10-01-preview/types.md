...
## Resource Microsoft.Search/searchServices@2019-10-01-preview (Async)
...
## NetworkRuleSet
### Properties
* **endpointAccess**: 'Private' | 'Public': The level of access to the search service endpoint. Public, the search service endpoint is reachable from the internet. Private, the search service endpoint can only be accessed via private endpoints. Default is Public.
