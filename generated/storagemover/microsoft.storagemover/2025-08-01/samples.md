...
```bicep
resource exampleResource 'Microsoft.StorageMover/storageMovers@2025-08-01' = {
  name: 'example'
  location: 'eastus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageMover/storageMovers/agents@2025-08-01' = {
...
```bicep
resource exampleResource 'Microsoft.StorageMover/storageMovers/connections@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageMover/storageMovers/endpoints@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageMover/storageMovers/projects@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageMover/storageMovers/projects/jobDefinitions@2025-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
