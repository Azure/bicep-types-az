...
CreateAlias
```bicep
resource exampleResource 'Microsoft.Subscription/aliases@2025-11-01-preview' = {
  name: 'example'
  properties: {
...
putTargetDirectory
```bicep
resource exampleResource 'Microsoft.Subscription/changeTenantRequest@2025-11-01-preview' = {
  name: 'example'
  properties: {
...
TenantPolicy
```bicep
resource exampleResource 'Microsoft.Subscription/policies@2025-11-01-preview' = {
  name: 'example'
