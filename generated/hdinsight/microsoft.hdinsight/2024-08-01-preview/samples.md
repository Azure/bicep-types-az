...
```bicep
resource exampleResource 'Microsoft.HDInsight/clusters@2024-08-01-preview' = {
  name: 'example'
  properties: {
    clusterDefinition: {
      configurations: {
...
Create Application
```bicep
resource exampleResource 'Microsoft.HDInsight/clusters/applications@2024-08-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.HDInsight/clusters/extensions@2024-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  primaryKey: '**********'
...
```bicep
resource exampleResource 'Microsoft.HDInsight/clusters/privateEndpointConnections@2024-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
