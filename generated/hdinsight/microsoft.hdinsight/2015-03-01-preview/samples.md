...
```bicep
resource exampleResource 'Microsoft.HDInsight/clusters@2015-03-01-preview' = {
  name: 'example'
  properties: {
    clusterDefinition: {
      configurations: {
...
Create Application
```bicep
resource exampleResource 'Microsoft.HDInsight/clusters/applications@2015-03-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.HDInsight/clusters/extensions@2015-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  primaryKey: '**********'
