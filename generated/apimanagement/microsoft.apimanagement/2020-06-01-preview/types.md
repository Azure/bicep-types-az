...
* **name**: 'Basic' | 'Consumption' | 'Developer' | 'Isolated' | 'Premium' | 'Standard' (Required): Name of the Sku. Possible values include: 'Developer', 'Standard', 'Premium', 'Basic', 'Consumption', 'Isolated'
...
* **operationNameFormat**: 'Name' | 'Url': The format of the Operation Name for Application Insights telemetries. Default is Name. Possible values include: 'Name', 'Url'
...
## DataMaskingEntity
### Properties
* **mode**: 'Hide' | 'Mask': Data masking mode. Possible values include: 'Mask', 'Hide'
...
* **loggerType**: 'applicationInsights' | 'azureEventHub' | 'azureMonitor' (Required): Logger type. Possible values include: 'azureEventHub', 'applicationInsights', 'azureMonitor'
...
* **status**: 'completed' | 'failed' | 'pending' | 'publishing' (ReadOnly): Portal revision publishing status. Possible values include: 'pending', 'publishing', 'completed', 'failed'
...
### Properties
* **appType**: 'developerPortal' | 'portal' (WriteOnly): Determines the type of application which send the create user request. Default is legacy portal. Possible values include: 'portal', 'developerPortal'
