...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service@2023-03-01-preview' = {
  name: 'example'
  location: 'West US'
  properties: {
    additionalLocations: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis@2023-03-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/diagnostics@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    alwaysLog: 'allErrors'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/attachments@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    content: 'IEJhc2U2NA=='
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/comments@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    createdDate: '2018-02-01T22:21:20.467Z'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    method: 'POST'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/releases@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/resolvers@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: 'Query/users'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/resolvers/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/schemas@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/tagDescriptions@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/wikis@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    documents: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apiVersionSets@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders/authorizations@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders/authorizations/accessPolicies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationServers@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/backends@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/caches@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/certificates@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/contentTypes@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    name: 'Page'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/contentTypes/contentItems@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    en_us: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/diagnostics@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    alwaysLog: 'allErrors'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/documentations@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    content: 'content'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/apis@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/certificateAuthorities@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isTrusted: false
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/hostnameConfigurations@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/groups@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/identityProviders@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clientId: 'facebookid'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/loggers@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/namedValues@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/openidConnectProviders@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
ApiManagementCreatePolicy
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/policyFragments@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalconfigs@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalRevisions@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalsettings@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    subscriptions: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/privateEndpointConnections@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/apiLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/groupLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/wikis@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    documents: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/schemas@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/subscriptions@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'testsub'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'tag1'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags/apiLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    apiId: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apis/echo-api'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags/operationLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags/productLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tenant@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/users@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    confirmation: 'signup'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: 'newapiPath'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/operations@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    method: 'POST'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/operations/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/releases@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/schemas@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contentType: 'application/vnd.ms-azure-apim.xsd+xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apiVersionSets@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Version configuration'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/groups@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'temp group'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/namedValues@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'prop3name'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/policyFragments@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'Test Template ProductName 4'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products/apiLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products/groupLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products/policies@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/schemas@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'sample schema description'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/subscriptions@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'testsub'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'tag1'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags/apiLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    apiId: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/apis/echo-api'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags/operationLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags/productLinks@2023-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
