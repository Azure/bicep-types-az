...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service@2018-01-01' = {
  name: 'example'
  location: 'Central US'
  properties: {
    additionalLocations: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/api-version-sets@2018-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: 'newapiPath'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/diagnostics@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/attachments@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    content: 'IEJhc2U2NA=='
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/comments@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    createdDate: '2018-02-01T22:21:20.467Z'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  name: 'newoperation'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations/policies@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contentFormat: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/policies@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contentFormat: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/releases@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/schemas@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/tagDescriptions@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationServers@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/backends@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/certificates@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/diagnostics@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/groups@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/identityProviders@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clientId: 'facebookid'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/loggers@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/openidConnectProviders@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/policies@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contentFormat: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalsettings@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    subscriptions: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/policies@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contentFormat: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/properties@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/subscriptions@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'testsub'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'tag1'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/templates@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/users@2018-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    confirmation: 'signup'
