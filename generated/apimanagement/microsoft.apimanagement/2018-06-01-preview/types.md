...
* **contentFormat**: 'openapi-link' | 'openapi' | 'openapi+json' | 'swagger-json' | 'swagger-link-json' | 'wadl-link-json' | 'wadl-xml' | 'wsdl-link' | 'wsdl' (WriteOnly): Format of the Content in which the API is getting imported. Possible values include: 'wadl-xml', 'wadl-link-json', 'swagger-json', 'swagger-link-json', 'wsdl', 'wsdl-link', 'openapi', 'openapi+json', 'openapi-link'
...
* **wsdlSelector**: [schemas:44_wsdlSelector](#schemas44wsdlselector) (WriteOnly): Criteria to limit import of WSDL to a subset of the document.
...
### Properties
* **contentFormat**: 'rawxml-link' | 'rawxml' | 'xml-link' | 'xml': Format of the policyContent. Possible values include: 'xml', 'xml-link', 'rawxml', 'rawxml-link'
...
### Properties
* **credentials**: [Dictionary<string,String>](#dictionarystringstring) (Required): The name and SendRule connection string of the event hub for azureEventHub logger.
