...
* **contentFormat**: 'openapi-link' | 'openapi' | 'openapi+json' | 'swagger-json' | 'swagger-link-json' | 'wadl-link-json' | 'wadl-xml' | 'wsdl-link' | 'wsdl' (WriteOnly): Format of the Content in which the API is getting imported.
...
### Properties
* **contentFormat**: 'rawxml-link' | 'rawxml' | 'xml-link' | 'xml': Format of the policyContent.
