...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [SchemaCreateOrUpdateProperties](#schemacreateorupdateproperties): Schema contract Properties.
...
* **document**: [SchemaDocumentProperties](#schemadocumentproperties): Any object
