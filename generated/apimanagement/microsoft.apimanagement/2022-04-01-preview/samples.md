...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service@2022-04-01-preview' = {
  name: 'example'
  location: 'West US'
  properties: {
    additionalLocations: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis@2022-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/diagnostics@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    alwaysLog: 'allErrors'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/attachments@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    content: 'IEJhc2U2NA=='
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/comments@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    createdDate: '2018-02-01T22:21:20.467Z'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    method: 'POST'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations/policies@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/policies@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/releases@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/schemas@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/tagDescriptions@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apiVersionSets@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders/authorizations@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders/authorizations/accessPolicies@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationServers@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/backends@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/caches@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/certificates@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/contentTypes@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    name: 'Page'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/diagnostics@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    alwaysLog: 'allErrors'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/apis@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/certificateAuthorities@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isTrusted: false
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/hostnameConfigurations@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/groups@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/identityProviders@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clientId: 'facebookid'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/loggers@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/namedValues@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/openidConnectProviders@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/policies@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
ApiManagementCreatePolicy
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/policyFragments@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalconfigs@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalRevisions@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalsettings@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    subscriptions: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/privateEndpointConnections@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/policies@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/schemas@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/subscriptions@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'testsub'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'tag1'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/templates@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tenant@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/users@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    confirmation: 'signup'
