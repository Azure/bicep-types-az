...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service@2022-09-01-preview' = {
  name: 'example'
  location: 'West US'
  properties: {
    additionalLocations: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis@2022-09-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/diagnostics@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    alwaysLog: 'allErrors'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/attachments@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    content: 'IEJhc2U2NA=='
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/issues/comments@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    createdDate: '2018-02-01T22:21:20.467Z'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    method: 'POST'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/operations/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/releases@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/resolvers@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: 'Query/users'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/resolvers/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/schemas@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/tagDescriptions@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apis/wikis@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    documents: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/apiVersionSets@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders/authorizations@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationProviders/authorizations/accessPolicies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/authorizationServers@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/backends@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/caches@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/certificates@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/contentTypes@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    name: 'Page'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/contentTypes/contentItems@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    en_us: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/diagnostics@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    alwaysLog: 'allErrors'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/documentations@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    content: 'content'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/apis@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/certificateAuthorities@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isTrusted: false
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/gateways/hostnameConfigurations@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/groups@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/identityProviders@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clientId: 'facebookid'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/loggers@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/namedValues@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/openidConnectProviders@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
ApiManagementCreatePolicy
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/policyFragments@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalconfigs@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalRevisions@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/portalsettings@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    subscriptions: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/privateEndpointConnections@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/apiLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/groupLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/products/wikis@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    documents: [
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/schemas@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/subscriptions@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'testsub'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'tag1'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags/apiLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    apiId: '/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apis/echo-api'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags/operationLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tags/productLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/templates@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/tenant@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/users@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    confirmation: 'signup'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: 'newapiPath'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/operations@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    method: 'POST'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/operations/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/releases@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apis/schemas@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    contentType: 'application/vnd.ms-azure-apim.xsd+xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/apiVersionSets@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Version configuration'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/groups@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'temp group'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/namedValues@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'prop3name'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/policyFragments@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'Test Template ProductName 4'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products/apiLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products/groupLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/products/policies@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    format: 'xml'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/schemas@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'sample schema description'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/subscriptions@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'testsub'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'tag1'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags/apiLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    apiId: '/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/apis/echo-api'
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags/operationLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ApiManagement/service/workspaces/tags/productLinks@2022-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
