...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices@2018-07-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/accountFilters@2018-07-01' = {
...
Create an Asset
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets/assetFilters@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    firstQuality: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/contentKeyPolicies@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a LiveEvent
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/liveEvents@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
Create a LiveOutput
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/liveEvents/liveOutputs@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/streamingEndpoints@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/streamingLocators@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/streamingPolicies@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    noEncryption: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/transforms@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a Job
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/transforms/jobs@2018-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    correlationData: {
