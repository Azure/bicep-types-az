...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices@2021-06-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/privateEndpointConnections@2021-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/accountFilters@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    firstQuality: {
...
Create an Asset
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets/assetFilters@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    firstQuality: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/contentKeyPolicies@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/transforms@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a Job
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/transforms/jobs@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    correlationData: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/streamingPolicies@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    noEncryption: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/streamingLocators@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a LiveEvent
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/liveEvents@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
Create a LiveOutput
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/liveEvents/liveOutputs@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/streamingEndpoints@2021-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
