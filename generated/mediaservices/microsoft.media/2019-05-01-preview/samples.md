...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices@2019-05-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/accountFilters@2019-05-01-preview' = {
...
Create an Asset
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets/assetFilters@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    firstQuality: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/contentKeyPolicies@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a LiveEvent
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/liveEvents@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
Create a LiveOutput
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/liveEvents/liveOutputs@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices/streamingEndpoints@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/streamingLocators@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/streamingPolicies@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    noEncryption: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/transforms@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a Job
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/transforms/jobs@2019-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    correlationData: {
