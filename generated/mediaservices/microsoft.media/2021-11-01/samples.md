...
```bicep
resource exampleResource 'Microsoft.Media/mediaservices@2021-11-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/accountFilters@2021-11-01' = {
...
Create an Asset
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets/assetFilters@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    firstQuality: {
...
Creates a Track
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/assets/tracks@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    track: {
...
```bicep
resource exampleResource 'Microsoft.Media/mediaServices/streamingPolicies@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    noEncryption: {
