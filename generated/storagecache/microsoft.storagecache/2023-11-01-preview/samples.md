...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems@2023-11-01-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches@2023-11-01-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches/storageTargets@2023-11-01-preview' = {
