...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems@2026-01-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/autoExportJobs@2026-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/autoImportJobs@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/expansionJobs@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/importJobs@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches@2026-01-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches/storageTargets@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    junctions: [
