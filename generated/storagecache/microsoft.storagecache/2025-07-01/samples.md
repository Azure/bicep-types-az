...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems@2025-07-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/autoExportJobs@2025-07-01' = {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/autoImportJobs@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/importJobs@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches@2025-07-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches/storageTargets@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    junctions: [
