...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems@2024-03-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.StorageCache/amlFilesystems/importJobs@2024-03-01' = {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches@2024-03-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.StorageCache/caches/storageTargets@2024-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    junctions: [
