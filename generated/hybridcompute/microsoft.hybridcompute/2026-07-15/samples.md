...
```bicep
resource exampleResource 'Microsoft.HybridCompute/gateways@2026-07-15' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.HybridCompute/licenses@2026-07-15' = {
  name: 'example'
  location: 'eastus2euap'
  properties: {
    licenseDetails: {
...
```bicep
resource exampleResource 'Microsoft.HybridCompute/machines@2026-07-15' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.HybridCompute/machines/extensions@2026-07-15' = {
...
```bicep
resource exampleResource 'Microsoft.HybridCompute/machines/licenseProfiles@2026-07-15' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus2euap'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.HybridCompute/machines/runCommands@2026-07-15' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.HybridCompute/privateLinkScopes@2026-07-15' = {
  name: 'example'
  location: 'westus'
}
```
...
```bicep
resource exampleResource 'Microsoft.HybridCompute/privateLinkScopes/privateEndpointConnections@2026-07-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
SettingsUpdate
```bicep
resource exampleResource 'Microsoft.HybridCompute/settings@2026-07-15' = {
  name: 'example'
  properties: {
    gatewayProperties: {
