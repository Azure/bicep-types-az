...
* **properties**: [MachinePropertiesAutoGenerated](#machinepropertiesautogenerated): Hybrid Compute Machine properties
...
* **location**: string (Required): The geo-location where the resource lives
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [MachineExtensionPropertiesAutoGenerated](#machineextensionpropertiesautogenerated): Describes Machine Extension Properties.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
