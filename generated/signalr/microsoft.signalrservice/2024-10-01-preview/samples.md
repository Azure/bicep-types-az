...
```bicep
resource exampleResource 'Microsoft.SignalRService/signalR@2024-10-01-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.SignalRService/signalR/customCertificates@2024-10-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/signalR/customDomains@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    customCertificate: {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/signalR/privateEndpointConnections@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/signalR/replicas@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/signalR/replicas/sharedPrivateLinkResources@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupId: 'sites'
...
```bicep
resource exampleResource 'Microsoft.SignalRService/signalR/sharedPrivateLinkResources@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupId: 'sites'
