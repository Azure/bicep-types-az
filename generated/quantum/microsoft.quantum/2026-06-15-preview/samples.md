...
```bicep
resource exampleResource 'Microsoft.Quantum/workspaces@2026-06-15-preview' = {
  name: 'example'
  location: 'West US'
  properties: {
    providers: [
      ...
      }
      {
        ...
        targetQuotas: [
          {
            highMinutesLifetime: 30
            standardMinutesLifetime: 300
            targetId: 'suiteProvider.target1'
          }
        ]
      }
    ]
