...
Create Account
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts@2026-01-15-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/capabilityHosts@2026-01-15-preview' = {
...
PutCommitmentPlan
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/commitmentPlans@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    autoRenew: true
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/connections@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    authType: 'None'
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/defenderForAISettings@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
PutDeployment
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/deployments@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
PutEncryptionScope
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/encryptionScopes@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    keySource: 'Microsoft.KeyVault'
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/managedNetworks@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    managedNetwork: {
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/managedNetworks/outboundRules@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'FQDN'
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/privateEndpointConnections@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create Project
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/projects@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/projects/applications@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/projects/applications/agentDeployments@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    agents: [
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/projects/capabilityHosts@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/projects/connections@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    authType: 'None'
...
PutRaiBlocklist
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/raiBlocklists@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
PutRaiBlocklistItem
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/raiBlocklists/raiBlocklistItems@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isRegex: false
...
PutRaiPolicy
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/raiPolicies@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
PutRaiToolLabel
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/raiToolLabels@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    accountScope: {
...
PutRaiTopic
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/raitopics@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/accounts/testRaiExternalSafetyProvider@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/commitmentPlans@2026-01-15-preview' = {
  name: 'example'
  kind: 'SpeechServices'
  location: 'West US'
  properties: {
...
PutCommitmentPlan
```bicep
resource exampleResource 'Microsoft.CognitiveServices/commitmentPlans/accountAssociations@2026-01-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/quotaTiers@2026-01-15-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.CognitiveServices/raiExternalSafetyProviders@2026-01-15-preview' = {
  name: 'example'
  properties: {
...
PutRaiPolicy
```bicep
resource exampleResource 'Microsoft.CognitiveServices/raiPolicy@2026-01-15-preview' = {
  name: 'example'
  properties: {
    basePolicyName: 'Microsoft.Default'
    contentFilters: [
