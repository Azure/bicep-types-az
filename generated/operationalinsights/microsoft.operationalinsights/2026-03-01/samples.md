...
ClustersCreate
```bicep
resource exampleResource 'Microsoft.OperationalInsights/clusters@2026-03-01' = {
  name: 'example'
  location: 'eastus'
  sku: {
...
WorkspacesCreate
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces@2026-03-01' = {
  name: 'example'
...
DataExportCreate
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/dataExports@2026-03-01' = {
...
DataSourcesCreate
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/dataSources@2026-03-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/linkedServices@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/linkedStorageAccounts@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    storageAccountIds: [
...
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/savedSearches@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/storageInsightConfigs@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    containers: [
...
SummaryLogsUpsert
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/summaryLogs@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
TablesUpsert
```bicep
resource exampleResource 'Microsoft.OperationalInsights/workspaces/tables@2026-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    schema: {
