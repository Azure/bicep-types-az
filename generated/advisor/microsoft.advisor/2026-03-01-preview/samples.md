...
PutAssessment
```bicep
resource exampleResource 'Microsoft.Advisor/assessments@2026-03-01-preview' = {
  name: 'example'
  properties: {
    locale: 'en-us'
...
PutConfigurations
```bicep
resource exampleResource 'Microsoft.Advisor/configurations@2026-03-01-preview' = {
  name: 'example'
  properties: {
    digests: [
      {
...
CreateSuppression
```bicep
resource exampleResource 'Microsoft.Advisor/recommendations/suppressions@2026-03-01-preview' = {
