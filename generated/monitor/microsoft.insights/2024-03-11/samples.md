...
```bicep
resource exampleResource 'Microsoft.Insights/dataCollectionEndpoints@2024-03-11' = {
  name: 'example'
  location: 'eastus'
  properties: {
    networkAcls: {
...
```bicep
resource exampleResource 'Microsoft.Insights/dataCollectionRuleAssociations@2024-03-11' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Insights/dataCollectionRules@2024-03-11' = {
  name: 'example'
  kind: 'AgentSettings'
  location: 'eastus'
  properties: {
