...
* **operator**: 'Equals' | 'GreaterThan' | 'GreaterThanOrEqual' | 'LessThan' | 'LessThanOrEqual' (Required): The criteria operator. Possible values include: 'Equals', 'GreaterThan', 'GreaterThanOrEqual', 'LessThan', 'LessThanOrEqual'
...
* **timeAggregation**: 'Average' | 'Count' | 'Maximum' | 'Minimum' | 'Total' (Required): Aggregation type. Possible values include: 'Count', 'Average', 'Minimum', 'Maximum', 'Total'

## Dimension
### Properties
* **name**: string (Required): Name of the dimension
* **operator**: 'Exclude' | 'Include' (Required): Operator for dimension values. Possible values include: 'Include', 'Exclude'
