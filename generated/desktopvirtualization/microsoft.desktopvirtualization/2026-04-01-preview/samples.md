...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/appAttachPackages@2026-04-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/applicationGroups@2026-04-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/applicationGroups/applications@2026-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools@2026-04-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
    ...
    conditionalRdpProperty: 'drivestoredirect:s:*:AuthContext:c1'
    customRdpProperty: {
    }
    deploymentScope: 'Geographical'
    directUDP: 'Enabled'
...
MSIXPackages_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/msixPackages@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'displayname'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/privateEndpointConnections@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
      description: 'Approved by admin@contoso.com'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/sessionHostConfigurations@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    availabilityZones: [
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/sessionHostManagements@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
SessionHost_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/sessionHosts@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
}
```
...
ScalingPlans_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans@2026-04-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans/personalSchedules@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    daysOfWeek: [
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans/pooledSchedules@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    daysOfWeek: [
...
Workspace_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/workspaces@2026-04-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/workspaces/privateEndpointConnections@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
