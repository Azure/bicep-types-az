...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/appAttachPackages@2025-09-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/applicationGroups@2025-09-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/applicationGroups/applications@2025-09-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools@2025-09-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
...
MSIXPackages_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/msixPackages@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'displayname'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/privateEndpointConnections@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/sessionHostConfigurations@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    availabilityZones: [
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/sessionHostManagements@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
ScalingPlans_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans@2025-09-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans/personalSchedules@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    daysOfWeek: [
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans/pooledSchedules@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    daysOfWeek: [
...
Workspace_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/workspaces@2025-09-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/workspaces/privateEndpointConnections@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
