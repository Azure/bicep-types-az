...
Workspace_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/workspaces@2024-08-08-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
...
ScalingPlans_Create
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans@2024-08-08-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans/pooledSchedules@2024-08-08-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    daysOfWeek: [
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/scalingPlans/personalSchedules@2024-08-08-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    daysOfWeek: [
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/applicationGroups@2024-08-08-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
    description: 'des1'
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/sessionHostManagements@2024-08-08-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/hostPools/sessionHostConfigurations@2024-08-08-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    availabilityZones: [
...
```bicep
resource exampleResource 'Microsoft.DesktopVirtualization/appAttachPackages@2024-08-08-preview' = {
  name: 'example'
