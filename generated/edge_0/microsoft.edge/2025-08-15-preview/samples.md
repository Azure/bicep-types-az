...
ConfigTemplates_CreateOrUpdate_MaximumSet - generated by [MaximumSet] rule
```bicep
resource exampleResource 'Microsoft.Edge/configTemplates@2025-08-15-preview' = {
  name: 'example'
  location: 'egqjo'
  properties: {
    description: 'wrgwfpuqo'
  }
  tags: {
  }
}
...
Contexts_CreateOrUpdate_MaximumSet - generated by [MaximumSet] rule
```bicep
resource exampleResource 'Microsoft.Edge/contexts@2025-08-15-preview' = {
  name: 'example'
  location: 'pkquwbplcp'
  properties: {
    capabilities: [
...
```bicep
resource exampleResource 'Microsoft.Edge/contexts/siteReferences@2025-08-15-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Edge/contexts/workflows@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
...
```bicep
resource exampleResource 'Microsoft.Edge/contexts/workflows/versions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
...
```bicep
resource exampleResource 'Microsoft.Edge/contexts/workflows/versions/executions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'ugf'
...
```bicep
resource exampleResource 'Microsoft.Edge/diagnostics@2025-08-15-preview' = {
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
    type: 'EdgeZone'
...
```bicep
resource exampleResource 'Microsoft.Edge/schemaReferences@2025-08-15-preview' = {
  name: 'example'
  properties: {
    schemaId: 'vxgxfkfws'
  }
...
```bicep
resource exampleResource 'Microsoft.Edge/schemas@2025-08-15-preview' = {
  name: 'example'
  location: 'alvi'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Edge/schemas/dynamicSchemas@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Edge/schemas/dynamicSchemas/versions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    value: 'uiaqdwsi'
...
```bicep
resource exampleResource 'Microsoft.Edge/schemas/versions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    value: 'uiaqdwsi'
...
```bicep
resource exampleResource 'Microsoft.Edge/solutionTemplates@2025-08-15-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Edge/targets@2025-08-15-preview' = {
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
    type: 'EdgeZone'
...
```bicep
resource exampleResource 'Microsoft.Edge/targets/solutions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
...
```bicep
resource exampleResource 'Microsoft.Edge/targets/solutions/instances@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
...
```bicep
resource exampleResource 'Microsoft.Edge/targets/solutions/versions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
...
```bicep
resource exampleResource 'Microsoft.Edge/workflows@2025-08-15-preview' = {
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
    type: 'EdgeZone'
...
```bicep
resource exampleResource 'Microsoft.Edge/workflows/versions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
...
```bicep
resource exampleResource 'Microsoft.Edge/workflows/versions/executions@2025-08-15-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
    name: 'szjrwimeqyiue'
  ...
  properties: {
    ...
    status: {
      ...
      status: 27
      statusMessage: 'hjladqtikpisiatirhelwz'
      updateTime: '2025-08-21T02:41:52.046Z'
    }
