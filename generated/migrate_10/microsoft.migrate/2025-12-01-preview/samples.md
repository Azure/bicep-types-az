...
```bicep
resource exampleResource 'Microsoft.Migrate/migrateProjects/migrationEntities@2025-12-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Migrate/migrateProjects/migrationEntityGroups@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Migrate/migrateProjects/tasks@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'lzhl'
...
```bicep
resource exampleResource 'Microsoft.Migrate/migrateProjects/waves@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
