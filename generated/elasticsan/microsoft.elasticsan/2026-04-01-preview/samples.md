...
```bicep
resource exampleResource 'Microsoft.ElasticSan/elasticSans@2026-04-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.ElasticSan/elasticSans/privateEndpointConnections@2026-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ElasticSan/elasticSans/volumegroups@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Microsoft.ElasticSan/elasticSans/volumegroups/snapshots@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    creationData: {
...
```bicep
resource exampleResource 'Microsoft.ElasticSan/elasticSans/volumegroups/volumes@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    creationData: {
