...
```bicep
resource exampleResource 'Microsoft.VideoIndexer/accounts@2025-04-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.VideoIndexer/accounts/privateEndpointConnections@2025-04-01' = {
