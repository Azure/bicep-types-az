...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/enterpriseMccCustomers@2026-06-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/enterpriseMccCustomers/enterpriseMccCacheNodes@2026-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/ispCustomers@2026-06-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    additionalCustomerProperties: {
...
```bicep
resource exampleResource 'Microsoft.ConnectedCache/ispCustomers/ispCacheNodes@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
