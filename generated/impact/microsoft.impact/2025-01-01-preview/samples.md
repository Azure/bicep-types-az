...
CreateConnector
```bicep
resource exampleResource 'Microsoft.Impact/connectors@2025-01-01-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.Impact/workloadImpacts@2025-01-01-preview' = {
  name: 'example'
  properties: {
...
Creating an insight
```bicep
resource exampleResource 'Microsoft.Impact/workloadImpacts/insights@2025-01-01-preview' = {
