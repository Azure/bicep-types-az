...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners@2023-01-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachines@2023-01-01-preview' = {
  name: 'example'
  location: 'northeurope'
  properties: {
