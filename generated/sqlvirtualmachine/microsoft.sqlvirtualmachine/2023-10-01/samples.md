...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups@2023-10-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners@2023-10-01' = {
...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachines@2023-10-01' = {
  name: 'example'
  location: 'northeurope'
  properties: {
