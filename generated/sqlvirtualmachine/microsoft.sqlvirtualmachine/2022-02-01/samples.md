...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups@2022-02-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners@2022-02-01' = {
...
```bicep
resource exampleResource 'Microsoft.SqlVirtualMachine/sqlVirtualMachines@2022-02-01' = {
  name: 'example'
  location: 'northeurope'
  properties: {
