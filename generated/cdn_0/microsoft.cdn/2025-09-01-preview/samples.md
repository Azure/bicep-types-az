...
```bicep
resource exampleResource 'Microsoft.Cdn/cdnWebApplicationFirewallPolicies@2025-09-01-preview' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    customRules: {
...
Profiles_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles@2025-09-01-preview' = {
  name: 'example'
  location: 'global'
  sku: {
...
AFDEndpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints@2025-09-01-preview' = {
...
Routes_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints/routes@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cacheConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/agents@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    customDomains: [
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/customDomains@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureDnsZone: {
...
Endpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'WestUs'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/customDomains@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hostName: 'www.someDomain.net'
...
OriginGroups_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/originGroups@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    healthProbeSettings: {
...
Origins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/origins@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
KeyGroups_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/keyGroups@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    keyReferences: [
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    authentication: {
...
AFDOrigins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups/origins@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabledState: 'Enabled'
    ...
    originCapacityResource: {
      enabled: 'Enabled'
      originIngressRateThreshold: 10
      originRequestRateThreshold: 1000
      region: 'EastUs'
    }
...
Rules_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/ruleSets/rules@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    actions: [
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/secrets@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/securityPolicies@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
...
## microsoft.cdn/webagents

Create or Update Web Agent
```bicep
resource exampleResource 'Microsoft.Cdn/webAgents@2025-09-01-preview' = {
  name: 'example'
  location: 'WestUs'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/webAgents/knowledgeSources@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
