...
```bicep
resource exampleResource 'Microsoft.Cdn/cdnWebApplicationFirewallPolicies@2024-06-01-preview' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    customRules: {
...
Profiles_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles@2024-06-01-preview' = {
  name: 'example'
  location: 'global'
  sku: {
...
AFDEndpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints@2024-06-01-preview' = {
...
Routes_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints/routes@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cacheConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/customDomains@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureDnsZone: {
...
Endpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'WestUs'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/customDomains@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hostName: 'www.someDomain.net'
...
OriginGroups_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/originGroups@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    healthProbeSettings: {
...
Origins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/origins@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
KeyGroups_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/keyGroups@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    keyReferences: [
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    healthProbeSettings: {
...
AFDOrigins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups/origins@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabledState: 'Enabled'
...
Rules_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/ruleSets/rules@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    actions: [
...
Secrets_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/secrets@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
      ...
      secretSource: {
        id: '/subscriptions/subid/resourcegroups/RG/providers/Microsoft.KeyVault/vaults/kvName/secrets/certificatename'
      }
...
resource exampleResource 'Microsoft.Cdn/profiles/secrets@2024-06-01-preview' = {
  ...
  properties: {
    parameters: {
      ...
      keyId: 'customKeyId'
      secretSource: {
        id: '/subscriptions/subid/resourcegroups/RG/providers/Microsoft.KeyVault/vaults/kvName/secrets/urlsigningkeyname'
      }
      secretVersion: 'abcdef1234578900abcdef1234567890'
    }
  }
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/securityPolicies@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/targetGroups@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    targetEndpoints: [
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/tunnelPolicies@2024-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    domains: [
