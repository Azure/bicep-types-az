...
NameSpaceCreate
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces@2021-11-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/networkRuleSets@2021-11-01' = {
...
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/AuthorizationRules@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/privateEndpointConnections@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
SBAliasCreate
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/disasterRecoveryConfigs@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/migrationConfigurations@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/queues/authorizationRules@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
QueueCreate
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/queues@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/topics/authorizationRules@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
TopicCreate
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/topics@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enableExpress: true
...
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/topics/subscriptions/rules@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    correlationFilter: {
...
SubscriptionCreate
```bicep
resource exampleResource 'Microsoft.ServiceBus/namespaces/topics/subscriptions@2021-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
