...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [schemas:22_properties](#schemas22properties): AuthorizationRule properties.
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [schemas:28_properties](#schemas28properties): Properties required to the Create Or Update Alias(Disaster Recovery configurations)
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [schemas:0_properties](#schemas0properties): Properties supplied to create or update IpFilterRules
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [schemas:48_properties](#schemas48properties): Properties required to the Create Migration Configuration
...
* **properties**: [schemas:45_properties](#schemas45properties): NetworkRuleSet properties
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [schemas:19_properties](#schemas19properties): Properties supplied to create or update VirtualNetworkRules
