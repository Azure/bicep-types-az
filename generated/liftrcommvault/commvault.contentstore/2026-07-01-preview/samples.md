...
```bicep
resource exampleResource 'Commvault.ContentStore/cloudAccounts@2026-07-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Commvault.ContentStore/cloudAccounts/plans@2026-07-01-preview' = {
...
```bicep
resource exampleResource 'Commvault.ContentStore/cloudAccounts/protectionGroups@2026-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Commvault.ContentStore/cloudAccounts/storages@2026-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    class: 'COLD'
