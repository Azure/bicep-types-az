...
```bicep
resource exampleResource 'Microsoft.Maintenance/configurationAssignments@2021-05-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Maintenance/maintenanceConfigurations@2021-05-01' = {
  name: 'example'
  location: 'westus2'
  properties: {
