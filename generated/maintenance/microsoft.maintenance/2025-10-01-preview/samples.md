...
```bicep
resource exampleResource 'Microsoft.Maintenance/applyUpdates@2025-10-01-preview' = {
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.Maintenance/configurationAssignments@2025-10-01-preview' = {
  name: 'example'
  properties: {
    filter: {
      locations: [
...
```bicep
resource exampleResource 'Microsoft.Maintenance/maintenanceConfigurations@2025-10-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
