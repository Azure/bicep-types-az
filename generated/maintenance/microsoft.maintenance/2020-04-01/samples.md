...
```bicep
resource exampleResource 'Microsoft.Maintenance/configurationAssignments@2020-04-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Maintenance/maintenanceConfigurations@2020-04-01' = {
  name: 'example'
  location: 'westus2'
  properties: {
