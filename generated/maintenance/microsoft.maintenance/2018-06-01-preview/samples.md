...
```bicep
resource exampleResource 'Microsoft.Maintenance/configurationAssignments@2018-06-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Maintenance/maintenanceConfigurations@2018-06-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
