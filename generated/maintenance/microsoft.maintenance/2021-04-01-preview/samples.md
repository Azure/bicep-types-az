...
```bicep
resource exampleResource 'Microsoft.Maintenance/configurationAssignments@2021-04-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Maintenance/maintenanceConfigurations@2021-04-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
