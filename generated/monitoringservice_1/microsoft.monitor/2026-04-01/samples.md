...
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver and backfill.
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver with allowedFormats set to cefRfc3164
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver with allowedFormats set to cefRfc5424
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver with allowedFormats set to rawCef
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver with allowedFormats set to syslogRfc3164
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver with allowedFormats set to syslogRfc3164 and allowSkipPriHeader set to false
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver with allowedFormats set to syslogRfc3164 and syslogRfc5424 for migration
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
...
Create a PipelineGroup instance using a syslog receiver with allowedFormats set to syslogRfc5424
```bicep
resource exampleResource 'Microsoft.Monitor/pipelineGroups@2026-04-01' = {
  name: 'example'
  extendedLocation: {
