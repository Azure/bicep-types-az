...
```bicep
resource exampleResource 'Microsoft.ContainerInstance/containerGroups@2026-07-01' = {
  name: 'example'
  location: 'westeurope'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerInstance/sandboxGroups@2026-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    networkProfile: {
