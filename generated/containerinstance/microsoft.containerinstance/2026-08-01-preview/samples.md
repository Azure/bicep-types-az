...
```bicep
resource exampleResource 'Microsoft.ContainerInstance/aiAgentsGroups@2026-08-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    networkProfile: {
...
```bicep
resource exampleResource 'Microsoft.ContainerInstance/containerGroups@2026-08-01-preview' = {
  name: 'example'
  location: 'westeurope'
  properties: {
