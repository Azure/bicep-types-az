...
```bicep
resource exampleResource 'Microsoft.ContainerInstance/containerGroups@2026-06-01-preview' = {
  name: 'example'
  location: 'westeurope'
  properties: {
...
## microsoft.containerinstance/sandboxgroups

Create or update a SandboxGroup
```bicep
resource exampleResource 'Microsoft.ContainerInstance/sandboxGroups@2026-06-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    networkProfile: {
