...
RedisCacheCreate
```bicep
resource exampleResource 'Microsoft.Cache/redis@2023-08-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/firewallRules@2023-08-01' = {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/patchSchedules@2023-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    scheduleEntries: [
...
LinkedServer_Create
```bicep
resource exampleResource 'Microsoft.Cache/redis/linkedServers@2023-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/privateEndpointConnections@2023-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/accessPolicies@2023-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/accessPolicyAssignments@2023-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
