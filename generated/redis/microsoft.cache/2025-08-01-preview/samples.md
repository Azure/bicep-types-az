...
RedisCacheCreate
```bicep
resource exampleResource 'Microsoft.Cache/redis@2025-08-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/accessPolicies@2025-08-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/accessPolicyAssignments@2025-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/firewallRules@2025-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    endIP: '192.168.1.4'
...
LinkedServer_Create
```bicep
resource exampleResource 'Microsoft.Cache/redis/linkedServers@2025-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/patchSchedules@2025-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    scheduleEntries: [
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/privateEndpointConnections@2025-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
