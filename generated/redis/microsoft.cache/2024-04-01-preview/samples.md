...
RedisCacheCreate
```bicep
resource exampleResource 'Microsoft.Cache/redis@2024-04-01-preview' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/accessPolicies@2024-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/accessPolicyAssignments@2024-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/firewallRules@2024-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    endIP: '192.168.1.4'
...
LinkedServer_Create
```bicep
resource exampleResource 'Microsoft.Cache/redis/linkedServers@2024-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/patchSchedules@2024-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    scheduleEntries: [
...
```bicep
resource exampleResource 'Microsoft.Cache/redis/privateEndpointConnections@2024-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
