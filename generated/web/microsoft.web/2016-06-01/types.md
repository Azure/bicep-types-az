...
* **customParameterValues**: [Dictionary<string,String>](#dictionarystringstring): Dictionary of custom parameter values
* **displayName**: string: Display name
* **nonSecretParameterValues**: [Dictionary<string,String>](#dictionarystringstring): Dictionary of nonsecret parameter values
* **parameterValues**: [Dictionary<string,String>](#dictionarystringstring): Dictionary of parameter values
...
* **importMethod**: 'NotSpecified' | 'SoapPassThrough' | 'SoapToRest'
