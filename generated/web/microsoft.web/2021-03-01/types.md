...
## Resource Microsoft.Web/sites/config@2021-03-01 (WriteOnly)
* **Valid Scope(s)**: ResourceGroup
* **Discriminator**: name
...
## Resource Microsoft.Web/sites/functions/keys@2021-03-01 (WriteOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2021-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Web/sites/slots/config@2021-03-01 (WriteOnly)
* **Valid Scope(s)**: ResourceGroup
* **Discriminator**: name
...
## Resource Microsoft.Web/sites/slots/functions/keys@2021-03-01 (WriteOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2021-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Web/staticSites/builds/config@2021-03-01 (WriteOnly)
* **Valid Scope(s)**: ResourceGroup
* **Discriminator**: name
...
## Resource Microsoft.Web/staticSites/config@2021-03-01 (WriteOnly)
* **Valid Scope(s)**: ResourceGroup
* **Discriminator**: name
