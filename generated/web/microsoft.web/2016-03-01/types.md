...
* **renderingType**: 'NoGraph' | 'Table' | 'TimeSeries' | 'TimeSeriesPerInstance' (ReadOnly): Rendering Type
...
## NameValuePair
### Properties
* **name**: string (ReadOnly): Pair name.
* **value**: string (ReadOnly): Pair value.
...
* **name**: string (ReadOnly): Unique name of the rule.
...
* **tags**: string[] (ReadOnly): An array of category tags that the rule contains.
