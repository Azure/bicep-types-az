...
* **systemData**: systemData (WriteOnly)
...
* **kind**: string
* **name**: string (Required, DeployTimeConstant)
* **properties**: schemas:182_properties
* **systemData**: systemData
...
* **kind**: string
* **name**: string (Required, DeployTimeConstant)
* **properties**: schemas:231_properties
* **systemData**: systemData
...
* **kind**: string
* **name**: string (Required, DeployTimeConstant)
* **properties**: schemas:257_properties
* **systemData**: systemData
...
* **kind**: string
* **name**: string (Required, DeployTimeConstant)
* **properties**: schemas:213_properties
* **systemData**: systemData
...
* **kind**: string
* **name**: string (Required, DeployTimeConstant)
* **properties**: schemas:247_properties
* **systemData**: systemData
...
* **kind**: string
* **name**: string (Required, DeployTimeConstant)
* **properties**: schemas:118_properties
* **systemData**: systemData
