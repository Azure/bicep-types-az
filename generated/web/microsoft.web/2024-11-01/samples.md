...
```bicep
resource exampleResource 'Microsoft.Web/certificates@2024-11-01' = {
  name: 'example'
  location: 'East US'
  properties: {
    hostNames: [
...
```bicep
resource exampleResource 'Microsoft.Web/hostingEnvironments@2024-11-01' = {
  name: 'example'
  kind: 'Asev3'
...
```bicep
resource exampleResource 'Microsoft.Web/hostingEnvironments/configurations@2024-11-01' = {
...
```bicep
resource exampleResource 'Microsoft.Web/hostingEnvironments/multiRolePools@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    workerCount: 3
...
```bicep
resource exampleResource 'Microsoft.Web/hostingEnvironments/privateEndpointConnections@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Web/hostingEnvironments/workerPools@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    workerCount: 3
...
```bicep
resource exampleResource 'Microsoft.Web/kubeEnvironments@2024-11-01' = {
  name: 'example'
  location: 'East US'
  properties: {
    staticIp: '1.2.3.4'
...
```bicep
resource exampleResource 'Microsoft.Web/serverfarms@2024-11-01' = {
  name: 'example'
  kind: 'app'
  location: 'East US'
  properties: {
...
Clone web app
```bicep
resource exampleResource 'Microsoft.Web/sites@2024-11-01' = {
  name: 'example'
  kind: 'app'
  location: 'East US'
  properties: {
...
Update FTP Allowed
```bicep
resource exampleResource 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    allow: true
...
Create Or Update Certificate
```bicep
resource exampleResource 'Microsoft.Web/sites/certificates@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
Update App Settings
```bicep
resource exampleResource 'Microsoft.Web/sites/config@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    Setting1: 'Value1'
...
```bicep
resource exampleResource 'Microsoft.Web/sites/privateEndpointConnections@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
...
Clone web app slot
```bicep
resource exampleResource 'Microsoft.Web/sites/slots@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'app'
  location: 'East US'
...
Update FTP Allowed
```bicep
resource exampleResource 'Microsoft.Web/sites/slots/basicPublishingCredentialsPolicies@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    allow: true
...
```bicep
resource exampleResource 'Microsoft.Web/sites/slots/certificates@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
...
Approves or rejects a private endpoint connection for a site.
```bicep
resource exampleResource 'Microsoft.Web/sites/slots/privateEndpointConnections@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites@2024-11-01' = {
  name: 'example'
  location: 'West US 2'
  properties: {
    branch: 'master'
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/basicAuth@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/builds/config@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    setting1: 'someval'
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/builds/databaseConnections@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/builds/linkedBackends@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/builds/userProvidedFunctionApps@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/config@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    setting1: 'someval'
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/customDomains@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/databaseConnections@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    connectionIdentity: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/linkedBackends@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    backendResourceId: '/subscription/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/backendRg/providers/Microsoft.Web/sites/testBackend'
...
Approves or rejects a private endpoint connection for a site.
```bicep
resource exampleResource 'Microsoft.Web/staticSites/privateEndpointConnections@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
...
```bicep
resource exampleResource 'Microsoft.Web/staticSites/userProvidedFunctionApps@2024-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    functionAppRegion: 'West US 2'
