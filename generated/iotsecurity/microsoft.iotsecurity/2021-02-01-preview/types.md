...
* **authorizedState**: 'Authorized' | 'Unauthorized' | string (ReadOnly): Authorized state of the device.
* **businessFunction**: string (ReadOnly): Device business function
* **cpes**: string[] (ReadOnly): List of Common Platform Enumeration (CPE)
* **criticality**: 'High' | 'Low' | 'Normal' | string (ReadOnly): Device criticality.
...
* **purdueLevel**: 'Enterprise' | 'ProcessControl' | 'Supervisory' | string (ReadOnly): Purdue level of the device.
...
* **type**: 'Enterprise' | 'Ot' | string (ReadOnly): Type of sensor
...
* **slotType**: 'AnalogIO' | 'CommAdapter' | 'Cpu' | 'DigitalIO' | 'Generic' | 'Hmi' | 'Supply' | string (ReadOnly): Slot type.
