...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/servers@2017-12-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/servers/administrators@2017-12-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/servers/configurations@2017-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
DatabaseCreate
```bicep
resource exampleResource 'Microsoft.DBforMySQL/servers/databases@2017-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    charset: 'utf8'
...
FirewallRuleCreate
```bicep
resource exampleResource 'Microsoft.DBforMySQL/servers/firewallRules@2017-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/servers/securityAlertPolicies@2017-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/servers/virtualNetworkRules@2017-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
