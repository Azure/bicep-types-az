# Microsoft.Devices @ 2026-10-01-preview

## Resource Microsoft.Devices/IotHubs@2026-10-01-preview
...
## Resource Microsoft.Devices/IotHubs/certificates@2026-10-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Devices/IotHubs/eventHubEndpoints/ConsumerGroups@2026-10-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Devices/iotHubs/privateEndpointConnections@2026-10-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function $testall (Microsoft.Devices/IotHubs/routing@2026-10-01-preview)
...
## Function $testnew (Microsoft.Devices/IotHubs/routing@2026-10-01-preview)
* **Resource**: Microsoft.Devices/IotHubs/routing
* **ApiVersion**: 2026-10-01-preview
* **Input**: [TestRouteInput](#testrouteinput)
* **Output**: [TestRouteResult](#testrouteresult)

## Function checkNameAvailability (Microsoft.Devices@2026-10-01-preview)
...
## Function exportDevices (Microsoft.Devices/IotHubs@2026-10-01-preview)
* **Resource**: Microsoft.Devices/IotHubs
* **ApiVersion**: 2026-10-01-preview
* **Input**: [ExportDevicesRequest](#exportdevicesrequest)
* **Output**: [JobResponse](#jobresponse)

## Function failover (Microsoft.Devices/IotHubs@2026-10-01-preview)
* **Resource**: Microsoft.Devices/IotHubs
* **ApiVersion**: 2026-10-01-preview
* **Input**: [FailoverInput](#failoverinput)
* **Output**: any

## Function generateVerificationCode (Microsoft.Devices/IotHubs/certificates@2026-10-01-preview)
* **Resource**: Microsoft.Devices/IotHubs/certificates
* **ApiVersion**: 2026-10-01-preview
* **Output**: [CertificateWithNonceDescription](#certificatewithnoncedescription)

## Function importDevices (Microsoft.Devices/IotHubs@2026-10-01-preview)
* **Resource**: Microsoft.Devices/IotHubs
* **ApiVersion**: 2026-10-01-preview
* **Input**: [ImportDevicesRequest](#importdevicesrequest)
* **Output**: [JobResponse](#jobresponse)

## Function listkeys (Microsoft.Devices/IotHubs/IotHubKeys@2026-10-01-preview)
...
## Function listkeys (Microsoft.Devices/IotHubs@2026-10-01-preview)
* **Resource**: Microsoft.Devices/IotHubs
* **ApiVersion**: 2026-10-01-preview
* **Output**: [SharedAccessSignatureAuthorizationRuleListResult](#sharedaccesssignatureauthorizationrulelistresult)

## Function verify (Microsoft.Devices/IotHubs/certificates@2026-10-01-preview)
* **Resource**: Microsoft.Devices/IotHubs/certificates
* **ApiVersion**: 2026-10-01-preview
...
* **certificateAuthorityResourceId**: string: Full certificate authority resource ID for ADR linked standard SKU hubs.
...
## DeviceRegistry
### Properties
* **dataPlaneHostName**: string: The host name for the data plane endpoint of the associated Azure Device Registry.
* **identity**: [DeviceRegistryIdentity](#deviceregistryidentity): The identity used to manage the ADR namespace from the data plane.
* **linkingProperties**: [DeviceRegistryLinkingProperties](#deviceregistrylinkingproperties) (ReadOnly): The properties related to linking the IoT Hub with the Azure Device Registry.
* **namespaceResourceId**: string: The identifier of the Azure Device Registry namespace
* **namespaceUuid**: string: The UUID of the associated Azure Device Registry namespace.

## DeviceRegistryIdentity
### Properties
* **type**: 'SystemAssigned' | 'UserAssigned' | string: The type of the identity.
* **userAssignedIdentity**: string: The user assigned identity if the identity type is 'UserAssigned'.

## DeviceRegistryLinkingProperties
### Properties
* **error**: [ErrorDetails](#errordetails) (ReadOnly): The last error encountered when linking the IoT Hub with an Azure Device Registry.
* **state**: 'Failed' | 'InProgress' | 'Orphaned' | 'Success' | string (ReadOnly): Indicates whether the IoT Hub is linked with an Azure Device Registry.
...
* **details**: string (ReadOnly): The error details.
* **httpStatusCode**: string (ReadOnly): The HTTP status code.
...
* **connectionProfile**: 'Classic' | 'MqttV5' | string: The connection profile that the IoT hub uses for device connections. Defaults to 'Classic'.
* **deviceHostName**: string (ReadOnly): The name of the device host. Supports secure connections over TLS 1.3.
* **deviceRegistry**: [DeviceRegistry](#deviceregistry) (ReadOnly): Represents properties related to the Azure Device Registry (ADR).
...
* **mqttV5Settings**: [MqttV5Settings](#mqttv5settings): The custom topic configuration for an Event Grid-backed MQTT v5 IoT hub. This property is valid only when connectionProfile is 'MqttV5'.
...
## MqttV5Settings
### Properties
* **topicGroups**: [TopicGroup](#topicgroup)[]: The customer-defined groups of topic templates that devices publish to.
...
* **dataSchema**: string: The data schema reference that is used to interpret the message body.
...
* **messagePayloadFormat**: 'DOObservationV1' | 'None' | string: The format of the message payload delivered to this endpoint.
...
## TopicGroup
### Properties
* **topicGroupId**: string: The customer-supplied identifier used to reconcile the topic group during updates.
* **topicTemplates**: string[]: The topic templates in this group.
