...
* **backupStorageRedundancy**: 'Geo' | 'Local' | 'Zone' | string (ReadOnly): The storage redundancy type of the copied backup
...
* **requestedBackupStorageRedundancy**: 'Geo' | 'Local' | 'Zone' | string (ReadOnly): The storage redundancy type of the copied backup
