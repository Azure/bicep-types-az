...
* **databaseEdition**: 'Basic' | 'BusinessCritical' | 'GeneralPurpose' | 'Premium' | 'Standard' (ReadOnly): The edition of the recommended elastic pool. The ElasticPoolEdition enumeration contains all the valid editions.
