# Microsoft.AzureArcData @ 2023-03-15-preview

## Resource Microsoft.AzureArcData/dataControllers@2023-03-15-preview
...
## Resource Microsoft.AzureArcData/dataControllers/activeDirectoryConnectors@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/postgresInstances@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): The extendedLocation of the resource.
...
## Resource Microsoft.AzureArcData/sqlAvailabilityGroups@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [SqlAvailabilityGroupProperties](#sqlavailabilitygroupproperties): null
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.AzureArcData/sqlAvailabilityGroups' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AzureArcData/sqlAvailabilityGroups/databases@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [SqlAvailabilityGroupMultiDatabaseReplicaResourceProperties](#sqlavailabilitygroupmultidatabasereplicaresourceproperties) (Required): Properties of Arc Sql Availability Group Multiple Database Replica
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.AzureArcData/sqlAvailabilityGroups/databases' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AzureArcData/sqlAvailabilityGroups/sqlServerInstances@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [SqlAvailabilityGroupReplicaResourceProperties](#sqlavailabilitygroupreplicaresourceproperties) (Required): Properties of Arc Sql Availability Group Replica
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.AzureArcData/sqlAvailabilityGroups/sqlServerInstances' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AzureArcData/sqlManagedInstances@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): The extendedLocation of the resource.
...
## Resource Microsoft.AzureArcData/sqlManagedInstances/failoverGroups@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerInstances@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerInstances/databases@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerInstances/sqlAvailabilityGroups@2023-03-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.AzureArcData/sqlServerInstances/sqlAvailabilityGroups' (ReadOnly, DeployTimeConstant): The resource type
...
### Properties
* **availabilityModeDesc**: string: Availability Synchronization mode description of availability group replica.
...
* **createDate**: string: Date that the replica was created.
* **endpointUrl**: string: Mirroring endpoint URL of availability group replica
* **failoverModeDesc**: string: failover mode description of the availability group replica.
* **modifyDate**: string: Date that the replica was modified.
* **primaryRoleAllowConnectionsDesc**: string: Allowed the connections for primary role of the availability group replica.
...
* **secondaryRoleAllowConnectionsDesc**: string: Allowed the connections for secondary role of availability group replica.
* **seedingModeDesc**: string: Describes seeding mode.
* **sessionTimeout**: int: The time-out period of availability group session replica, in seconds.

## AvailabilityGroupState
### Properties
* **availabilityGroupReplicaRole**: string: Role description of the availability group replica.
* **connectedStateDesc**: string: Connected state description of the availability group replica.
* **lastConnectErrorDescription**: string: Last connect error description of the availability group replica.
* **lastConnectErrorTimestamp**: string: Last connect error time stamp of the availability group replica.
* **operationalStateDesc**: string: Operation state description of the availability group replica
* **recoveryHealthDesc**: string: Recovery health description of the availability group replica.
* **synchronizationHealthDesc**: string: Synchronization health description of the availability group replica.
...
* **isCommitParticipant**: bool: Whether this replica is transaction committer.
* **isLocal**: bool: Whether the availability database is local.
* **isPrimaryReplica**: bool: Returns 1 if the replica is primary, or 0 if it is a secondary replica.
* **isSuspended**: bool: Whether this data movement is suspended.
...
* **collectionTimestamp**: string: Timestamp for when the data was collected from the client machine.
* **dbFailover**: bool: SQL Server availability group failover for database health conditions.
* **dtcSupport**: bool: SQL Server availability group DTC support enabled.
* **instanceName**: string: The name of the instance name which availability group primary is on.
* **isContained**: bool: SQL Server availability group contained system databases.
* **isDistributed**: bool: SQL Server distributed availability group.
* **requiredSynchronizedSecondariesCommit**: int: Availability group required the number of synchronized secondary to commit.
* **version**: int: SQL Server availability group current version.
