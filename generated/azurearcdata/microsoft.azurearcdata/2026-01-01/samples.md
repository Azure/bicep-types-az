...
```bicep
resource exampleResource 'Microsoft.AzureArcData/dataControllers@2026-01-01' = {
  name: 'example'
  extendedLocation: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/dataControllers/activeDirectoryConnectors@2026-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/postgresInstances@2026-01-01' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/arclocation'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlManagedInstances@2026-01-01' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/arclocation'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlManagedInstances/failoverGroups@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerEsuLicenses@2026-01-01' = {
  name: 'example'
  location: 'northeurope'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerInstances@2026-01-01' = {
  name: 'example'
  location: 'northeurope'
  properties: {
    authentication: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerInstances/availabilityGroups@2026-01-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerInstances/databases@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'southeastasia'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureArcData/sqlServerLicenses@2026-01-01' = {
  name: 'example'
  location: 'northeurope'
  properties: {
