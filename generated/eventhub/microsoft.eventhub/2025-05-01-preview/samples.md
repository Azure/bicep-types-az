...
ClusterPut
```bicep
resource exampleResource 'Microsoft.EventHub/clusters@2025-05-01-preview' = {
  name: 'example'
...
NamespaceCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces@2025-05-01-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/applicationGroups@2025-05-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/authorizationRules@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
EHAliasCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/disasterRecoveryConfigs@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
EHEventHubCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/eventhubs@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    captureDescription: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/eventhubs/authorizationRules@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
ConsumerGroupCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/eventhubs/consumergroups@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/networkRuleSets@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    defaultAction: 'Deny'
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/privateEndpointConnections@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/schemagroups@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupProperties: {
