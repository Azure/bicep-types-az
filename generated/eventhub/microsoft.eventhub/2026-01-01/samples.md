...
ClusterPut
```bicep
resource exampleResource 'Microsoft.EventHub/clusters@2026-01-01' = {
  name: 'example'
...
NamespaceCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces@2026-01-01' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/applicationGroups@2026-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/authorizationRules@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
EHAliasCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/disasterRecoveryConfigs@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
EHEventHubCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/eventhubs@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    captureDescription: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/eventhubs/authorizationRules@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rights: [
...
ConsumerGroupCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/eventhubs/consumergroups@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/networkRuleSets@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    defaultAction: 'Deny'
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/privateEndpointConnections@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/schemagroups@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupProperties: {
