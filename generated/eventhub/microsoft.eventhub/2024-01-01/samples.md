...
ClusterPut
```bicep
resource exampleResource 'Microsoft.EventHub/clusters@2024-01-01' = {
  name: 'example'
...
NamespaceCreate
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces@2024-01-01' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/networkRuleSets@2024-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    defaultAction: 'Deny'
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/privateEndpointConnections@2024-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
```bicep
resource exampleResource 'Microsoft.EventHub/namespaces/schemagroups@2024-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupProperties: {
