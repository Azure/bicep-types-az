...
```bicep
resource exampleResource 'Microsoft.Datadog/agreements@2025-01-07' = {
  name: 'example'
  properties: {
    accepted: true
  }
...
Monitors_Create
```bicep
resource exampleResource 'Microsoft.Datadog/monitors@2025-01-07' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Datadog/monitors/monitoredSubscriptions@2025-01-07' = {
...
```bicep
resource exampleResource 'Microsoft.Datadog/monitors/singleSignOnConfigurations@2025-01-07' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enterpriseAppId: '00000000-0000-0000-0000-000000000000'
...
```bicep
resource exampleResource 'Microsoft.Datadog/monitors/tagRules@2025-01-07' = {
  parent: parentResource 
  name: 'example'
  properties: {
    automuting: true
