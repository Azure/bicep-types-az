...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries@2023-02-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/codes@2023-02-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/codes/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/components@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/components/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/data@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/data/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/environments@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/environments/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/models@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/models/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
Create Workspace
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces@2023-02-01-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/batchEndpoints@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/batchEndpoints/deployments@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/codes@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/codes/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/components@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/components/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/computes@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/connections@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    authType: 'None'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/data@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/data/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/datastores@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/environments@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/environments/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featuresets@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featuresets/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featurestoreEntities@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featurestoreEntities/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/jobs@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/labelingJobs@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/models@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Model container description'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/models/versions@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/onlineEndpoints@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/onlineEndpoints/deployments@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/privateEndpointConnections@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/schedules@2023-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
