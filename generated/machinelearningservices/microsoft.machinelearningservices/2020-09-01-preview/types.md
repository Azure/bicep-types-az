...
* **environmentImageRequest**: [schemas:141_environmentImageRequest](#schemas141environmentimagerequest) (WriteOnly): The Environment, models and assets needed for inferencing.
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **identity**: [Identity](#identity) (ReadOnly): Identity for the resource.
* **keys**: [schemas:141_keys](#schemas141keys) (WriteOnly): The authentication keys.
...
* **dataCollection**: [schemas:110_dataCollection](#schemas110datacollection) (WriteOnly): Details of the data collection options specified.
* **dnsNameLabel**: string (WriteOnly): The Dns label for the service.
* **encryptionProperties**: [schemas:110_encryptionProperties](#schemas110encryptionproperties) (WriteOnly): The encryption properties.
...
* **vnetConfiguration**: [schemas:110_vnetConfiguration](#schemas110vnetconfiguration) (WriteOnly): The virtual network configuration.
...
* **properties**: [schemas:53_properties](#schemas53properties): AKS properties

### AmlCompute
#### Properties
* **computeType**: 'AmlCompute' (Required): An Azure Machine Learning compute.
* **properties**: [schemas:54_properties](#schemas54properties): AML Compute properties

### ComputeInstance
#### Properties
* **computeType**: 'ComputeInstance' (Required): An Azure Machine Learning compute instance.
* **properties**: [schemas:55_properties](#schemas55properties): Compute Instance properties
...
* **labelCategories**: [Dictionary<string,LabelCategory>](#dictionarystringlabelcategory) (Required): Label categories of the job.
* **labelingJobMediaProperties**: [mediaType](#mediatype) (Required): Properties in an labeling job of image media.
...
* **properties**: [Dictionary<string,String>](#dictionarystringstring): The job property dictionary. Properties can be added, but not removed or altered.
* **status**: 'Canceled' | 'CancelRequested' | 'Completed' | 'Failed' | 'Finalizing' | 'NotResponding' | 'NotStarted' | 'Paused' | 'Preparing' | 'Provisioning' | 'Queued' | 'Running' | 'Starting' (ReadOnly): Status of the job. Possible values include: 'NotStarted', 'Starting', 'Provisioning', 'Preparing', 'Queued', 'Running', 'Finalizing', 'CancelRequested', 'Completed', 'Failed', 'Canceled', 'NotResponding', 'Paused'
* **statusMessages**: [StatusMessage](#statusmessage)[] (ReadOnly): Status messages of the job.
* **tags**: [Dictionary<string,String>](#dictionarystringstring): The job tag dictionary. Tags can be added, removed, and updated.
...
* **classes**: [Dictionary<string,LabelClass>](#dictionarystringlabelclass) (Required): Dictionary of label classes in this category.
...
## mediaType
### Properties
* **annotationType**: 'BoundingBox' | 'Classification' | 'InstanceSegmentation': Annotation type of image labeling tasks. Possible values include: 'Classification', 'BoundingBox', 'InstanceSegmentation'
* **mediaType**: 'Image' | 'Text' (Required): Media type of data asset. Possible values include: 'Image', 'Text'
### Additional Properties
...
* **level**: 'Error' | 'Information' | 'Warning' (ReadOnly): Severity level of the status message. Possible values include: 'Error', 'Information', 'Warning'
...
* **linkType**: 'Synapse': Type of the link target. Possible values include: 'Synapse'
...
* **environment**: [schemas:116_environment](#schemas116environment) (WriteOnly): The details of the AZURE ML environment.
* **environmentReference**: [schemas:116_environmentReference](#schemas116environmentreference) (WriteOnly): The unique identifying details of the AZURE ML environment.
...
### Properties
* **docker**: [schemas:119_docker](#schemas119docker) (WriteOnly): The definition of a Docker container.
...
* **python**: [schemas:119_python](#schemas119python) (WriteOnly): Settings for a Python environment.
* **r**: [schemas:119_r](#schemas119r) (WriteOnly): Settings for a R environment.
* **spark**: [schemas:119_spark](#schemas119spark) (WriteOnly): The configuration for a Spark environment.
...
* **baseImageRegistry**: [schemas:125_baseImageRegistry](#schemas125baseimageregistry) (WriteOnly): Image registry that contains the base image.
