...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/codes@2022-12-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/codes/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/components@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/components/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/environments@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/environments/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/models@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/models/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
Create Workspace
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces@2022-12-01-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/batchEndpoints@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/batchEndpoints/deployments@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/codes@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/codes/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/components@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/components/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/computes@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/connections@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    authType: 'None'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/data@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/data/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/datastores@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/environments@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/environments/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/jobs@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/labelingJobs@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/models@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Model container description'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/models/versions@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/onlineEndpoints@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/onlineEndpoints/deployments@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/privateEndpointConnections@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/schedules@2022-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
