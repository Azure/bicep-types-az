...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries@2024-10-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/codes@2024-10-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/codes/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/components@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/components/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/data@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/data/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/environments@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/environments/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/models@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/registries/models/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
Create Workspace
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces@2024-10-01-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/batchEndpoints@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/batchEndpoints/deployments@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/capabilityHosts@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/codes@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/codes/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/components@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/components/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/computes@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/connections@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    authType: 'None'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/connections/deployments@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'Azure.OpenAI'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/connections/raiBlocklists@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/connections/raiBlocklists/raiBlocklistItems@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isRegex: false
...
Create Rai policy
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/connections/raiPolicies@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'SystemManaged'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/data@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/data/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/datastores@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
Create Endpoint
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/endpoints@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    name: 'Azure.OpenAI'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/endpoints/deployments@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'Azure.OpenAI'
...
Create Rai policy
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/endpoints/raiPolicies@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'SystemManaged'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/environments@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/environments/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featuresets@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featuresets/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featurestoreEntities@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/featurestoreEntities/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/inferencePools@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/inferencePools/endpoints@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/inferencePools/groups@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/marketplaceSubscriptions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    modelId: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/models@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Model container description'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/models/versions@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/onlineEndpoints@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/onlineEndpoints/deployments@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/outboundRules@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'FQDN'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/privateEndpointConnections@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/schedules@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'Microsoft.MachineLearningServices/workspaces/serverlessEndpoints@2024-10-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'SystemAssigned'
