...
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Scaling' | 'Succeeded' | 'Updating' (ReadOnly): Possible values for DeploymentProvisioningState.
...
### Properties
* **dataType**: 'MLTable' | 'UriFile' | 'UriFolder' (Required): Enum to determine the type of data.
* **description**: string: The asset description text.
* **isArchived**: bool: Is the asset archived?
* **latestVersion**: string (ReadOnly): The latest version inside this container.
* **nextVersion**: string (ReadOnly): The next auto incremental version
...
* **serviceDataAccessAuthIdentity**: 'None' | 'WorkspaceSystemAssignedIdentity' | 'WorkspaceUserAssignedIdentity'
...
* **endpoint**: string: Azure cloud endpoint for the storage account.
* **fileShareName**: string (Required): [Required] TODO - File share name.
* **protocol**: string: Protocol used to communicate with the storage account.
* **serviceDataAccessAuthIdentity**: 'None' | 'WorkspaceSystemAssignedIdentity' | 'WorkspaceUserAssignedIdentity'
...
* **secretsType**: 'AccountKey' | 'Certificate' | 'KerberosKeytab' | 'KerberosPassword' | 'Sas' | 'ServicePrincipal' (Required): Enum to determine the datastore secrets type.
...
* **description**: string: The asset description text.
* **environmentType**: 'Curated' | 'UserCreated' (ReadOnly): Environment type is either user created or curated by Azure ML service
...
* **status**: 'CancelRequested' | 'Canceled' | 'Completed' | 'Failed' | 'Finalizing' | 'NotResponding' | 'NotStarted' | 'Paused' | 'Preparing' | 'Provisioning' | 'Queued' | 'Running' | 'Scheduled' | 'Starting' | 'Unknown' (ReadOnly): The status of a job.
* **tags**: [ResourceBaseTags](#resourcebasetags): Tag dictionary. Tags can be added, removed, and updated.
### AutoMLJob
#### Properties
...
* **scheduleStatus**: 'Disabled' | 'Enabled': Enum to describe status of schedule
...
### RecurrenceSchedule
#### Properties
* **frequency**: 'Day' | 'Hour' | 'Minute' | 'Month' | 'Week' (Required): Enum to describe the frequency of a recurrence schedule
...
* **weekdays**: 'Friday' | 'Monday' | 'Saturday' | 'Sunday' | 'Thursday' | 'Tuesday' | 'Wednesday'[]: List of weekdays for recurrence schedule pattern
...
### Base Properties
* **logVerbosity**: 'Critical' | 'Debug' | 'Error' | 'Info' | 'NotSet' | 'Warning': Enum for setting log verbosity.
### Classification
#### Properties
* **allowedModels**: 'BernoulliNaiveBayes' | 'DecisionTree' | 'ExtremeRandomTrees' | 'GradientBoosting' | 'KNN' | 'LightGBM' | 'LinearSVM' | 'LogisticRegression' | 'MultinomialNaiveBayes' | 'RandomForest' | 'SGD' | 'SVM' | 'XGBoostClassifier'[]: Allowed models for classification task.
* **blockedModels**: 'BernoulliNaiveBayes' | 'DecisionTree' | 'ExtremeRandomTrees' | 'GradientBoosting' | 'KNN' | 'LightGBM' | 'LinearSVM' | 'LogisticRegression' | 'MultinomialNaiveBayes' | 'RandomForest' | 'SGD' | 'SVM' | 'XGBoostClassifier'[]: Blocked models for classification task.
* **primaryMetric**: 'AUCWeighted' | 'Accuracy' | 'AveragePrecisionScoreWeighted' | 'NormMacroRecall' | 'PrecisionScoreWeighted': Primary metrics for classification tasks.
* **taskType**: 'Classification' (Required): [Required] Task type for AutoMLJob.

### Forecasting
#### Properties
* **allowedModels**: 'Arimax' | 'AutoArima' | 'Average' | 'DecisionTree' | 'ElasticNet' | 'ExponentialSmoothing' | 'ExtremeRandomTrees' | 'GradientBoosting' | 'KNN' | 'LassoLars' | 'LightGBM' | 'Naive' | 'Prophet' | 'RandomForest' | 'SGD' | 'SeasonalAverage' | 'SeasonalNaive' | 'TCNForecaster' | 'XGBoostRegressor'[]: Allowed models for forecasting task.
* **blockedModels**: 'Arimax' | 'AutoArima' | 'Average' | 'DecisionTree' | 'ElasticNet' | 'ExponentialSmoothing' | 'ExtremeRandomTrees' | 'GradientBoosting' | 'KNN' | 'LassoLars' | 'LightGBM' | 'Naive' | 'Prophet' | 'RandomForest' | 'SGD' | 'SeasonalAverage' | 'SeasonalNaive' | 'TCNForecaster' | 'XGBoostRegressor'[]: Blocked models for forecasting task.
* **forecastingSettings**: [ForecastingSettings](#forecastingsettings): Forecasting specific parameters.
* **primaryMetric**: 'NormalizedMeanAbsoluteError' | 'NormalizedRootMeanSquaredError' | 'R2Score' | 'SpearmanCorrelation': Primary metrics for Forecasting task.
...
#### Properties
* **primaryMetric**: 'AUCWeighted' | 'Accuracy' | 'AveragePrecisionScoreWeighted' | 'IOU' | 'NormMacroRecall' | 'PrecisionScoreWeighted': Primary metrics for classification multilabel tasks.
* **taskType**: 'ImageClassificationMultilabel' (Required): [Required] Task type for AutoMLJob.

### ImageInstanceSegmentation
#### Properties
* **primaryMetric**: 'MeanAveragePrecision': Primary metrics for InstanceSegmentation tasks.
* **taskType**: 'ImageInstanceSegmentation' (Required): [Required] Task type for AutoMLJob.

### ImageObjectDetection
#### Properties
* **primaryMetric**: 'MeanAveragePrecision': Primary metrics for Image ObjectDetection task.
* **taskType**: 'ImageObjectDetection' (Required): [Required] Task type for AutoMLJob.

### Regression
#### Properties
* **allowedModels**: 'DecisionTree' | 'ElasticNet' | 'ExtremeRandomTrees' | 'GradientBoosting' | 'KNN' | 'LassoLars' | 'LightGBM' | 'RandomForest' | 'SGD' | 'XGBoostRegressor'[]: Allowed models for regression task.
* **blockedModels**: 'DecisionTree' | 'ElasticNet' | 'ExtremeRandomTrees' | 'GradientBoosting' | 'KNN' | 'LassoLars' | 'LightGBM' | 'RandomForest' | 'SGD' | 'XGBoostRegressor'[]: Blocked models for regression task.
* **primaryMetric**: 'NormalizedMeanAbsoluteError' | 'NormalizedRootMeanSquaredError' | 'R2Score' | 'SpearmanCorrelation': Primary metrics for Regression task.
...
#### Properties
* **primaryMetric**: 'AUCWeighted' | 'Accuracy' | 'AveragePrecisionScoreWeighted' | 'IOU' | 'NormMacroRecall' | 'PrecisionScoreWeighted' (ReadOnly): Primary metrics for classification multilabel tasks.
* **taskType**: 'TextClassificationMultilabel' (Required): [Required] Task type for AutoMLJob.

### TextNer
#### Properties
* **primaryMetric**: 'AUCWeighted' | 'Accuracy' | 'AveragePrecisionScoreWeighted' | 'NormMacroRecall' | 'PrecisionScoreWeighted' (ReadOnly): Primary metrics for classification tasks.
...
three days apart.
* **featureLags**: 'Auto' | 'None': Flag for generating lags for the numeric features.
...
* **shortSeriesHandlingConfig**: 'Auto' | 'Drop' | 'None' | 'Pad': The parameter defining how if AutoML should handle short time series.
* **targetAggregateFunction**: 'Max' | 'Mean' | 'Min' | 'None' | 'Sum': Target aggregate function.
...
* **useStl**: 'None' | 'Season' | 'SeasonTrend': Configure STL Decomposition of the time-series target column.
...
## CommandJobLimits
### Properties
* **jobLimitsType**: 'Command' | 'Sweep' (Required)
...
#### Properties
* **rule**: 'Random' | 'Sobol': The specific type of random algorithm
...
* **modelType**: 'CustomModel' | 'MLFlowModel' | 'TritonModel': The async operation state.
...
* **properties**: [EndpointPropertiesBaseProperties](#endpointpropertiesbaseproperties): Property dictionary. Properties can be added, but not removed or altered.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' (ReadOnly): State of endpoint provisioning.
* **publicNetworkAccess**: 'Disabled' | 'Enabled': Enum to determine whether PublicNetworkAccess is Enabled or Disabled.
* **scoringUri**: string (ReadOnly): Endpoint URI.
* **swaggerUri**: string (ReadOnly): Endpoint Swagger URI.
...
* **codeConfiguration**: [CodeConfiguration](#codeconfiguration): Configuration for a scoring code asset.
* **description**: string: Description of the endpoint deployment.
* **egressPublicNetworkAccess**: 'Disabled' | 'Enabled': Enum to determine whether PublicNetworkAccess is Enabled or Disabled for egress of a deployment.
* **environmentId**: string: ARM resource ID of the environment specification for the endpoint deployment.
* **environmentVariables**: [EndpointDeploymentPropertiesBaseEnvironmentVariables](#endpointdeploymentpropertiesbaseenvironmentvariables): Environment variables configuration for the deployment.
