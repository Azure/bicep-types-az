...
Create cluster
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters@2025-09-15-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
Create ArcSetting
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings@2025-09-15-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings/extensions@2025-09-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    extensionParameters: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/deploymentSettings@2025-09-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    arcNodeResourceIds: [
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/securitySettings@2025-09-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates@2025-09-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates/updateRuns@2025-09-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    progress: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updateSummaries@2025-09-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices@2025-09-15-preview' = {
  name: 'example'
  kind: 'HCI'
  properties: {
    deviceConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices/jobs@2025-09-15-preview' = {
  parent: parentResource 
  name: 'example'
  kind: 'HCI'
  properties: {
