...
Create cluster
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters@2024-04-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
Create ArcSetting
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings@2024-04-01' = {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings/extensions@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    extensionParameters: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/deploymentSettings@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    arcNodeResourceIds: [
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/securitySettings@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates/updateRuns@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    progress: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updateSummaries@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices@2024-04-01' = {
  name: 'example'
  kind: 'HCI'
  properties: {
    deviceConfiguration: {
