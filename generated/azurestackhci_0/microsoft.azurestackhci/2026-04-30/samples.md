...
Create cluster
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters@2026-04-30' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
Create ArcSetting
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings@2026-04-30' = {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings/extensions@2026-04-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
    extensionParameters: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/deploymentSettings@2026-04-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
    arcNodeResourceIds: [
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/securitySettings@2026-04-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates@2026-04-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates/updateRuns@2026-04-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
    progress: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updateSummaries@2026-04-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices@2026-04-30' = {
  name: 'example'
  kind: 'HCI'
  properties: {
    deviceConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices/jobs@2026-04-30' = {
  parent: parentResource 
  name: 'example'
  kind: 'HCI'
  properties: {
