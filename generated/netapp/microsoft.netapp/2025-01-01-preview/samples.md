...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts@2025-01-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupPolicies@2025-01-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupVaults@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupVaults/backups@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    label: 'myLabel'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/buckets@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/path'
...
Snapshots_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
Subvolumes_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/subvolumes@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/subvolumePath'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/volumeQuotaRules@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/snapshotPolicies@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/volumeGroups@2025-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
