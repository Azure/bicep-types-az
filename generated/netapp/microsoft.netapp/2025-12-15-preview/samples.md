...
```bicep
resource exampleResource 'Microsoft.NetApp/activeDirectoryConfigs@2025-12-15-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts@2025-12-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts/elasticBackupPolicies@2025-12-15-preview' = {
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts/elasticBackupVaults@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts/elasticBackupVaults/elasticBackups@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts/elasticCapacityPools@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts/elasticCapacityPools/elasticVolumes@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts/elasticCapacityPools/elasticVolumes/elasticSnapshots@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.NetApp/elasticAccounts/elasticSnapshotPolicies@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts@2025-12-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
Accounts_CreateOrUpdateLdapConfig
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts@2025-12-15-preview' = {
  name: 'example'
  location: 'eastus'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupPolicies@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupVaults@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupVaults/backups@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    label: 'myLabel'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/caches@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/buckets@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/path'
...
Snapshots_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
Subvolumes_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/subvolumes@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/subvolumePath'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/volumeQuotaRules@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/snapshotPolicies@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
VolumeGroups_Create_Custom
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/volumeGroups@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
VolumeGroups_Create_Custom_SMB
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/volumeGroups@2025-12-15-preview' = {
  parent: parentResource 
  name: 'example'
