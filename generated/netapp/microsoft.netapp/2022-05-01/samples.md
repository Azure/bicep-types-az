...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts@2022-05-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    activeDirectories: [
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupPolicies@2022-05-01' = {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Backups_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/backups@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Snapshots_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
Subvolumes_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/subvolumes@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/subvolumePath'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/volumeQuotaRules@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/snapshotPolicies@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
VolumeGroups_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/volumeGroups@2022-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
