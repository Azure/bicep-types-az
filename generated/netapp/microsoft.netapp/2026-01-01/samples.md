...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts@2026-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupPolicies@2026-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupVaults@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupVaults/backups@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    label: 'myLabel'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/caches@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/buckets@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/path'
...
Snapshots_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
Subvolumes_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/subvolumes@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/subvolumePath'
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/volumeQuotaRules@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/snapshotPolicies@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/volumeGroups@2026-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
