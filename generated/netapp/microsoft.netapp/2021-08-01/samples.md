...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts@2021-08-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    activeDirectories: [
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/backupPolicies@2021-08-01' = {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools@2021-08-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes@2021-08-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Backups_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/backups@2021-08-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Snapshots_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots@2021-08-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/snapshotPolicies@2021-08-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
VolumeGroups_Create
```bicep
resource exampleResource 'Microsoft.NetApp/netAppAccounts/volumeGroups@2021-08-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
