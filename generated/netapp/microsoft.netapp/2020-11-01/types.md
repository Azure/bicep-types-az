...
## accountEncryption
### Properties
* **keySource**: 'Microsoft.NetApp': Encryption Key Source. Possible values are: 'Microsoft.NetApp'. Possible values include: 'Microsoft.NetApp'
...
* **dataProtection**: [schemas:23_dataProtection](#schemas23dataprotection): DataProtection type volumes include an object containing details of the replication
* **encryptionKeySource**: string: Encryption Key Source. Possible values are: 'Microsoft.NetApp'
* **exportPolicy**: [schemas:23_exportPolicy](#schemas23exportpolicy): Set of export policy rules
...
* **provisioningState**: string (ReadOnly): Azure lifecycle management
* **securityStyle**: 'ntfs' | 'unix': The security style of volume, default unix, defaults to ntfs for dual protocol or CIFS protocol. Possible values include: 'ntfs', 'unix'
