...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/devices@2022-01-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    azureStackEdge: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/networkFunctions@2022-01-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    device: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/vendors@2022-01-01-preview' = {
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/vendors/vendorSkus@2022-01-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/vendors/vendorSkus/previewSubscriptions@2022-01-01-preview' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/locations/vendors/networkFunctions@2022-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
