...
```bicep
resource exampleResource 'Microsoft.Support/fileWorkspaces/files@2026-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.Support/supportTickets@2026-06-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Support/supportTickets/communications@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
