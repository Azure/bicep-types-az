...
```bicep
resource exampleResource 'Microsoft.Support/fileWorkspaces/files@2024-04-01' = {
...
```bicep
resource exampleResource 'Microsoft.Support/supportTickets@2024-04-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Support/supportTickets/communications@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
