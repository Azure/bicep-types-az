...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/accessControlLists@2025-07-15' = {
  name: 'example'
  location: 'eastUs'
  properties: {
...
AccessControlLists_Create_MaximumSet_Gen - generated by [MaximumSet] rule
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/accessControlLists@2025-07-15' = {
  name: 'example'
  location: 'eastus'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/internetGatewayRules@2025-07-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/internetGateways@2025-07-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
    type: 'Infrastructure'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/ipCommunities@2025-07-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/ipExtendedCommunities@2025-07-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/ipPrefixes@2025-07-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l2IsolationDomains@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l3IsolationDomains@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l3IsolationDomains/externalNetworks@2025-07-15' = {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l3IsolationDomains/internalNetworks@2025-07-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    annotation: 'annotation'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/neighborGroups@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
## microsoft.managednetworkfabric/networkbootstrapdevices

NetworkBootstrapDevices_Create_MaximumSet - generated by [MaximumSet] rule - generated by [MaximumSet] rule
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkBootstrapDevices@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkBootstrapDevices/networkBootstrapInterfaces@2025-07-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkDevices@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkDevices/networkInterfaces@2025-07-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkFabricControllers@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkFabrics@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkFabrics/networkToNetworkInterconnects@2025-07-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkMonitors@2025-07-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkPacketBrokers@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkRacks@2025-07-15' = {
  name: 'example'
  location: 'eastuseuap'
  properties: {
    annotation: 'annotation'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkTapRules@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkTaps@2025-07-15' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/routePolicies@2025-07-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
