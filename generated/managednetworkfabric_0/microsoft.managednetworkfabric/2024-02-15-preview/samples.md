...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/accessControlLists@2024-02-15-preview' = {
  name: 'example'
  location: 'eastUs'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/internetGatewayRules@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/internetGateways@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    type: 'Infrastructure'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/ipCommunities@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/ipExtendedCommunities@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/ipPrefixes@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l2IsolationDomains@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l3IsolationDomains@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l3IsolationDomains/externalNetworks@2024-02-15-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/l3IsolationDomains/internalNetworks@2024-02-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    annotation: 'annotation'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/neighborGroups@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    annotation: 'annotation'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkDevices@2024-02-15-preview' = {
  name: 'example'
  location: 'eastuseuap'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkDevices/networkInterfaces@2024-02-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkFabricControllers@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    annotation: 'annotation'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkFabrics@2024-02-15-preview' = {
  name: 'example'
  location: 'eastuseuap'
  properties: {
    annotation: 'annotation'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkFabrics/networkToNetworkInterconnects@2024-02-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    egressAclId: '/subscriptions/1234ABCD-0A1B-1234-5678-123456ABCDEF/resourceGroups/example-rg/providers/Microsoft.ManagedNetworkFabric/accessControlLists/example-acl'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkPacketBrokers@2024-02-15-preview' = {
  name: 'example'
  location: 'eastuseuap'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkRacks@2024-02-15-preview' = {
  name: 'example'
  location: 'eastuseuap'
  properties: {
    annotation: 'annotation'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkTapRules@2024-02-15-preview' = {
  name: 'example'
  location: 'eastuseuap'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/networkTaps@2024-02-15-preview' = {
  name: 'example'
  location: 'eastuseuap'
  properties: {
    administrativeState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.ManagedNetworkFabric/routePolicies@2024-02-15-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
