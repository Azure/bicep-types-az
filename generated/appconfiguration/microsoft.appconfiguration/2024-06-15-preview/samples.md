...
```bicep
resource exampleResource 'Microsoft.AppConfiguration/configurationStores@2024-06-15-preview' = {
  name: 'example'
  location: 'westus'
  sku: {
    name: 'Standard'
...
```bicep
resource exampleResource 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-06-15-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AppConfiguration/configurationStores/privateEndpointConnections@2024-06-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Replicas_Create
```bicep
resource exampleResource 'Microsoft.AppConfiguration/configurationStores/replicas@2024-06-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
Snapshots_Create
```bicep
resource exampleResource 'Microsoft.AppConfiguration/configurationStores/snapshots@2024-06-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    filters: [
