...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring@2022-12-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apiPortals@2022-12-01' = {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apiPortals/domains@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    thumbprint: '*'
...
Apps_CreateOrUpdate
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps/bindings@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    bindingParameters: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps/deployments@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    deploymentSettings: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps/domains@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    certName: 'mycert'
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/agentPools@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    poolSize: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/builders@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    buildpackGroups: [
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/builders/buildpackBindings@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/builds@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/certificates@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/configServers@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    configServer: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/configurationServices@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    settings: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/gateways@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    public: true
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/gateways/domains@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    thumbprint: '*'
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/gateways/routeConfigs@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/monitoringSettings@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/storages@2022-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
