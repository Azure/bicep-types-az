...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring@2023-11-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apiPortals@2023-11-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apiPortals/domains@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    thumbprint: '*'
...
Apms_CreateOrUpdate
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apms@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/applicationAccelerators@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/applicationAccelerators/customizedAccelerators@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/applicationLiveViews@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
Apps_CreateOrUpdate
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps/bindings@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    bindingParameters: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps/deployments@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    deploymentSettings: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/apps/domains@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    certName: 'mycert'
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/agentPools@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    poolSize: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/builders@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    buildpackGroups: [
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/builders/buildpackBindings@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/buildServices/builds@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/certificates@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/configServers@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    configServer: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/configurationServices@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    settings: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/containerRegistries@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    credentials: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/eurekaServers@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabledState: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/gateways@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    apms: [
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/gateways/domains@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    thumbprint: '*'
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/gateways/routeConfigs@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/monitoringSettings@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AppPlatform/Spring/storages@2023-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
