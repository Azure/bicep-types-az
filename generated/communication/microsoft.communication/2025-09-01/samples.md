...
```bicep
resource exampleResource 'Microsoft.Communication/communicationServices@2025-09-01' = {
  name: 'example'
  location: 'Global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/communicationServices/smtpUsernames@2025-09-01' = {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices@2025-09-01' = {
  name: 'example'
  location: 'Global'
  properties: {
    dataLocation: 'United States'
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  location: 'Global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains/senderUsernames@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains/suppressionLists@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains/suppressionLists/suppressionListAddresses@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
