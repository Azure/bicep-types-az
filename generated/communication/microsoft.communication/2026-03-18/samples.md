...
```bicep
resource exampleResource 'Microsoft.Communication/communicationServices@2026-03-18' = {
  name: 'example'
  location: 'Global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/communicationServices/smtpUsernames@2026-03-18' = {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices@2026-03-18' = {
  name: 'example'
  location: 'Global'
  properties: {
    dataLocation: 'United States'
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains@2026-03-18' = {
  parent: parentResource 
  name: 'example'
  location: 'Global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains/senderUsernames@2026-03-18' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains/suppressionLists@2026-03-18' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Communication/emailServices/domains/suppressionLists/suppressionListAddresses@2026-03-18' = {
  parent: parentResource 
  name: 'example'
  properties: {
