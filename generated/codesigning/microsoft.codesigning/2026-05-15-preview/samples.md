...
```bicep
resource exampleResource 'Microsoft.CodeSigning/codeSigningAccounts@2026-05-15-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    sku: {
...
```bicep
resource exampleResource 'Microsoft.CodeSigning/codeSigningAccounts/certificateProfiles@2026-05-15-preview' = {
