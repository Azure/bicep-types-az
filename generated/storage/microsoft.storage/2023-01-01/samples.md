...
NfsV3AccountCreate
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts@2023-01-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/blobServices@2023-01-01' = {
...
PutContainers
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-01-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/blobServices/containers/immutabilityPolicies@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    allowProtectedAppendWrites: true
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/encryptionScopes@2023-01-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
PutFileServices
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/fileServices@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
Create NFS Shares
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/fileServices/shares@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/inventoryPolicies@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    policy: {
...
CreateLocalUser
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/localUsers@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hasSshPassword: true
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/managementPolicies@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    policy: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/objectReplicationPolicies@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/privateEndpointConnections@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
QueueServicesPut
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/queueServices@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
QueueOperationPut
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/queueServices/queues@2023-01-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
TableServicesPut
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/tableServices@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/tableServices/tables@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    signedIdentifiers: [
