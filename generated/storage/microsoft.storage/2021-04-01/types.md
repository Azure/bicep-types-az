...
* **properties**: [BlobServicePropertiesAutoGenerated](#blobservicepropertiesautogenerated): The properties of a storage account’s Blob service.
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [FileServicePropertiesAutoGenerated](#fileservicepropertiesautogenerated): The properties of File services in storage account.
* **sku**: [Sku](#sku) (ReadOnly): The SKU of the storage account.
