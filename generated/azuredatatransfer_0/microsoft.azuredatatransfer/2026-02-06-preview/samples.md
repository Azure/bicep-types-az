...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/connections@2026-02-06-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
    flowProfileList: [
...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/connections/flows@2026-02-06-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/pipelines@2026-02-06-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
    remoteCloud: 'testdc'
...
```bicep
resource exampleResource 'Microsoft.AzureDataTransfer/pipelines/flowProfiles@2026-02-06-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'East US'
  properties: {
