...
```bicep
resource exampleResource 'Microsoft.Authorization/policyAssignments@2021-06-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2021-06-01' = {
  name: 'example'
  properties: {
