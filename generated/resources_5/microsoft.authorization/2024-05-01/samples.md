...
```bicep
resource exampleResource 'Microsoft.Authorization/policyAssignments@2024-05-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2024-05-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions/versions@2024-05-01' = {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2024-05-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions/versions@2024-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Policies to enforce low cost storage SKUs'
