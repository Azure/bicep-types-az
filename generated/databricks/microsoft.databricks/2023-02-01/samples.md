...
```bicep
resource exampleResource 'Microsoft.Databricks/workspaces@2023-02-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Databricks/workspaces/privateEndpointConnections@2023-02-01' = {
