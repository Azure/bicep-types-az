...
```bicep
resource exampleResource 'Microsoft.Databricks/accessConnectors@2026-01-01' = {
  name: 'example'
  location: 'westus'
}
```
...
```bicep
resource exampleResource 'Microsoft.Databricks/workspaces@2026-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    computeMode: 'Hybrid'
...
```bicep
resource exampleResource 'Microsoft.Databricks/workspaces/privateEndpointConnections@2026-01-01' = {
