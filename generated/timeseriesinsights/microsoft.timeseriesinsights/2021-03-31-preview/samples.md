...
EnvironmentsCreate
```bicep
resource exampleResource 'Microsoft.TimeSeriesInsights/environments@2021-03-31-preview' = {
  name: 'example'
  kind: 'Gen1'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.TimeSeriesInsights/environments/eventSources@2021-03-31-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.TimeSeriesInsights/environments/referenceDataSets@2021-03-31-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
