# Microsoft.AlertsManagement @ 2025-05-01-preview

## Function previewAlertRule (Microsoft.AlertsManagement@2025-05-01-preview)
...
* **resolveConfiguration**: [LogAlertRuleResolveConfiguration](#logalertruleresolveconfiguration): Defines the configuration for resolving fired alerts. Relevant only for rules of the kind LogAlert.
...
### Properties
* **lookbackPeriod**: string (Required): Specifies the lookback of the preview in ISO 8601 duration format.
