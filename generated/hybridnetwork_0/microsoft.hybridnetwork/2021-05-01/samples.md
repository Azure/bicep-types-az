...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/networkFunctions@2021-05-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    device: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/vendors@2021-05-01' = {
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/vendors/vendorSkus@2021-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
