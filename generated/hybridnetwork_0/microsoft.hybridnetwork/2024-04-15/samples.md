...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/configurationGroupValues@2024-04-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/networkFunctions@2024-04-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers@2024-04-15' = {
  name: 'example'
  location: 'eastus'
  properties: {
    scope: 'Public'
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers/artifactStores@2024-04-15' = {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers/artifactStores/artifactManifests@2024-04-15' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers/configurationGroupSchemas@2024-04-15' = {
  parent: parentResource 
  name: 'example'
  location: 'westUs2'
  properties: {
...
Create or update the network function definition group
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers/networkFunctionDefinitionGroups@2024-04-15' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers/networkFunctionDefinitionGroups/networkFunctionDefinitionVersions@2024-04-15' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers/networkServiceDesignGroups@2024-04-15' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/publishers/networkServiceDesignGroups/networkServiceDesignVersions@2024-04-15' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.HybridNetwork/siteNetworkServices@2024-04-15' = {
  name: 'example'
  location: 'westUs2'
  properties: {
...
Create network site
```bicep
resource exampleResource 'Microsoft.HybridNetwork/sites@2024-04-15' = {
  name: 'example'
  location: 'westUs2'
  properties: {
    nfvis: [
