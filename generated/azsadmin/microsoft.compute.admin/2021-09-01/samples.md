...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/diskmigrationjobs@2021-09-01' = {
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/artifactTypes/publishers/offers/skus/versions@2021-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    osDisk: {
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/artifactTypes/publishers/types/versions@2021-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    computeRole: 'N/A'
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/quotas@2021-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
