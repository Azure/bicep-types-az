...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/artifactTypes/publishers/offers/skus/versions@2015-12-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/artifactTypes/publishers/types/versions@2015-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    computeRole: 'N/A'
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/diskmigrationjobs@2015-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  0: {
    location: 'redmond'
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/quotas@2015-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
