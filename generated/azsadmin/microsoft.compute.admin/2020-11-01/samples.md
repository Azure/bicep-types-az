...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/diskmigrationjobs@2020-11-01' = {
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/artifactTypes/publishers/offers/skus/versions@2020-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    osDisk: {
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/artifactTypes/publishers/types/versions@2020-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    computeRole: 'N/A'
...
```bicep
resource exampleResource 'Microsoft.Compute.Admin/locations/quotas@2020-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
