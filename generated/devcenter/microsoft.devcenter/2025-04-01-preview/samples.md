...
DevCenters_Create
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters@2025-04-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/attachednetworks@2025-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/catalogs@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    adoGit: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/devboxdefinitions@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/encryptionSets@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/environmentTypes@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'Dev'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/galleries@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/projectPolicies@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    resourcePolicies: [
...
```bicep
resource exampleResource 'Microsoft.DevCenter/networkConnections@2025-04-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects@2025-04-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/catalogs@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    adoGit: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/environmentTypes@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools/schedules@2025-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'StopDevBox'
