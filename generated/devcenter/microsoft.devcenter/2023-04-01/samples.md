...
DevCenters_Create
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters@2023-04-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/attachednetworks@2023-04-01' = {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/catalogs@2023-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    adoGit: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/devboxdefinitions@2023-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/environmentTypes@2023-04-01' = {
  parent: parentResource 
  name: 'example'
  tags: {
    Owner: 'superuser'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/galleries@2023-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/networkConnections@2023-04-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects@2023-04-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/environmentTypes@2023-04-01' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools@2023-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools/schedules@2023-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'StopDevBox'
