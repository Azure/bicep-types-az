...
DevCenters_Create
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters@2026-01-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/attachednetworks@2026-01-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/catalogs@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    adoGit: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/devboxdefinitions@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/encryptionSets@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/environmentTypes@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    displayName: 'Dev'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/galleries@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/projectPolicies@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    configurationPolicies: {
      ...
      devBoxScheduleDeleteFeatureStatus: {
        ...
        defaultValues: [
          ...
          {
            name: 'cancelOnConnectEnableStatus'
            value: 'false'
          }
        ]
      ...
      projectCatalogFeatureStatus: {
        defaultValues: [
          {
            name: 'environmentDefinitionCatalogItemSync'
            value: 'Enabled'
          }
          {
            name: 'imageDefinitionCatalogItemSync'
            value: 'Enabled'
          }
        ]
        valuesModifiable: 'Modifiable'
      ...
      serverlessGpuSessionsFeatureStatus: {
        ...
        defaultValues: [
          {
            name: 'maxConcurrentSessionsPerProject'
            value: '3'
          }
        ]
        statusModifiable: 'Modifiable'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/networkConnections@2026-01-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects@2026-01-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/catalogs@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    adoGit: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/environmentTypes@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools/schedules@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'StopDevBox'
