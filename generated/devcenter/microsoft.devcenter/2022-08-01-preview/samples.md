...
DevCenters_Create
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters@2022-08-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/attachednetworks@2022-08-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/catalogs@2022-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    adoGit: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/devboxdefinitions@2022-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/environmentTypes@2022-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  tags: {
    Owner: 'superuser'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/devcenters/galleries@2022-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/networkConnections@2022-08-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects@2022-08-01-preview' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/environmentTypes@2022-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools@2022-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DevCenter/projects/pools/schedules@2022-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'StopDevBox'
