...
```bicep
resource exampleResource 'Microsoft.Compute/availabilitySets@2023-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups@2023-03-01' = {
  name: 'example'
  location: 'westus'
  tags: {
    department: 'finance'
...
```bicep
resource exampleResource 'Microsoft.Compute/capacityReservationGroups/capacityReservations@2023-03-01' = {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups@2023-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups/hosts@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/images@2023-03-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    storageProfile: {
...
```bicep
resource exampleResource 'Microsoft.Compute/proximityPlacementGroups@2023-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    intent: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections@2023-03-01' = {
  name: 'example'
  location: 'norwayeast'
  properties: {
    source: {
...
```bicep
resource exampleResource 'Microsoft.Compute/restorePointCollections/restorePoints@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    sourceRestorePoint: {
...
```bicep
resource exampleResource 'Microsoft.Compute/sshPublicKeys@2023-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2023-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    hardwareProfile: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/extensions@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/runCommands@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2023-03-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    overprovision: true
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/extensions@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  name: '{extension-name}'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  plan: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/extensions@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'extType'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/runCommands@2023-03-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
