...
```bicep
resource exampleResource 'Microsoft.SignalRService/webPubSub@2023-08-01-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.SignalRService/webPubSub/customCertificates@2023-08-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/webPubSub/customDomains@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    customCertificate: {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/webPubSub/hubs@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/webPubSub/privateEndpointConnections@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateEndpoint: {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/webPubSub/replicas@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.SignalRService/webPubSub/sharedPrivateLinkResources@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupId: 'sites'
