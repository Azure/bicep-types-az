...
```bicep
resource exampleResource 'Microsoft.StreamAnalytics/streamingjobs@2016-03-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StreamAnalytics/streamingjobs/inputs@2016-03-01' = {
...
```bicep
resource exampleResource 'Microsoft.StreamAnalytics/streamingjobs/outputs@2016-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    datasource: {
...
```bicep
resource exampleResource 'Microsoft.StreamAnalytics/streamingjobs/transformations@2016-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    query: 'Select Id, Name from inputtest'
...
```bicep
resource exampleResource 'Microsoft.StreamAnalytics/streamingjobs/functions@2016-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'Scalar'
