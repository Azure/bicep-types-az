...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters@2023-09-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    addonFeatures: [
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters/nodeTypes@2023-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    capacities: {
