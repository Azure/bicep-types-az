...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters@2026-05-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    addonFeatures: [
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters/applications@2026-05-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters/applications/services@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters/applicationTypes@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
}
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters/applicationTypes/versions@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ServiceFabric/managedClusters/nodeTypes@2026-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    capacities: {
...
resource exampleResource 'Microsoft.ServiceFabric/managedClusters/nodeTypes@2026-05-01-preview' = {
  ...
  properties: {
    ...
    proxyAgentSettings: {
      ...
      enabled: true
      imds: {
        inVMAccessControlProfileReferenceId: 'someReferenceId'
        mode: 'Audit'
      }
      keyIncarnationId: 17
      wireServer: {
