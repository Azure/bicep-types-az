...
```bicep
resource exampleResource 'Microsoft.DomainRegistration/domains@2024-04-01' = {
  name: 'example'
  location: 'global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DomainRegistration/domains/domainOwnershipIdentifiers@2024-04-01' = {
