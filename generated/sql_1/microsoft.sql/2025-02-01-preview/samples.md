...
```bicep
resource exampleResource 'Microsoft.Sql/instancePools@2025-02-01-preview' = {
  name: 'example'
  location: 'japaneast'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/locations/instanceFailoverGroups@2025-02-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Sql/locations/serverTrustGroups@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupMembers: [
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances@2025-02-01-preview' = {
  name: 'example'
  location: 'Japan East'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/administrators@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/advancedThreatProtectionSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/azureADOnlyAuthentications@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/advancedThreatProtectionSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/backupLongTermRetentionPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/backupShortTermRetentionPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    retentionDays: 14
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/ledgerDigestUploads@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/schemas/tables/columns/sensitivityLabels@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/securityAlertPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/transparentDataEncryption@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/vulnerabilityAssessments@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/databases/vulnerabilityAssessments/rules/baselines@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    baselineResults: [
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/distributedAvailabilityGroups@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    databases: [
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/dnsAliases@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/dtc@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dtcEnabled: true
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/encryptionProtector@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/keys@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    serverKeyType: 'AzureKeyVault'
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/privateEndpointConnections@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/restorableDroppedDatabases/backupShortTermRetentionPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    retentionDays: 14
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/securityAlertPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/serverConfigurationOptions@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/serverTrustCertificates@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/sqlAgent@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/startStopSchedules@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/managedInstances/vulnerabilityAssessments@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
Create server
```bicep
resource exampleResource 'Microsoft.Sql/servers@2025-02-01-preview' = {
  name: 'example'
  location: 'Japan East'
  properties: {
    administratorLogin: 'dummylogin'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/administrators@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    administratorType: 'ActiveDirectory'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/advancedThreatProtectionSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/auditingSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Creates or updates Azure Active Directory only authentication object.
```bicep
resource exampleResource 'Microsoft.Sql/servers/azureADOnlyAuthentications@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureADOnlyAuthentication: false
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/connectionPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'southeastasia'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/advancedThreatProtectionSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/auditingSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isAzureMonitorTargetEnabled: true
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/backupLongTermRetentionPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    monthlyRetention: 'P1Y'
...
Update the short term retention policy for the database.
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/backupShortTermRetentionPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/dataMaskingPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/dataMaskingPolicies/rules@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aliasName: 'nickname'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/extendedAuditingSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isAzureMonitorTargetEnabled: true
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/extensions@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/geoBackupPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/ledgerDigestUploads@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    digestStorageEndpoint: 'https://MyAccount.blob.core.windows.net'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/replicationLinks@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    linkType: 'STANDBY'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clientClassificationSource: 'Native'
...
Update a database's threat detection policy with all parameters
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/securityAlertPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/sqlVulnerabilityAssessments/baselines@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    latestScan: true
...
Creates or updates a database's vulnerability assessment rule baseline.
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/sqlVulnerabilityAssessments/baselines/rules@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    latestScan: false
...
Update a database's Transparent Data Encryption state with minimal parameters
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/transparentDataEncryption@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    scanState: 'Suspend'
...
Create a database's vulnerability assessment with all parameters
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/vulnerabilityAssessments@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
Creates or updates a database's vulnerability assessment rule baseline.
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/vulnerabilityAssessments/rules/baselines@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    baselineResults: [
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/workloadGroups@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    importance: 'normal'
...
Create a workload group with all properties specified.
```bicep
resource exampleResource 'Microsoft.Sql/servers/databases/workloadGroups/workloadClassifiers@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/devOpsAuditingSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    isAzureMonitorTargetEnabled: true
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/elasticPools@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'Japan East'
  properties: {
...
Update the encryption protector to key vault
```bicep
resource exampleResource 'Microsoft.Sql/servers/encryptionProtector@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    autoRotationEnabled: false
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/extendedAuditingSettings@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    auditActionsAndGroups: [
...
Create failover group
```bicep
resource exampleResource 'Microsoft.Sql/servers/failoverGroups@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    databases: [
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/firewallRules@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/ipv6FirewallRules@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/jobAgents@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'southeastasia'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/jobAgents/credentials@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    password: '<password>'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/jobAgents/jobs@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/jobAgents/jobs/steps@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    action: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/jobAgents/privateEndpoints@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/jobAgents/targetGroups@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    members: [
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/keys@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    serverKeyType: 'AzureKeyVault'
...
Approve or reject a private endpoint connection with a given name.
```bicep
resource exampleResource 'Microsoft.Sql/servers/privateEndpointConnections@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/securityAlertPolicies@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    disabledAlerts: [
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/sqlVulnerabilityAssessments@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Enabled'
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/syncAgents@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/virtualNetworkRules@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Sql/servers/vulnerabilityAssessments@2025-02-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    recurringScans: {
...
```bicep
resource exampleResource 'Microsoft.Sql/virtualClusters@2025-02-01-preview' = {
  name: 'example'
  location: 'japaneast'
  tags: {
    key: 'value'
