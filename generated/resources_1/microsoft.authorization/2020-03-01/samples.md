...
```bicep
resource exampleResource 'Microsoft.Authorization/policyAssignments@2020-03-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2020-03-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2020-03-01' = {
  name: 'example'
  properties: {
