...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2026-06-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions/versions@2026-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2026-06-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions/versions@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Policies to enforce low cost storage SKUs'
