...
```bicep
resource exampleResource 'Microsoft.Authorization/policyAssignments@2019-09-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2019-09-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2019-09-01' = {
  name: 'example'
  properties: {
