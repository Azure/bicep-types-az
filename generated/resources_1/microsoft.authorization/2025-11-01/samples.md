...
```bicep
resource exampleResource 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2025-11-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions/versions@2025-11-01' = {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2025-11-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions/versions@2025-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Policies to enforce low cost storage SKUs'
