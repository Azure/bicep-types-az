...
Create BackupVault
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults@2022-11-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
  }
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupPolicies@2022-11-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupInstances@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dataSourceInfo: {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/resourceGuards@2022-11-01-preview' = {
  name: 'example'
  location: 'WestUS'
  tags: {
    key1: 'val1'
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupResourceGuardProxies@2022-11-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
