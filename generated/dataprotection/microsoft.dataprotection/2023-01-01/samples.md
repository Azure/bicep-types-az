...
Create BackupVault
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults@2023-01-01' = {
  name: 'example'
  identity: {
    type: 'None'
  }
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupInstances@2023-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupPolicies@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    datasourceTypes: [
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupResourceGuardProxies@2023-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/resourceGuards@2023-01-01' = {
  name: 'example'
  location: 'WestUS'
  tags: {
    key1: 'val1'
