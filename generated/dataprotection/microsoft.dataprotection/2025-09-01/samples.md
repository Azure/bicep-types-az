...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupInstances@2025-09-01' = {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupPolicies@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    datasourceTypes: [
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupResourceGuardProxies@2025-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/resourceGuards@2025-09-01' = {
  name: 'example'
  location: 'WestUS'
  tags: {
    key1: 'val1'
