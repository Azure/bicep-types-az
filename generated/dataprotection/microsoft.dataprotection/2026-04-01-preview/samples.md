...
Create BackupVault
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults@2026-04-01-preview' = {
  name: 'example'
  location: 'WestUS'
  properties: {
    featureSettings: {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupInstances@2026-04-01-preview' = {
...
Create BackupInstance With PostgreSqlFlexibleServerBackupDatasourceParameters
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupInstances@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupPolicies@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    datasourceTypes: [
...
```bicep
resource exampleResource 'Microsoft.DataProtection/backupVaults/backupResourceGuardProxies@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DataProtection/resourceGuards@2026-04-01-preview' = {
  name: 'example'
  location: 'WestUS'
  tags: {
    key1: 'val1'
