...
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles@2022-04-01-preview' = {
  name: 'example'
  location: 'global'
  properties: {
    dnsConfig: {
...
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles/AzureEndpoints@2022-04-01-preview' = {
...
Endpoint-PUT-External-WithAlwaysServe
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles/ExternalEndpoints@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  name: 'azsmnet7187'
  type: 'Microsoft.network/TrafficManagerProfiles/ExternalEndpoints'
...
Endpoint-PUT-External-WithAlwaysServe
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles/NestedEndpoints@2022-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  name: 'azsmnet7187'
  type: 'Microsoft.network/TrafficManagerProfiles/ExternalEndpoints'
