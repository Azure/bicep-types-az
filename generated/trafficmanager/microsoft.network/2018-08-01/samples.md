...
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles@2018-08-01' = {
  name: 'example'
  location: 'global'
  properties: {
    dnsConfig: {
...
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles/AzureEndpoints@2018-08-01' = {
...
Endpoint-PUT-External-WithCustomHeaders
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles/ExternalEndpoints@2018-08-01' = {
  parent: parentResource 
  name: 'example'
  name: 'azsmnet7187'
  type: 'Microsoft.network/TrafficManagerProfiles/ExternalEndpoints'
...
Endpoint-PUT-External-WithCustomHeaders
```bicep
resource exampleResource 'Microsoft.Network/trafficmanagerprofiles/NestedEndpoints@2018-08-01' = {
  parent: parentResource 
  name: 'example'
  name: 'azsmnet7187'
  type: 'Microsoft.network/TrafficManagerProfiles/ExternalEndpoints'
