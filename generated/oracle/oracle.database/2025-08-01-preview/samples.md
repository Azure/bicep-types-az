...
```bicep
resource exampleResource 'Oracle.Database/autonomousDatabases@2025-08-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    adminPassword: '********'
...
```bicep
resource exampleResource 'Oracle.Database/autonomousDatabases/autonomousDatabaseBackups@2025-08-01-preview' = {
...
```bicep
resource exampleResource 'Oracle.Database/cloudExadataInfrastructures@2025-08-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    computeCount: 100
...
Create VM Cluster
```bicep
resource exampleResource 'Oracle.Database/cloudVmClusters@2025-08-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/cloudVmClusters/virtualNetworkAddresses@2025-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/dbSystems@2025-08-01-preview' = {
  name: 'example'
  location: 'uuh'
  properties: {
    adminPassword: '********'
...
```bicep
resource exampleResource 'Oracle.Database/exadbVmClusters@2025-08-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Oracle.Database/exascaleDbStorageVaults@2025-08-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Oracle.Database/networkAnchors@2025-08-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Oracle.Database/oracleSubscriptions@2025-08-01-preview' = {
  name: 'example'
  plan: {
    name: 'plan1'
    product: 'product1'
...
```bicep
resource exampleResource 'Oracle.Database/resourceAnchors@2025-08-01-preview' = {
  name: 'example'
  location: 'at'
  properties: {
