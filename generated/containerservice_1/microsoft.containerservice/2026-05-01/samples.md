...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters@2026-05-01' = {
  name: 'example'
  location: 'location1'
  properties: {
    addonProfiles: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/agentPools@2026-05-01' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/identityBindings@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    managedIdentity: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    maintenanceWindow: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/managedNamespaces@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/privateEndpointConnections@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2026-05-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    roles: [
...
```bicep
resource exampleResource 'Microsoft.ContainerService/snapshots@2026-05-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    creationData: {
