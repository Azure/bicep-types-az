...
```bicep
resource exampleResource 'Microsoft.ContainerService/maintenanceWindows@2026-04-02-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    durationHours: 8
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters@2026-04-02-preview' = {
  name: 'example'
  location: 'location1'
  properties: {
    addonProfiles: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/agentPools@2026-04-02-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/agentPools/machines@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hardware: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/identityBindings@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    managedIdentity: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/jwtAuthenticators@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    claimMappings: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/loadBalancers@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    maintenanceWindow: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/managedNamespaces@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/meshMemberships@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/privateEndpointConnections@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2026-04-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    roles: [
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedclustersnapshots@2026-04-02-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    creationData: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/snapshots@2026-04-02-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    creationData: {
