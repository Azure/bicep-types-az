...
PutGalleryImage
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/galleryImages@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
...
PutLoadBalancer
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/loadBalancers@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
...
PutLogicalNetwork
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/logicalNetworks@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/marketplaceGalleryImages@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
PutNatGateway
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/natGateways@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/natGateways/inboundRules@2026-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/networkInterfaces@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/networkSecurityGroups@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
}
```
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/networkSecurityGroups/securityRules@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  extendedLocation: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/publicIPAddresses@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/snapshots@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
PutStorageContainer
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/storageContainers@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/virtualHardDisks@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/virtualMachineInstances@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
CreateGuestAgent
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/virtualMachineInstances/guestAgents@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    credentials: {
...
PutVirtualNetwork
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/virtualNetworks@2026-04-01-preview' = {
  name: 'example'
  extendedLocation: {
    name: '/subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location'
    type: 'CustomLocation'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/virtualNetworks/subnets@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
