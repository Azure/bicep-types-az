...
## Function checkPolicyRestrictions (Microsoft.PolicyInsights@2024-10-01)
* **Resource**: Microsoft.PolicyInsights
* **ApiVersion**: 2024-10-01
* **Input**: [CheckManagementGroupRestrictionsRequest](#checkmanagementgrouprestrictionsrequest)
...
* **resourceDetails**: [CheckRestrictionsResourceDetails](#checkrestrictionsresourcedetails): The information about the resource that will be evaluated.
...
* **reason**: string (ReadOnly): The reason for the evaluation result.
...
* **policyEffect**: string (ReadOnly): The effect of the policy that is causing the field restriction. http://aka.ms/policyeffects
* **reason**: string (ReadOnly): The reason for the restriction.
* **result**: 'Audit' | 'Deny' | 'Removed' | 'Required' | string (ReadOnly): The type of restriction that is imposed on the field.
...
## PolicyEffectDetails
### Properties
* **policyEffect**: string (ReadOnly): The effect that was applied to the resource. http://aka.ms/policyeffects
...
### Properties
* **effectDetails**: [PolicyEffectDetails](#policyeffectdetails) (ReadOnly): The details of the effect that was applied to the resource.
* **evaluationDetails**: [CheckRestrictionEvaluationDetails](#checkrestrictionevaluationdetails) (ReadOnly): The detailed results of the policy expressions and values that were evaluated.
