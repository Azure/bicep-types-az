...
```bicep
resource exampleResource 'MongoDB.Atlas/organizations@2026-03-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'MongoDB.Atlas/organizations/projects@2026-03-01-preview' = {
...
```bicep
resource exampleResource 'MongoDB.Atlas/organizations/projects/clusters@2026-03-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    clusterTier: 'FREE'
