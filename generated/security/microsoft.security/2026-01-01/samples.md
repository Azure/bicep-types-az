...
Create private link
```bicep
resource exampleResource 'Microsoft.Security/privateLinks@2026-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Security/privateLinks/privateEndpointConnections@2026-01-01' = {
