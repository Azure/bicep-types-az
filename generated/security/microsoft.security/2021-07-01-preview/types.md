...
* **supportedCloud**: 'AWS' | 'GCP': Relevant cloud for the custom assessment automation.
...
### Properties
* **cloudName**: 'AWS' | 'Azure' | 'GCP': The multi cloud resource's cloud name.
...
* **organizationMembershipType**: 'Member' | 'Organization': The multi cloud account's membership type in the organization
