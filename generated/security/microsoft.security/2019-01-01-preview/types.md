...
* **status**: [SubAssessmentStatus](#subassessmentstatus) (ReadOnly): Status of the sub-assessment
...
* **code**: 'Healthy' | 'NotApplicable' | 'Unhealthy' (ReadOnly): Programmatic code for the status of the assessment
* **description**: string (ReadOnly): Human readable description of the assessment status
* **severity**: 'High' | 'Low' | 'Medium' (ReadOnly): The sub-assessment severity level
...
* **state**: 'Failed' | 'Passed' | 'Skipped' | 'Unsupported' (ReadOnly): Aggregative state based on the standard's supported controls states
