# Microsoft.Security @ 2026-07-01

## Resource Microsoft.Security/batchPricings@2026-07-01
* **Readable Scope(s)**: Tenant, ManagementGroup, Subscription, ResourceGroup, Extension
* **Writable Scope(s)**: Tenant, ManagementGroup, Subscription, ResourceGroup, Extension
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^global$"} (Required, DeployTimeConstant): The resource name
* **properties**: [PricingBatchProperties](#pricingbatchproperties): Pricing batch properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Security/batchPricings' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Security/pricings@2026-07-01
* **Readable Scope(s)**: Tenant, ManagementGroup, Subscription, ResourceGroup, Extension
* **Writable Scope(s)**: Tenant, ManagementGroup, Subscription, ResourceGroup, Extension
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
* **securityOperatorResourceId**: string: Resource ID of the security operator associated with the extension.
...
## PricingBatchPlanItem
### Properties
* **operationStatus**: [PricingPlanOperationStatus](#pricingplanoperationstatus) (ReadOnly): Status of this plan's update operation. This property is returned only after a PUT operation.
* **planName**: string (Required): Name of the pricing plan.
* **properties**: [PricingProperties](#pricingproperties) (Required): Pricing configuration properties for the plan.

## PricingBatchProperties
### Properties
* **plansConfigurations**: [PricingBatchPlanItem](#pricingbatchplanitem)[] {minLength: 1, maxLength: 30} (Required): Pricing plan configurations represented by this resource.

## PricingPlanOperationStatus
### Properties
...
* **managedBy**: string (ReadOnly): Indicates who exclusively manages the pricing configuration.
* **originatedFrom**: 'M365' | string (ReadOnly): Indicates the origin of the most recent configuration change.
...
* **securityOperatorResourceId**: string: Resource ID of the security operator associated with the pricing configuration.
