...
#### Properties
* **ciem**: [DefenderCspmAwsOfferingCiem](#defendercspmawsofferingciem): Defenders CSPM Cloud infrastructure entitlement management (CIEM) offering configurations
...
#### Properties
* **ciemDiscovery**: [DefenderCspmGcpOfferingCiemDiscovery](#defendercspmgcpofferingciemdiscovery): GCP Defenders CSPM Cloud infrastructure entitlement management (CIEM) discovery offering configurations
...
* **vmScanners**: [DefenderCspmGcpOfferingVmScanners](#defendercspmgcpofferingvmscanners): The Microsoft Defender for Server VM scanning configuration
...
### Properties
* **ciemDiscovery**: [DefenderCspmAwsOfferingCiemDiscovery](#defendercspmawsofferingciemdiscovery): Defender CSPM CIEM discovery configuration
* **ciemOidc**: [DefenderCspmAwsOfferingCiemOidc](#defendercspmawsofferingciemoidc): Defender CSPM CIEM AWS OIDC (open id connect) configuration

## DefenderCspmAwsOfferingCiemDiscovery
### Properties
* **cloudRoleArn**: string: The cloud role ARN in AWS for CIEM discovery
...
### Properties
* **configuration**: [DefenderCspmGcpOfferingVmScannersConfiguration](#defendercspmgcpofferingvmscannersconfiguration): configuration for Microsoft Defender for Server VM scanning
* **enabled**: bool: Is Microsoft Defender for Server VM scanning enabled

## DefenderCspmGcpOfferingVmScannersConfiguration
### Properties
* **exclusionTags**: [DefenderCspmGcpOfferingVmScannersConfigurationExclusionTags](#defendercspmgcpofferingvmscannersconfigurationexclusiontags): VM tags that indicates that VM should not be scanned
* **scanningMode**: 'Default' | string: The scanning mode for the VM scan.

## DefenderCspmGcpOfferingVmScannersConfigurationExclusionTags
### Properties
### Additional Properties
* **Additional Properties Type**: string
