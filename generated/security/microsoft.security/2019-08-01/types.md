...
* **reportedSeverity**: 'High' | 'Informational' | 'Low' | 'Medium' (ReadOnly): Assessed alert severity.
...
* **severity**: 'Healthy' | 'High' | 'Low' | 'Medium' | 'NotApplicable' | 'OffByPolicy' | 'Unknown' (ReadOnly): The severity of the recommendation
