...
* **securityFamily**: 'Ngfw' | 'SaasWaf' | 'Va' | 'Waf' | string (ReadOnly): The security family of the discovered solution
...
* **direction**: 'Inbound' | 'Outbound' | string (ReadOnly): The rule's direction
...
* **protocols**: 'TCP' | 'UDP' | string[] (ReadOnly): The rule's transport protocols
