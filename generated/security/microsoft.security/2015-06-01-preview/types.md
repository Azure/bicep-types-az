...
* **confidenceReasons**: [AlertConfidenceReason](#alertconfidencereason)[] (ReadOnly): reasons the alert got the confidenceScore value
...
* **entities**: [AlertEntity](#alertentity)[] (ReadOnly): objects that are related to this alerts
* **extendedProperties**: [AlertExtendedProperties](#alertextendedproperties) (ReadOnly): Changing set of properties depending on the alert type.
...
* **reportedSeverity**: 'High' | 'Information' | 'Low' | 'Silent' (ReadOnly): Estimated severity of this alert
...
* **securityTaskParameters**: [SecurityTaskParameters](#securitytaskparameters) (ReadOnly): Changing set of properties, depending on the task type that is derived from the name field
