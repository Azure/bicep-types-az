...
```bicep
resource exampleResource 'Microsoft.Cdn/CdnWebApplicationFirewallPolicies@2019-06-15' = {
  name: 'example'
  location: 'global'
  properties: {
    customRules: {
...
Profiles_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles@2019-06-15' = {
  name: 'example'
...
Endpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints@2019-06-15' = {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/customDomains@2019-06-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
