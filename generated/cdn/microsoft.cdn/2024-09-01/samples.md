...
```bicep
resource exampleResource 'Microsoft.Cdn/cdnWebApplicationFirewallPolicies@2024-09-01' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    customRules: {
...
Profiles_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles@2024-09-01' = {
  name: 'example'
  location: 'global'
  sku: {
...
AFDEndpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints@2024-09-01' = {
...
Routes_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints/routes@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cacheConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/customDomains@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureDnsZone: {
...
Endpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  location: 'WestUs'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/customDomains@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hostName: 'www.someDomain.net'
...
OriginGroups_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/originGroups@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    healthProbeSettings: {
...
Origins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/origins@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    healthProbeSettings: {
...
AFDOrigins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups/origins@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabledState: 'Enabled'
...
Rules_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/ruleSets/rules@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    actions: [
...
Secrets_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/secrets@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/securityPolicies@2024-09-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
