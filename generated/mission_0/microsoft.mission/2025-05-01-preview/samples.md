...
```bicep
resource exampleResource 'Microsoft.Mission/approvals@2025-05-01-preview' = {
  name: 'example'
  properties: {
    approvers: [
      {
...
```bicep
resource exampleResource 'Microsoft.Mission/communities@2025-05-01-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.Mission/communities/communityEndpoints@2025-05-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Mission/communities/transitHubs@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westcentralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Mission/enclaveConnections@2025-05-01-preview' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Mission/virtualEnclaves@2025-05-01-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned,UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.Mission/virtualEnclaves/enclaveEndpoints@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Mission/virtualEnclaves/workloads@2025-05-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westcentralus'
  properties: {
