...
```bicep
resource exampleResource 'Microsoft.Network/applicationGateways@2022-01-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.Network/applicationGateways/privateEndpointConnections@2022-01-01' = {
...
```bicep
resource exampleResource 'Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies@2022-01-01' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    customRules: [
...
```bicep
resource exampleResource 'Microsoft.Network/applicationSecurityGroups@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/azureFirewalls@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
Create Bastion Host
```bicep
resource exampleResource 'Microsoft.Network/bastionHosts@2022-01-01' = {
  name: 'example'
  properties: {
    ipConfigurations: [
      {
...
```bicep
resource exampleResource 'Microsoft.Network/connections@2022-01-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/customIpPrefixes@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    cidr: '0.0.0.0/24'
...
```bicep
resource exampleResource 'Microsoft.Network/ddosCustomPolicies@2022-01-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/ddosProtectionPlans@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/dscpConfigurations@2022-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits@2022-01-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/authorizations@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/peerings@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    peerASN: 200
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/peerings/connections@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCrossConnections@2022-01-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCrossConnections/peerings@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    ipv6PeeringConfig: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteGateways@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteGateways/expressRouteConnections@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  name: 'connectionName'
...
```bicep
resource exampleResource 'Microsoft.Network/ExpressRoutePorts@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    bandwidthInGbps: 100
...
```bicep
resource exampleResource 'Microsoft.Network/expressRoutePorts/authorizations@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    dnsSettings: {
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies/ruleCollectionGroups@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    priority: 100
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies/signatureOverrides@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  name: 'default'
...
Create IpAllocation
```bicep
resource exampleResource 'Microsoft.Network/IpAllocations@2022-01-01' = {
  name: 'example'
  location: 'centraluseuap'
  properties: {
    type: 'Hypernet'
...
```bicep
resource exampleResource 'Microsoft.Network/ipGroups@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    ipAddresses: [
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers@2022-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    backendAddressPools: [
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers/backendAddressPools@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    loadBalancerBackendAddresses: [
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers/inboundNatRules@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    backendPort: 3389
...
```bicep
resource exampleResource 'Microsoft.Network/localNetworkGateways@2022-01-01' = {
  name: 'example'
  location: 'Central US'
  properties: {
...
Create nat gateway
```bicep
resource exampleResource 'Microsoft.Network/natGateways@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    publicIpAddresses: [
...
```bicep
resource exampleResource 'Microsoft.Network/networkInterfaces@2022-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkInterfaces/tapConfigurations@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    virtualNetworkTap: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagerConnections@2022-01-01' = {
  name: 'example'
  properties: {
...
Put Network Manager
```bicep
resource exampleResource 'Microsoft.Network/networkManagers@2022-01-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/connectivityConfigurations@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
NetworkGroupsPut
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/networkGroups@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
StaticMemberPut
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/networkGroups/staticMembers@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/scopeConnections@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityAdminConfigurations@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityAdminConfigurations/ruleCollections@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'A sample policy'
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityAdminConfigurations/ruleCollections/rules@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'Default'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkProfiles@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityGroups@2022-01-01' = {
  name: 'example'
  location: 'eastus'
}
```
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityGroups/securityRules@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    access: 'Deny'
...
```bicep
resource exampleResource 'Microsoft.Network/networkVirtualAppliances@2022-01-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkVirtualAppliances/inboundSecurityRules@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    rules: [
...
```bicep
resource exampleResource 'Microsoft.Network/networkVirtualAppliances/virtualApplianceSites@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers@2022-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/connectionMonitors@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/flowLogs@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  location: 'centraluseuap'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/packetCaptures@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
P2SVpnGatewayPut
```bicep
resource exampleResource 'Microsoft.Network/p2svpnGateways@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    customDnsServers: [
...
```bicep
resource exampleResource 'Microsoft.Network/privateEndpoints@2022-01-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/privateLinkServices@2022-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    autoApproval: {
...
```bicep
resource exampleResource 'Microsoft.Network/privateLinkServices/privateEndpointConnections@2022-01-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/publicIPAddresses@2022-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    idleTimeoutInMinutes: 10
...
```bicep
resource exampleResource 'Microsoft.Network/publicIPPrefixes@2022-01-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    prefixLength: 30
...
RouteFilterCreate
```bicep
resource exampleResource 'Microsoft.Network/routeFilters@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    rules: [
...
```bicep
resource exampleResource 'Microsoft.Network/routeFilters/routeFilterRules@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    access: 'Allow'
...
Create route table
```bicep
resource exampleResource 'Microsoft.Network/routeTables@2022-01-01' = {
  name: 'example'
  location: 'westus'
}
```
...
Create route
```bicep
resource exampleResource 'Microsoft.Network/routeTables/routes@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    addressPrefix: '10.0.3.0/24'
...
```bicep
resource exampleResource 'Microsoft.Network/securityPartnerProviders@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/serviceEndpointPolicies@2022-01-01' = {
  name: 'example'
  location: 'westus'
}
```
...
VirtualHubPut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/bgpConnections@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
RouteTablePut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/hubRouteTables@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    labels: [
...
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/hubVirtualNetworkConnections@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/ipConfigurations@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    subnet: {
...
VirtualHubRouteTableV2Put
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/routeTables@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    attachedConnections: [
...
RouteTablePut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/routingIntent@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    routingPolicies: [
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworkGateways@2022-01-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
    activeActive: false
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworks@2022-01-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    addressSpace: {
...
Create subnet
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworks/subnets@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    addressPrefix: '10.0.0.0/16'
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworkTaps@2022-01-01' = {
  name: 'example'
  location: 'centraluseuap'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualRouters@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    hostedGateway: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualRouters/peerings@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    peerAsn: 20000
...
VirtualWANCreate
```bicep
resource exampleResource 'Microsoft.Network/virtualWans@2022-01-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    type: 'Basic'
...
VpnGatewayPut
```bicep
resource exampleResource 'Microsoft.Network/vpnGateways@2022-01-01' = {
  name: 'example'
  location: 'westcentralus'
  properties: {
    bgpSettings: {
