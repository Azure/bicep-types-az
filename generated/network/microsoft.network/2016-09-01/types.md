...
* **localNetworkAddressSpace**: [AddressSpace](#addressspace) (Required)
* **provisioningState**: string (ReadOnly)
* **resourceGuid**: string
...
* **ipConfigurations**: [VirtualNetworkGatewayIPConfiguration](#virtualnetworkgatewayipconfiguration)[] (Required)
* **provisioningState**: string (ReadOnly)
* **resourceGuid**: string
