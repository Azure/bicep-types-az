...
* **userAssignedIdentities**: [Dictionary<string,Schemas236UserAssignedIdentitiesValue>](#dictionarystringschemas236userassignedidentitiesvalue)
...
* **autoApproval**: [schemas:374_autoApproval](#schemas374autoapproval)
* **fqdns**: string[]
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating'
* **visibility**: [schemas:374_visibility](#schemas374visibility)
