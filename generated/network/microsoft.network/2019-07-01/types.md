...
### Properties
* **type**: 'Alert ' | 'Allow' | 'Deny' | string: The action type of a rule.

## FirewallPolicyNatRuleAction
### Properties
* **type**: 'DNAT' | 'SNAT' | string: The action type of a rule.
...
* **protocolType**: 'Http' | 'Https' | string: The application protocol type of a Rule condition.
