...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): Resource location
* **name**: '' (Required, DeployTimeConstant): The resource name
...
* **ruleType**: 'Basic': Gets or sets the rule type. Possible values include: 'Basic'
...
* **provisioningState**: string: Gets or sets Provisioning state of the PublicIP resource Updating/Deleting/Failed
* **publicIPAllocationMethod**: 'Dynamic' | 'Static' (Required): Gets or sets PublicIP allocation method (Static/Dynamic). Possible values include: 'Static', 'Dynamic'
