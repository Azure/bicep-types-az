...
### Properties
* **bounds**: [ApplicationGatewayAutoscaleBounds](#applicationgatewayautoscalebounds) (Required)
...
### Properties
* **internalPublicIpAddress**: [SubResource](#subresource)
* **privateIPAddress**: string
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating'
* **publicIPAddress**: [SubResource](#subresource)
* **subnet**: [SubResource](#subresource)
...
### Properties
* **addressPrefix**: string
* **hubVirtualNetworkConnections**: [HubVirtualNetworkConnection](#hubvirtualnetworkconnection)[]
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating'
...
### Properties
* **connectionBandwidth**: int (ReadOnly)
