...
```bicep
resource exampleResource 'Microsoft.Network/applicationGateways@2025-07-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.Network/applicationGateways/privateEndpointConnections@2025-07-01' = {
...
```bicep
resource exampleResource 'Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies@2025-07-01' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    customRules: [
...
```bicep
resource exampleResource 'Microsoft.Network/applicationSecurityGroups@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/azureFirewalls@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
Create Bastion Host
```bicep
resource exampleResource 'Microsoft.Network/bastionHosts@2025-07-01' = {
  name: 'example'
  properties: {
    ipConfigurations: [
      {
...
```bicep
resource exampleResource 'Microsoft.Network/cloudServiceSlots@2025-07-01' = {
  name: 'example'
  properties: {
    slotType: 'Production'
  }
...
```bicep
resource exampleResource 'Microsoft.Network/connections@2025-07-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/customIpPrefixes@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    cidr: '0.0.0.0/24'
...
```bicep
resource exampleResource 'Microsoft.Network/ddosCustomPolicies@2025-07-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/ddosProtectionPlans@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/dscpConfigurations@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits@2025-07-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/authorizations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/peerings@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    peerASN: 200
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/peerings/connections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCrossConnections@2025-07-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCrossConnections/peerings@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    ipv6PeeringConfig: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteGateways@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteGateways/expressRouteConnections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  name: 'connectionName'
...
```bicep
resource exampleResource 'Microsoft.Network/ExpressRoutePorts@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    bandwidthInGbps: 100
...
```bicep
resource exampleResource 'Microsoft.Network/expressRoutePorts/authorizations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    dnsSettings: {
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies/firewallPolicyDrafts@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dnsSettings: {
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies/ruleCollectionGroups@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    priority: 100
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies/ruleCollectionGroups/ruleCollectionGroupDrafts@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    priority: 100
...
```bicep
resource exampleResource 'Microsoft.Network/firewallPolicies/signatureOverrides@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  name: 'default'
...
```bicep
resource exampleResource 'Microsoft.Network/interconnectGroups@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    scope: 'InfiniBand'
...
Create IpAllocation
```bicep
resource exampleResource 'Microsoft.Network/IpAllocations@2025-07-01' = {
  name: 'example'
  location: 'centraluseuap'
  properties: {
    type: 'Hypernet'
...
```bicep
resource exampleResource 'Microsoft.Network/ipGroups@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    ipAddresses: [
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    backendAddressPools: [
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers/backendAddressPools@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    loadBalancerBackendAddresses: [
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers/inboundNatRules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    backendPort: 3389
...
```bicep
resource exampleResource 'Microsoft.Network/localNetworkGateways@2025-07-01' = {
  name: 'example'
  location: 'Central US'
  properties: {
...
Create nat gateway
```bicep
resource exampleResource 'Microsoft.Network/natGateways@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    publicIpAddresses: [
...
```bicep
resource exampleResource 'Microsoft.Network/networkInterfaces@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkInterfaces/tapConfigurations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    virtualNetworkTap: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagerConnections@2025-07-01' = {
  name: 'example'
  properties: {
...
Put Network Manager
```bicep
resource exampleResource 'Microsoft.Network/networkManagers@2025-07-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/commits@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/connectivityConfigurations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
IpamPools_Create
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/ipamPools@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
NetworkGroupsPut
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/networkGroups@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
StaticMemberPut
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/networkGroups/staticMembers@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/routingConfigurations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/routingConfigurations/ruleCollections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'A sample policy'
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/routingConfigurations/ruleCollections/rules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/scopeConnections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityAdminConfigurations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityAdminConfigurations/ruleCollections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'A sample policy'
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityAdminConfigurations/ruleCollections/rules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'Custom'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityUserConfigurations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'A sample policy'
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityUserConfigurations/ruleCollections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'A sample policy'
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/securityUserConfigurations/ruleCollections/rules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/verifierWorkspaces@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/verifierWorkspaces/reachabilityAnalysisIntents@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkManagers/verifierWorkspaces/reachabilityAnalysisRuns@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkProfiles@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityGroups@2025-07-01' = {
  name: 'example'
  location: 'eastus'
}
```
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityGroups/securityRules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    access: 'Deny'
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityPerimeters@2025-07-01' = {
  name: 'example'
  location: 'location1'
  properties: {
  }
...
NspLinksPut
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityPerimeters/links@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityPerimeters/loggingConfigurations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
NspProfilesPut
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityPerimeters/profiles@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
NspAccessRulePut
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityPerimeters/profiles/accessRules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    addressPrefixes: [
...
NspAssociationPut
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityPerimeters/resourceAssociations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    accessMode: 'Enforced'
...
```bicep
resource exampleResource 'Microsoft.Network/networkVirtualAppliances@2025-07-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkVirtualAppliances/inboundSecurityRules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    ruleType: 'Permanent'
...
```bicep
resource exampleResource 'Microsoft.Network/networkVirtualAppliances/virtualApplianceSites@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/connectionMonitors@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/flowLogs@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/packetCaptures@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
P2SVpnGatewayPut
```bicep
resource exampleResource 'Microsoft.Network/p2svpnGateways@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    customDnsServers: [
...
```bicep
resource exampleResource 'Microsoft.Network/privateEndpoints@2025-07-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/privateLinkServices@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    autoApproval: {
...
```bicep
resource exampleResource 'Microsoft.Network/privateLinkServices/privateEndpointConnections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Network/publicIPAddresses@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    idleTimeoutInMinutes: 10
...
```bicep
resource exampleResource 'Microsoft.Network/publicIPPrefixes@2025-07-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    prefixLength: 30
...
RouteFilterCreate
```bicep
resource exampleResource 'Microsoft.Network/routeFilters@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    rules: [
...
```bicep
resource exampleResource 'Microsoft.Network/routeFilters/routeFilterRules@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    access: 'Allow'
...
Create route table
```bicep
resource exampleResource 'Microsoft.Network/routeTables@2025-07-01' = {
  name: 'example'
  location: 'westus'
}
```
...
Create ECMP route
```bicep
resource exampleResource 'Microsoft.Network/routeTables/routes@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    addressPrefix: '10.1.0.0/16'
...
```bicep
resource exampleResource 'Microsoft.Network/securityPartnerProviders@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/serviceEndpointPolicies@2025-07-01' = {
  name: 'example'
  location: 'westus'
}
```
...
```bicep
resource exampleResource 'Microsoft.Network/serviceGateways@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    routeTargetAddress: {
...
VirtualHubPut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/bgpConnections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
ConnectionPolicyPut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/connectionPolicies@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
RouteTablePut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/hubRouteTables@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    labels: [
...
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/hubVirtualNetworkConnections@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/ipConfigurations@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    subnet: {
...
RouteMapPut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/routeMaps@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
VirtualHubRouteTableV2Put
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/routeTables@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    attachedConnections: [
...
RouteTablePut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs/routingIntent@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    routingPolicies: [
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworkAppliances@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    bandwidthInGbps: 100
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworkGateways@2025-07-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworks@2025-07-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
    addressSpace: {
...
Create subnet
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworks/subnets@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    addressPrefix: '10.0.0.0/16'
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworkTaps@2025-07-01' = {
  name: 'example'
  location: 'centraluseuap'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualRouters@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    hostedGateway: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualRouters/peerings@2025-07-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    peerAsn: 20000
...
VirtualWANCreate
```bicep
resource exampleResource 'Microsoft.Network/virtualWans@2025-07-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    type: 'Basic'
...
VpnGatewayPut
```bicep
resource exampleResource 'Microsoft.Network/vpnGateways@2025-07-01' = {
  name: 'example'
  location: 'westcentralus'
  properties: {
    bgpSettings: {
