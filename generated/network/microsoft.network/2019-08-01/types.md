...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the application gateway resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the authentication certificate resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the backend address pool resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the network interface IP configuration.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the inbound NAT rule resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the public IP address resource.
...
* **privateIPAllocationMethod**: 'Dynamic' | 'Static': The private IP address allocation method.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the IP configuration resource.
* **publicIPAddress**: [PublicIPAddress](#publicipaddress): Public IP address resource.
* **subnet**: [Subnet](#subnet): Subnet in a virtual network resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the subnet resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the network security group resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the security rule resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the network interface resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the private endpoint resource.
* **subnet**: [Subnet](#subnet): Subnet in a virtual network resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the private link service connection resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the frontend IP configuration resource.
* **publicIPAddress**: [PublicIPAddress](#publicipaddress): Public IP address resource.
* **publicIPPrefix**: [SubResource](#subresource): Reference to another subresource.
* **subnet**: [Subnet](#subnet): Subnet in a virtual network resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the route table resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the route resource.
...
### Properties
* **locations**: string[]: A list of locations.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the service endpoint resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the backend HTTP settings resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the frontend port resource.
...
### Properties
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the application gateway IP configuration resource.
* **subnet**: [SubResource](#subresource): Reference to another subresource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the HTTP listener resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the probe resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the request routing rule resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the SSL certificate resource.
...
* **data**: string: Certificate public data.
* **keyVaultSecretId**: string: Secret Id of (base-64 encoded unencrypted pfx) 'Secret' or 'Certificate' object stored in KeyVault.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the trusted root certificate resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the URL path map resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the path rule resource.
* **redirectConfiguration**: [SubResource](#subresource): Reference to another subresource.
* **rewriteRuleSet**: [SubResource](#subresource): Reference to another subresource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the Azure firewall resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the application rule collection resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the Azure firewall IP configuration resource.
* **publicIPAddress**: [SubResource](#subresource): Reference to another subresource.
* **subnet**: [SubResource](#subresource): Reference to another subresource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the NAT rule collection resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the network rule collection resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the bastion host resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the bastion host IP configuration resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the express route circuit resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the authorization resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the express route circuit peering resource.
...
* **advertisedPublicPrefixesState**: 'Configured' | 'Configuring' | 'NotConfigured' | 'ValidationNeeded': The advertised public prefix state of the Peering resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the express route gateway resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the express route connection resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the firewall policy resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the firewall policy rule group resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the load balancer resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the inbound NAT pool resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the load balancing rule resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the outbound rule resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the NAT gateway resource.
...
### Properties
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the network watcher resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the P2S VPN gateway resource.
* **virtualHub**: [SubResource](#subresource): Reference to another subresource.
...
### Properties
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the P2SConnectionConfiguration resource.
* **vpnClientAddressPool**: [AddressSpace](#addressspace): AddressSpace contains an array of IP address ranges that can be used by subnets of the virtual network.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the private link service resource.
...
* **privateIPAddressVersion**: 'IPv4' | 'IPv6': Whether the specific IP configuration is IPv4 or IPv6. Default is IPv4.
* **privateIPAllocationMethod**: 'Dynamic' | 'Static': The private IP address allocation method.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the private link service IP configuration resource.
* **subnet**: [Subnet](#subnet): Subnet in a virtual network resource.
...
* **privateLinkServiceConnectionState**: [PrivateLinkServiceConnectionState](#privatelinkserviceconnectionstate): A collection of information about the state of the connection between service consumer and provider.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the private endpoint connection resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the public IP prefix resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the virtual hub resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the hub virtual network connection resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the virtual network resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the virtual network peering resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the virtual WAN resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the VPN gateway resource.
* **virtualHub**: [SubResource](#subresource): Reference to another subresource.
...
* **ipsecPolicies**: [IpsecPolicy](#ipsecpolicy)[]: The IPSec Policies to be considered by this connection.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the VPN connection resource.
...
* **ingressBytesTransferred**: int (ReadOnly): Ingress bytes transferred.
* **ipsecPolicies**: [IpsecPolicy](#ipsecpolicy)[]: The IPSec Policies to be considered by this connection.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the VPN site link connection resource.
* **routingWeight**: int: Routing weight for vpn connection.
* **sharedKey**: string: SharedKey for the vpn connection.
* **useLocalAzureIpAddress**: bool: Use local azure ip to initiate connection.
* **usePolicyBasedTrafficSelectors**: bool: Enable policy-based traffic selectors.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the VPN site resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating': The provisioning state of the VPN site link resource.
