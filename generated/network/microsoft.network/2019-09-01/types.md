...
* **ruleType**: 'Invalid' | 'MatchRule' (Required): Describes type of rule. Possible values include: 'MatchRule', 'Invalid'
...
* **operator**: 'BeginsWith' | 'Contains' | 'EndsWith' | 'Equal' | 'GeoMatch' | 'GreaterThan' | 'GreaterThanOrEqual' | 'IPMatch' | 'LessThan' | 'LessThanOrEqual' | 'Regex' (Required): Describes operator to be matched. Possible values include: 'IPMatch', 'Equal', 'Contains', 'LessThan', 'GreaterThan', 'LessThanOrEqual', 'GreaterThanOrEqual', 'BeginsWith', 'EndsWith', 'Regex', 'GeoMatch'
...
* **state**: 'Disabled': Describes the state of the managed rule. Defaults to Disabled if not specified. Possible values include: 'Disabled'
...
* **state**: 'Disabled' | 'Enabled': Describes if the policy is in enabled state or disabled state. Possible values include: 'Disabled', 'Enabled'
...
### Properties
* **autoScaleConfiguration**: [schemas:176_autoScaleConfiguration](#schemas176autoscaleconfiguration): Configuration for auto scaling.
...
## schemas:176_autoScaleConfiguration
### Properties
* **bounds**: [schemas:176_autoScaleConfiguration_bounds](#schemas176autoscaleconfigurationbounds): Minimum and maximum number of scale units to deploy.

## schemas:176_autoScaleConfiguration_bounds
### Properties
...
* **autoApproval**: [schemas:390_autoApproval](#schemas390autoapproval): The auto-approval list of the private link service.
...
* **visibility**: [schemas:390_visibility](#schemas390visibility): The visibility list of the private link service.

## schemas:390_autoApproval
### Properties
