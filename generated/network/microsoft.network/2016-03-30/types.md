...
* **operationalState**: 'Running' | 'Starting' | 'Stopped' | 'Stopping' (ReadOnly): Gets operational state of application gateway resource. Possible values include: 'Stopped', 'Starting', 'Running', 'Stopping'
...
* **privateIPAllocationMethod**: 'Dynamic' | 'Static': Gets or sets PrivateIP allocation method (Static/Dynamic). Possible values include: 'Static', 'Dynamic'
...
* **protocol**: 'Tcp' | 'Udp': Gets or sets the transport protocol for the external endpoint. Possible values are Udp or Tcp. Possible values include: 'Udp', 'Tcp'
...
### Properties
* **cookieBasedAffinity**: 'Disabled' | 'Enabled': Gets or sets the cookie affinity. Possible values include: 'Enabled', 'Disabled'
* **port**: int: Gets or sets the port
* **probe**: [SubResource](#subresource):
* **protocol**: 'Http' | 'Https': Gets or sets the protocol. Possible values include: 'Http', 'Https'
...
* **ruleType**: 'Basic' | 'PathBasedRouting': Gets or sets the rule type. Possible values include: 'Basic', 'PathBasedRouting'
* **urlPathMap**: [SubResource](#subresource):

## ApplicationGatewaySku
### Properties
* **capacity**: int: Gets or sets capacity (instance count) of application gateway
* **name**: 'Standard_Large' | 'Standard_Medium' | 'Standard_Small': Gets or sets name of application gateway SKU. Possible values include: 'Standard_Small', 'Standard_Medium', 'Standard_Large'
* **tier**: 'Standard': Gets or sets tier of application gateway. Possible values include: 'Standard'
