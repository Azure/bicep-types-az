...
* **migrationPhase**: 'Abort' | 'Commit' | 'Committed' | 'None' | 'Prepare': Migration phase of Network Interface resource. Possible values include: 'None', 'Prepare', 'Commit', 'Abort', 'Committed'
* **networkSecurityGroup**: [NetworkSecurityGroup](#networksecuritygroup): NetworkSecurityGroup resource.
...
* **usePolicyBasedTrafficSelectors**: bool: Enable policy-based traffic selectors.
* **vpnConnectionProtocolType**: 'IKEv1' | 'IKEv2': Connection protocol used for this connection. Possible values include: 'IKEv2', 'IKEv1'
* **vpnLinkConnectionMode**: 'Default' | 'InitiatorOnly' | 'ResponderOnly': Vpn link connection mode. Possible values include: 'Default', 'ResponderOnly', 'InitiatorOnly'
...
* **mode**: 'EgressSnat' | 'IngressSnat': The Source NAT direction of a VPN NAT. Possible values include: 'EgressSnat', 'IngressSnat'
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' (ReadOnly): The provisioning state of the NAT Rule resource. Possible values include: 'Succeeded', 'Updating', 'Deleting', 'Failed'
* **type**: 'Dynamic' | 'Static': The type of NAT rule for VPN NAT. Possible values include: 'Static', 'Dynamic'
