...
```bicep
resource exampleResource 'Microsoft.Network/applicationGateways@2018-11-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.Network/applicationSecurityGroups@2018-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/azureFirewalls@2018-11-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/ddosCustomPolicies@2018-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/ddosProtectionPlans@2018-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/authorizations@2018-11-01' = {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/peerings@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureASN: 12076
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits/peerings/connections@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCircuits@2018-11-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCrossConnections@2018-11-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteCrossConnections/peerings@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    ipv6PeeringConfig: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteGateways@2018-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/expressRouteGateways/expressRouteConnections@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  name: 'connectionName'
...
```bicep
resource exampleResource 'Microsoft.Network/ExpressRoutePorts@2018-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    bandwidthInGbps: 100
...
```bicep
resource exampleResource 'Microsoft.Network/interfaceEndpoints@2018-11-01' = {
  name: 'example'
  properties: {
    endpointService: {
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers@2018-11-01' = {
  name: 'example'
  properties: {
    backendAddressPools: [
      {
...
```bicep
resource exampleResource 'Microsoft.Network/loadBalancers/inboundNatRules@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    backendPort: 3389
...
```bicep
resource exampleResource 'Microsoft.Network/networkInterfaces@2018-11-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkInterfaces/tapConfigurations@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    virtualNetworkTap: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkProfiles@2018-11-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityGroups@2018-11-01' = {
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.Network/networkSecurityGroups/securityRules@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    access: 'Deny'
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers@2018-11-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/packetCaptures@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/networkWatchers/connectionMonitors@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.Network/publicIPAddresses@2018-11-01' = {
  name: 'example'
  properties: {
    dnsSettings: {
...
```bicep
resource exampleResource 'Microsoft.Network/publicIPPrefixes@2018-11-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    prefixLength: 30
...
RouteFilterCreate
```bicep
resource exampleResource 'Microsoft.Network/routeFilters@2018-11-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    peerings: [
...
```bicep
resource exampleResource 'Microsoft.Network/routeFilters/routeFilterRules@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    access: 'Allow'
...
Create route table
```bicep
resource exampleResource 'Microsoft.Network/routeTables@2018-11-01' = {
  name: 'example'
  location: 'westus'
}
```
...
Create route
```bicep
resource exampleResource 'Microsoft.Network/routeTables/routes@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    addressPrefix: '10.0.3.0/24'
...
```bicep
resource exampleResource 'Microsoft.Network/serviceEndpointPolicies@2018-11-01' = {
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworks@2018-11-01' = {
  name: 'example'
  properties: {
    addressSpace: {
      addressPrefixes: [
...
Create subnet
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworks/subnets@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    addressPrefix: '10.0.0.0/16'
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworkGateways@2018-11-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
    activeActive: false
...
```bicep
resource exampleResource 'Microsoft.Network/connections@2018-11-01' = {
  name: 'example'
  location: 'centralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Network/localNetworkGateways@2018-11-01' = {
  name: 'example'
  location: 'Central US'
  properties: {
    gatewayIpAddress: 'x.x.x.x'
...
```bicep
resource exampleResource 'Microsoft.Network/virtualNetworkTaps@2018-11-01' = {
  name: 'example'
...
VirtualWANCreate
```bicep
resource exampleResource 'Microsoft.Network/virtualWans@2018-11-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
VirtualHubPut
```bicep
resource exampleResource 'Microsoft.Network/virtualHubs@2018-11-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
VpnGatewayPut
```bicep
resource exampleResource 'Microsoft.Network/vpnGateways@2018-11-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    bgpSettings: {
...
```bicep
resource exampleResource 'Microsoft.Network/virtualWans/p2sVpnServerConfigurations@2018-11-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
P2SVpnGatewayPut
```bicep
resource exampleResource 'Microsoft.Network/p2svpnGateways@2018-11-01' = {
  name: 'example'
  location: 'West US'
  properties: {
