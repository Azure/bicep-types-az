...
* **privateIPAllocationMethod**: 'Dynamic' | 'Static': Gets or sets PrivateIP allocation method.
...
* **protocol**: 'Tcp' | 'Udp': Gets or sets the transport protocol for the endpoint. Possible values are Udp or Tcp.
...
* **protocol**: 'Tcp' | 'Udp' (Required): Gets or sets the transport protocol for the endpoint. Possible values are Udp or Tcp.
* **provisioningState**: string: Gets provisioning state of the PublicIP resource Updating/Deleting/Failed
