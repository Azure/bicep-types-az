...
* **protocol**: 'Http' | 'Https' | 'Tcp' | 'Tls' | string: Application Gateway protocol.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The current provisioning state.
...
* **hubRoutingPreference**: 'ASPath' | 'ExpressRoute' | 'VpnGateway' | string: The hub routing preference gateway types
