...
* **privateIPAddressVersion**: 'IPv4' | 'IPv6' (ReadOnly): Gets or sets PrivateIP address version (IPv4/IPv6)
* **privateIPAllocationMethod**: 'Dynamic' | 'Static' (ReadOnly): PrivateIP allocation method (Static/Dynamic)
...
* **protocol**: 'Tcp' | 'Udp' (ReadOnly): Gets or sets the transport protocol for the external endpoint. Possible values are Udp or Tcp
* **provisioningState**: string (ReadOnly): Gets provisioning state of the PublicIP resource Updating/Deleting/Failed
...
* **provisioningState**: string (ReadOnly): Gets provisioning state of the PublicIP resource Updating/Deleting/Failed
* **publicIPAddressVersion**: 'IPv4' | 'IPv6' (ReadOnly): Gets or sets PrivateIP address version (IPv4/IPv6)
* **publicIPAllocationMethod**: 'Dynamic' | 'Static' (ReadOnly): PrivateIP allocation method (Static/Dynamic)
...
### Properties
* **access**: 'Allow' | 'Deny' (ReadOnly): Gets or sets network traffic is allowed or denied. Possible values are 'Allow' and 'Deny'
...
* **direction**: 'Inbound' | 'Outbound' (ReadOnly): Gets or sets the direction of the rule.InBound or Outbound. The direction specifies if rule will be evaluated on incoming or outgoing traffic.
...
* **protocol**: '*' | 'Tcp' | 'Udp' (ReadOnly): Gets or sets Network protocol this rule applies to. Can be Tcp, Udp or All(*).
* **provisioningState**: string (ReadOnly): Gets provisioning state of the PublicIP resource Updating/Deleting/Failed
...
* **nextHopType**: 'Internet' | 'None' | 'VirtualAppliance' | 'VirtualNetworkGateway' | 'VnetLocal' (ReadOnly): Gets or sets the type of Azure hop the packet should be sent to.
* **provisioningState**: string (ReadOnly): Gets provisioning state of the resource Updating/Deleting/Failed
