# microsoft.Compute @ 2016-09-01

## Resource microsoft.Compute/virtualMachineScaleSets/virtualMachines/networkInterfaces@2016-09-01 (ReadOnly)
...
* **protocol**: '*' | 'Tcp' | 'Udp' | string (ReadOnly): The network protocol this rule applies to. Possible values are: 'Tcp', 'Udp', and '*'.
* **provisioningState**: string (ReadOnly): The provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
