...
### Properties
* **auxiliaryMode**: 'Floating' | 'MaxConnections' | 'None' (ReadOnly): Auxiliary mode of Network Interface resource.
...
### Properties
* **adminState**: 'Down' | 'Drain' | 'None' | 'Up' (ReadOnly): A list of administrative states which once set can override health probe so that Load Balancer will always forward new connections to backend, or deny new connections and reset existing connections.
