...
## Resource Microsoft.Compute/locations/placementScores@2026-09-05-preview
...
## Resource Microsoft.Compute/locations/skuMixPlacementScores@2026-09-05-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-09-05-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function generate (Microsoft.Compute/locations/placementScores@2026-09-05-preview)
...
## Function generate (Microsoft.Compute/locations/skuMixPlacementScores@2026-09-05-preview)
...
### Properties
* **limit**: int {minValue: 0} (Required): Upper bound, in VMs, on how much capacity can be allocated for this (VM size, zone): the smallest of
...
* **priority**: 'Regular' | 'Spot' | string (Required): Priority of this entry (Regular or Spot).
* **reason**: 'InsufficientCapacity' | 'InsufficientQuota' | 'None' | 'SkuNotAvailable' | string (Required): Why the limit is below the requested capacity, or None when the request is fully available.
* **zone**: string: Logical zone (e.g. "1", "2", "3"). Omitted or empty for regional requests.
...
### Properties
* **capacityLimits**: [SkuMixPlacementCapacityLimit](#skumixplacementcapacitylimit)[]: Capacity availability for each requested (VM size, zone) combination, independent of the recommended
...
* **id**: string (Required): Unique identifier for this placement response, including responses that contain no placement choices.
