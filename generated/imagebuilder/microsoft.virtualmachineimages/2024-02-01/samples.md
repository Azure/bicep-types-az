...
```bicep
resource exampleResource 'Microsoft.VirtualMachineImages/imageTemplates@2024-02-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.VirtualMachineImages/imageTemplates/triggers@2024-02-01' = {
