...
* **hyperVGeneration**: 'V1' | 'V2' | string (ReadOnly): Specifies the HyperVGeneration Type
...
### Properties
* **vmDiskType**: 'None' | 'Unmanaged' | string (ReadOnly): VM disk types which are disallowed.
