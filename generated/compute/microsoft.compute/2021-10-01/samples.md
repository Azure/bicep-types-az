...
```bicep
resource exampleResource 'Microsoft.Compute/galleries@2021-10-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/galleries/applications@2021-10-01' = {
...
```bicep
resource exampleResource 'Microsoft.Compute/galleries/applications/versions@2021-10-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/galleries/images@2021-10-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/galleries/images/versions@2021-10-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
