...
```bicep
resource exampleResource 'Microsoft.Compute/availabilitySets@2020-12-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/diskAccesses@2020-12-01' = {
  name: 'example'
  location: 'West US'
}
```
...
```bicep
resource exampleResource 'Microsoft.Compute/diskAccesses/privateEndpointConnections@2020-12-01' = {
...
```bicep
resource exampleResource 'Microsoft.Compute/diskEncryptionSets@2020-12-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Compute/disks@2020-12-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    creationData: {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups@2020-12-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/hostGroups/hosts@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/images@2020-12-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    storageProfile: {
...
```bicep
resource exampleResource 'Microsoft.Compute/proximityPlacementGroups@2020-12-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/snapshots@2020-12-01' = {
  name: 'example'
  location: 'West US'
  properties: {
    creationData: {
...
```bicep
resource exampleResource 'Microsoft.Compute/sshPublicKeys@2020-12-01' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines@2020-12-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    hardwareProfile: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachines/runCommands@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets@2020-12-01' = {
  name: 'example'
  location: 'westus'
  properties: {
    overprovision: true
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/extensions@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'extType'
...
```bicep
resource exampleResource 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/runCommands@2020-12-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
