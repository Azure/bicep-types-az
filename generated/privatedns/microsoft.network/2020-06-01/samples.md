...
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones@2020-06-01' = {
  name: 'example'
  location: 'Global'
  tags: {
    key1: 'value1'
...
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/A@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
...
PUT Private DNS Zone A Record Set
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/AAAA@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
...
PUT Private DNS Zone A Record Set
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/CNAME@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
...
PUT Private DNS Zone A Record Set
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/MX@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
...
PUT Private DNS Zone A Record Set
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/PTR@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
...
PUT Private DNS Zone A Record Set
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/SOA@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
...
PUT Private DNS Zone A Record Set
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/SRV@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
...
PUT Private DNS Zone A Record Set
```bicep
resource exampleResource 'Microsoft.Network/privateDnsZones/TXT@2020-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    aRecords: [
