...
### Properties
* **apiVersion**: '2021-01-15' (ReadOnly, DeployTimeConstant)
...
* **userAssignedIdentities**: [Dictionary<string,Schemas131UserAssignedIdentitiesValue>](#dictionarystringschemas131userassignedidentitiesvalue)
...
### Properties
* **kind**: 'Hash' | 'MultiHash' | 'Range' (WriteOnly)
* **paths**: string[] (WriteOnly)
* **systemKey**: bool (ReadOnly, WriteOnly)
