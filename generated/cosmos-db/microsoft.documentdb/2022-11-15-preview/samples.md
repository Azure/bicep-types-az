...
```bicep
resource exampleResource 'Microsoft.DocumentDB/cassandraClusters@2022-11-15-preview' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/cassandraClusters/dataCenters@2022-11-15-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts@2022-11-15-preview' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/views@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    options: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/views/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    resource: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/dataTransferJobs@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/graphs@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbRoleDefinitions@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    databaseName: 'sales'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbUserDefinitions@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/privateEndpointConnections@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/services@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    instanceCount: 1
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/clientEncryptionKeys@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    resource: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    options: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/triggers@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    options: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/userDefinedFunctions@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    options: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlRoleAssignments@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlRoleDefinitions@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'CustomRole'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/tables@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings@2022-11-15-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
