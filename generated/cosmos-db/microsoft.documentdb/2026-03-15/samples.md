...
```bicep
resource exampleResource 'Microsoft.DocumentDB/cassandraClusters@2026-03-15' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/cassandraClusters/dataCenters@2026-03-15' = {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts@2026-03-15' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraRoleAssignments@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/cassandraRoleDefinitions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'CustomRole'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinRoleAssignments@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    principalId: 'myPrincipalId'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/gremlinRoleDefinitions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'CustomRole'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbRoleDefinitions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    databaseName: 'sales'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongodbUserDefinitions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongoMIRoleAssignments@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    principalId: 'myPrincipalId'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/mongoMIRoleDefinitions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'CustomRole'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces@2026-03-15' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/privateEndpointConnections@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/services@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    instanceCount: 1
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/clientEncryptionKeys@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    resource: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    options: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/triggers@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    options: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/userDefinedFunctions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    options: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlRoleAssignments@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    principalId: 'myPrincipalId'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/sqlRoleDefinitions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'CustomRole'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/tableRoleAssignments@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    principalId: 'myPrincipalId'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/tableRoleDefinitions@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    type: 'CustomRole'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/tables@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/fleets@2026-03-15' = {
  name: 'example'
  location: 'West US'
  tags: {
    Dept: 'Finance'
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/fleets/fleetspaces@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dataRegions: [
...
```bicep
resource exampleResource 'Microsoft.DocumentDB/fleets/fleetspaces/fleetspaceAccounts@2026-03-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
