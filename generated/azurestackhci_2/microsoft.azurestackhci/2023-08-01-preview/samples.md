...
Create cluster
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters@2023-08-01-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
Create ArcSetting
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings@2023-08-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings/extensions@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    extensionParameters: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/deploymentSettings@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    arcNodeResourceIds: [
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates/updateRuns@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    progress: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updateSummaries@2023-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create Edge Device
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices@2023-08-01-preview' = {
  name: 'example'
  properties: {
    deviceConfiguration: {
      deviceMetadata: ''
