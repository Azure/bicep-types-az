...
```bicep
resource exampleResource 'Microsoft.FileShares/fileShares@2025-09-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    mediaTier: 'SSD'
...
```bicep
resource exampleResource 'Microsoft.FileShares/fileShares/fileShareSnapshots@2025-09-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.FileShares/fileShares/privateEndpointConnections@2025-09-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
