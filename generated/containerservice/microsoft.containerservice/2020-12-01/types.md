...
* **Additional Properties Type**: schemas:50_provisioningInfo
...
* **autoScalerProfile**: schemas:38_autoScalerProfile
...
* **identityProfile**: Dictionary<string,Schemas50ProvisioningInfo>
...
* **identity**: schemas:49_identity (ReadOnly)
...
* **managedOutboundIPs**: schemas:30_managedOutboundIPs
* **outboundIPPrefixes**: schemas:30_outboundIPPrefixes
* **outboundIPs**: schemas:30_outboundIPs
...
* **provisioningInfo**: schemas:50_provisioningInfo (ReadOnly)
