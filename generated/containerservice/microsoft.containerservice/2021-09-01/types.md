...
## Resource Microsoft.ContainerService/managedClusters@2021-09-01 (Async)
...
## Resource Microsoft.ContainerService/managedClusters/agentPools@2021-09-01 (Async)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2021-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **publicNetworkAccess**: 'Disabled' | 'Enabled': Default value is 'Enabled' (case insensitive). Could be set to 'Disabled' to enable private cluster
