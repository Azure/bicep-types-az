...
* **autoScalerProfile**: [schemas:28_autoScalerProfile](#schemas28autoscalerprofile)
* **diskEncryptionSetID**: string
* **dnsPrefix**: string
* **enablePodSecurityPolicy**: bool
* **enableRBAC**: bool
* **fqdn**: string (ReadOnly)
* **identityProfile**: [Dictionary<string,Schemas28IdentityProfileValue>](#dictionarystringschemas28identityprofilevalue)
...
* **identity**: [schemas:37_identity](#schemas37identity) (ReadOnly)
