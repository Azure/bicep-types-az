...
## Resource Microsoft.ContainerService/managedClusters@2018-03-31 (Async)
...
* **storageProfile**: 'ManagedDisks' | 'StorageAccount' (ReadOnly): Storage profile specifies what kind of storage used. Choose from StorageAccount and ManagedDisks. Leave it empty, we will choose for you based on the orchestrator choice.
...
* **networkPolicy**: 'calico': Network policy used for building Kubernetes network.
