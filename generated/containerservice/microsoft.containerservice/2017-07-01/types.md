...
* **ports**: (int {minValue: 1, maxValue: 65535})[]: Ports number array used to expose on this agent pool. The default opened ports are different based on your choice of orchestrator.
...
### Properties
* **orchestratorType**: 'Custom' | 'DCOS' | 'DockerCE' | 'Kubernetes' | 'Swarm' | string (Required): The orchestrator to use to manage container service cluster resources. Valid values are Kubernetes, Swarm, DCOS, DockerCE and Custom.
