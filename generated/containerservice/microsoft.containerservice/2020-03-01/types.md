...
* **autoScalerProfile**: [schemas:29_autoScalerProfile](#schemas29autoscalerprofile): Parameters to be applied to the cluster-autoscaler when enabled
...
* **identityProfile**: [Dictionary<string,Schemas29IdentityProfileValue>](#dictionarystringschemas29identityprofilevalue): Identities associated with the cluster.
...
* **identity**: [schemas:38_identity](#schemas38identity) (ReadOnly): Information of user assigned identity used by this add-on.
...
* **provisioningState**: string (ReadOnly): The current deployment or provisioning state, which only appears in the response.
* **scaleSetEvictionPolicy**: 'Deallocate' | 'Delete': ScaleSetEvictionPolicy to be used to specify eviction policy for Spot or low priority virtual machine scale set. Default to Delete.
* **scaleSetPriority**: 'Low' | 'Regular' | 'Spot': ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
...
* **managedOutboundIPs**: [schemas:21_managedOutboundIPs](#schemas21managedoutboundips): Desired managed outbound IPs for the cluster load balancer.
* **outboundIPPrefixes**: [schemas:21_outboundIPPrefixes](#schemas21outboundipprefixes): Desired outbound IP Prefix resources for the cluster load balancer.
* **outboundIPs**: [schemas:21_outboundIPs](#schemas21outboundips): Desired outbound IP resources for the cluster load balancer.
