...
* **provisioningState**: string (ReadOnly): The current deployment or provisioning state, which only appears in the response.
* **scaleSetEvictionPolicy**: 'Deallocate' | 'Delete': ScaleSetEvictionPolicy to be used to specify eviction policy for low priority virtual machine scale set. Default to Delete.
* **scaleSetPriority**: 'Low' | 'Regular': ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
...
* **managedOutboundIPs**: [schemas:24_managedOutboundIPs](#schemas24managedoutboundips): Desired managed outbound IPs for the cluster load balancer.
* **outboundIPPrefixes**: [schemas:24_outboundIPPrefixes](#schemas24outboundipprefixes): Desired outbound IP Prefix resources for the cluster load balancer.
* **outboundIPs**: [schemas:24_outboundIPs](#schemas24outboundips): Desired outbound IP resources for the cluster load balancer.

## ResourceReference
### Properties
* **id**: string: The fully qualified Azure resource id.

## schemas:24_managedOutboundIPs
### Properties
