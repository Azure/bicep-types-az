...
* **userAssignedIdentities**: [Dictionary<string,Schemas50ProvisioningInfo>](#dictionarystringschemas50provisioninginfo): The user identity associated with the managed cluster. This identity will be used in control plane and only one user assigned identity is allowed. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.

## Dictionary<string,Schemas50ProvisioningInfo>
### Properties
### Additional Properties
* **Additional Properties Type**: [schemas:50_provisioningInfo](#schemas50provisioninginfo)

## schemas:50_provisioningInfo
### Properties
...
* **autoScalerProfile**: [schemas:38_autoScalerProfile](#schemas38autoscalerprofile): Parameters to be applied to the cluster-autoscaler when enabled
...
* **identityProfile**: [Dictionary<string,Schemas50ProvisioningInfo>](#dictionarystringschemas50provisioninginfo): Identities associated with the cluster.
...
* **identity**: [schemas:49_identity](#schemas49identity) (ReadOnly): Information of user assigned identity used by this add-on.
...
* **kubeletDiskType**: 'OS' | 'Temporary': KubeletDiskType determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage. Currently allows one value, OS, resulting in Kubelet using the OS disk for data. Possible values include: 'OS', 'Temporary'
...
* **osDiskType**: 'Ephemeral' | 'Managed': OS disk type to be used for machines in a given agent pool. Allowed values are 'Ephemeral' and 'Managed'. Defaults to 'Managed'. May not be changed after creation. Possible values include: 'Managed', 'Ephemeral'
...
## PowerState
### Properties
* **code**: 'Running' | 'Stopped': Tells whether the cluster is Running or Stopped. Possible values include: 'Running', 'Stopped'
...
## schemas:38_autoScalerProfile
### Properties
* **balance-similar-node-groups**: string:
* **expander**: 'least-waste' | 'most-pods' | 'priority' | 'random': Possible values include: 'least-waste', 'most-pods', 'priority', 'random'
...
### Properties
* **upgradeChannel**: 'none' | 'patch' | 'rapid' | 'stable': upgrade channel for auto upgrade. Possible values include: 'rapid', 'stable', 'patch', 'none'
...
* **managedOutboundIPs**: [schemas:30_managedOutboundIPs](#schemas30managedoutboundips): Desired managed outbound IPs for the cluster load balancer.
* **outboundIPPrefixes**: [schemas:30_outboundIPPrefixes](#schemas30outboundipprefixes): Desired outbound IP Prefix resources for the cluster load balancer.
* **outboundIPs**: [schemas:30_outboundIPs](#schemas30outboundips): Desired outbound IP resources for the cluster load balancer.

## ResourceReference
### Properties
* **id**: string: The fully qualified Azure resource id.

## schemas:30_managedOutboundIPs
### Properties
...
* **provisioningInfo**: [schemas:50_provisioningInfo](#schemas50provisioninginfo) (ReadOnly):
* **provisioningState**: 'Assigned' | 'Deleting' | 'Failed' | 'Updating' (ReadOnly): The current provisioning state of the pod identity. Possible values include: 'Assigned', 'Updating', 'Deleting', 'Failed'
...
* **licenseType**: 'None' | 'Windows_Server': The licenseType to use for Windows VMs. Windows_Server is used to enable Azure Hybrid User Benefits for Windows VMs. Possible values include: 'None', 'Windows_Server'

## ManagedClusterSKU
### Properties
* **name**: 'Basic': Name of a managed cluster SKU. Possible values include: 'Basic'
* **tier**: 'Free' | 'Paid': Tier of a managed cluster SKU. Possible values include: 'Paid', 'Free'
...
## TimeInWeek
### Properties
* **day**: 'Friday' | 'Monday' | 'Saturday' | 'Sunday' | 'Thursday' | 'Tuesday' | 'Wednesday': A day in a week. Possible values include: 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'
