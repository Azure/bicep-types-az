...
```bicep
resource exampleResource 'NewRelic.Observability/monitors@2022-07-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'NewRelic.Observability/monitors/tagRules@2022-07-01-preview' = {
