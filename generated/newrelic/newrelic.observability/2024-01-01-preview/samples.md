...
```bicep
resource exampleResource 'NewRelic.Observability/monitors@2024-01-01-preview' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'NewRelic.Observability/monitors/tagRules@2024-01-01-preview' = {
