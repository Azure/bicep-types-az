...
* **configurationState**: 'Complete' | 'Incomplete' | string (ReadOnly): The configuration state of the sim resource - complete or incomplete.
...
### Properties
* **ipv4Address**: string: The IPv4 address assigned to the sim at this network scope. This address must be in the userEquipmentStaticAddressPoolPrefix defined in the attachedDataNetwork.
