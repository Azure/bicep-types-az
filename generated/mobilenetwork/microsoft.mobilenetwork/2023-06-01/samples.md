...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks@2023-06-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
Create data network
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/dataNetworks@2023-06-01' = {
...
Create service
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/services@2023-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Create SIM policy
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/simPolicies@2023-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/sites@2023-06-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/slices@2023-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes@2023-06-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes/packetCaptures@2023-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes/packetCoreDataPlanes@2023-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes/packetCoreDataPlanes/attachedDataNetworks@2023-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Create SIM group
```bicep
resource exampleResource 'Microsoft.MobileNetwork/simGroups@2023-06-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
Create SIM
```bicep
resource exampleResource 'Microsoft.MobileNetwork/simGroups/sims@2023-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
