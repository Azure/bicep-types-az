...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks@2024-04-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
Create data network
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/dataNetworks@2024-04-01' = {
...
Create service
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/services@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Create SIM policy
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/simPolicies@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/sites@2024-04-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/mobileNetworks/slices@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes@2024-04-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes/packetCaptures@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes/packetCoreDataPlanes@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.MobileNetwork/packetCoreControlPlanes/packetCoreDataPlanes/attachedDataNetworks@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
Create SIM group
```bicep
resource exampleResource 'Microsoft.MobileNetwork/simGroups@2024-04-01' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
Create SIM
```bicep
resource exampleResource 'Microsoft.MobileNetwork/simGroups/sims@2024-04-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
