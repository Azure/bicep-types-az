...
Create a peer ASN
```bicep
resource exampleResource 'Microsoft.Peering/peerAsns@2020-04-01' = {
  name: 'example'
  properties: {
    peerAsn: 65000
    peerContactDetail: [
...
```bicep
resource exampleResource 'Microsoft.Peering/peerings@2020-04-01' = {
  name: 'example'
  kind: 'Direct'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Peering/peeringServices@2020-04-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
