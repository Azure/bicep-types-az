...
Create a peer ASN
```bicep
resource exampleResource 'Microsoft.Peering/peerAsns@2022-01-01' = {
  name: 'example'
  properties: {
    peerAsn: 65000
    peerContactDetail: [
...
```bicep
resource exampleResource 'Microsoft.Peering/peerings@2022-01-01' = {
  name: 'example'
  kind: 'Direct'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Peering/peeringServices/connectionMonitorTests@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Peering/peeringServices/prefixes@2022-01-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
