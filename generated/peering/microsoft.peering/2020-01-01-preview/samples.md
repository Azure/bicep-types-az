...
Create a peer ASN
```bicep
resource exampleResource 'Microsoft.Peering/peerAsns@2020-01-01-preview' = {
  name: 'example'
  properties: {
    peerAsn: 65000
    peerContactDetail: [
...
```bicep
resource exampleResource 'Microsoft.Peering/peerings@2020-01-01-preview' = {
  name: 'example'
  kind: 'Direct'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Peering/peerings/registeredAsns@2020-01-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Peering/peerings/registeredPrefixes@2020-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Peering/peeringServices@2020-01-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Peering/peeringServices/prefixes@2020-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
