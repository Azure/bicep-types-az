...
## Resource Microsoft.KubernetesConfiguration/extensions@2022-11-01
...
## Resource Microsoft.KubernetesConfiguration/fluxConfigurations@2022-11-01
* **Valid Scope(s)**: Extension
### Properties
* **apiVersion**: '2022-11-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.KubernetesConfiguration/sourceControlConfigurations@2022-11-01
* **Valid Scope(s)**: Extension
### Properties
* **apiVersion**: '2022-11-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## AzureBlobDefinition
### Properties
* **accountKey**: string {secure}: The account key (shared key) to access the storage account
...
* **sasToken**: string {secure}: The Shared Access token to access the storage container
...
### Properties
* **clientCertificate**: string {secure}: Base64-encoded certificate used to authenticate a Service Principal
* **clientCertificatePassword**: string {secure}: The password for the certificate used to authenticate a Service Principal
...
* **clientSecret**: string {secure}: The client secret for authenticating a Service Principal
