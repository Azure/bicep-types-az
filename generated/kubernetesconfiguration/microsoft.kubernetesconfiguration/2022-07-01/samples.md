...
Create Extension
```bicep
resource exampleResource 'Microsoft.KubernetesConfiguration/extensions@2022-07-01' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.KubernetesConfiguration/fluxConfigurations@2022-07-01' = {
  name: 'example'
  properties: {
    gitRepository: {
...
```bicep
resource exampleResource 'Microsoft.KubernetesConfiguration/sourceControlConfigurations@2022-07-01' = {
  name: 'example'
  properties: {
    configurationProtectedSettings: {
