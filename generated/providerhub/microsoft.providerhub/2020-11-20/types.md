...
### Properties
* **apiVersion**: '2020-11-20' (ReadOnly, DeployTimeConstant)
* **error**: [schemas:9_error](#schemas9error) (ReadOnly)
* **id**: string (ReadOnly, DeployTimeConstant)
* **name**: string (Required, DeployTimeConstant)
...
* **specification**: [schemas:1_canary](#schemas1canary) (ReadOnly)
* **status**: [schemas:1_canary](#schemas1canary) (ReadOnly)
...
* **innerError**: [schemas:8_innerError](#schemas8innererror) (ReadOnly)
...
### Properties
* **code**: string (ReadOnly)
* **innerError**: [schemas:7_innerError](#schemas7innererror) (ReadOnly)
