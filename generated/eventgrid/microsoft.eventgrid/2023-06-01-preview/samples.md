...
```bicep
resource exampleResource 'Microsoft.EventGrid/domains@2023-06-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
    inboundIpRules: [
...
```bicep
resource exampleResource 'Microsoft.EventGrid/domains/eventSubscriptions@2023-06-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/domains/privateEndpointConnections@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/domains/topics/eventSubscriptions@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/eventSubscriptions@2023-06-01-preview' = {
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces@2023-06-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/caCertificates@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/clientGroups@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/clients@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/permissionBindings@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
PrivateEndpointConnections_Update
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/privateEndpointConnections@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/topics@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/topics/eventSubscriptions@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/namespaces/topicSpaces@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    topicTemplates: [
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerConfigurations@2023-06-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerDestinations@2023-06-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerNamespaces@2023-06-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerNamespaces/channels@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
PrivateEndpointConnections_Update
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerNamespaces/privateEndpointConnections@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerRegistrations@2023-06-01-preview' = {
  name: 'example'
  location: 'global'
  tags: {
    key1: 'value1'
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerTopics@2023-06-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerTopics/eventSubscriptions@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/systemTopics@2023-06-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/systemTopics/eventSubscriptions@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/topics@2023-06-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
    inboundIpRules: [
...
```bicep
resource exampleResource 'Microsoft.EventGrid/topics/eventSubscriptions@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
PrivateEndpointConnections_Update
```bicep
resource exampleResource 'Microsoft.EventGrid/topics/privateEndpointConnections@2023-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
