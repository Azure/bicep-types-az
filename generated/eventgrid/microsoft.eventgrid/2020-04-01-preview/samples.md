...
```bicep
resource exampleResource 'Microsoft.EventGrid/domains@2020-04-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
    inboundIpRules: [
...
```bicep
resource exampleResource 'Microsoft.EventGrid/domains/privateEndpointConnections@2020-04-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/eventSubscriptions@2020-04-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerNamespaces@2020-04-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerNamespaces/eventChannels@2020-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerRegistrations@2020-04-01-preview' = {
  name: 'example'
  location: 'global'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/partnerTopics/eventSubscriptions@2020-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/systemTopics@2020-04-01-preview' = {
  name: 'example'
  location: 'westus2'
  tags: {
    tag1: 'value1'
...
```bicep
resource exampleResource 'Microsoft.EventGrid/systemTopics/eventSubscriptions@2020-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    destination: {
...
```bicep
resource exampleResource 'Microsoft.EventGrid/topics@2020-04-01-preview' = {
  name: 'example'
  location: 'westus2'
  properties: {
    inboundIpRules: [
...
PrivateEndpointConnections_Update
```bicep
resource exampleResource 'Microsoft.EventGrid/topics/privateEndpointConnections@2020-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    privateLinkServiceConnectionState: {
