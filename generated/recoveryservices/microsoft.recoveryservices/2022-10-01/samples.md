...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/certificates@2022-10-01' = {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults@2022-10-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
