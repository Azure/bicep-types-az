...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults@2024-09-30-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/certificates@2024-09-30-preview' = {
