...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts@2018-07-01-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/agreements@2018-07-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/assemblies@2018-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/batchConfigurations@2018-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/certificates@2018-07-01-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/maps@2018-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/partners@2018-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/schemas@2018-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'westus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Logic/integrationAccounts/sessions@2018-07-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    content: {
...
```bicep
resource exampleResource 'Microsoft.Logic/workflows@2018-07-01-preview' = {
  name: 'example'
  location: 'brazilsouth'
  properties: {
    definition: {
