...
Create a new server
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers@2024-12-30' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/administrators@2024-12-30' = {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/advancedThreatProtectionSettings@2024-12-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Disabled'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/configurations@2024-12-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a database
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/databases@2024-12-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
    charset: 'utf8'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/firewallRules@2024-12-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/privateEndpointConnections@2024-12-30' = {
  parent: parentResource 
  name: 'example'
  properties: {
