...
Create a new server
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers@2025-06-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/administrators@2025-06-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/advancedThreatProtectionSettings@2025-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Disabled'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/configurations@2025-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a database
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/databases@2025-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    charset: 'utf8'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/firewallRules@2025-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/privateEndpointConnections@2025-06-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
