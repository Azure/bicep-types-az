...
Create a new server
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers@2025-12-01-preview' = {
  name: 'example'
...
Create a server with lower case table names
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers@2025-12-01-preview' = {
  name: 'example'
  location: 'southeastasia'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/administrators@2025-12-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/advancedThreatProtectionSettings@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    state: 'Disabled'
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/configurations@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a database
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/databases@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    charset: 'utf8'
...
## microsoft.dbformysql/flexibleservers/fabricmirroringsettings

Create Or Update a server's Fabric Mirroring settings.
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/fabricMirroringSettings@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/firewallRules@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.DBforMySQL/flexibleServers/privateEndpointConnections@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
