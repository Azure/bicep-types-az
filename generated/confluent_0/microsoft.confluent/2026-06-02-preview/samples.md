...
```bicep
resource exampleResource 'Microsoft.Confluent/agreements@2026-06-02-preview' = {
  name: 'example'
  properties: {
    accepted: true
...
```bicep
resource exampleResource 'Microsoft.Confluent/organizations@2026-06-02-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Confluent/organizations/environments@2026-06-02-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Confluent/organizations/environments/clusters@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  kind: 'eroxushslwhufo'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Confluent/organizations/environments/clusters/connectors@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    connectorBasicInfo: {
...
```bicep
resource exampleResource 'Microsoft.Confluent/organizations/environments/clusters/topics@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    configs: {
...
```bicep
resource exampleResource 'Microsoft.Confluent/organizations/environments/networkGateways@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    dictionary: [
...
```bicep
resource exampleResource 'Microsoft.Confluent/organizations/environments/networkGateways/accessPoints@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
