...
```bicep
resource exampleResource 'Microsoft.DataMigration/services@2018-03-31-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.DataMigration/services/projects/tasks@2018-03-31-preview' = {
