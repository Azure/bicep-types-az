...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices@2020-03-01' = {
  name: 'example'
  location: 'WestUS'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/privateEndpointConnections@2020-03-01' = {
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/registeredServers@2020-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
SyncGroups_Create
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups@2020-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups/cloudEndpoints@2020-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups/serverEndpoints@2020-03-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cloudTiering: 'off'
