...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices@2019-10-01' = {
  name: 'example'
  location: 'WestUS'
  tags: {
  }
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/registeredServers@2019-10-01' = {
...
SyncGroups_Create
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups@2019-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups/cloudEndpoints@2019-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups/serverEndpoints@2019-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cloudTiering: 'off'
