...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices@2019-03-01' = {
  name: 'example'
  location: 'WestUS'
  tags: {
  }
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/registeredServers@2019-03-01' = {
...
SyncGroups_Create
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups@2019-03-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups/cloudEndpoints@2019-03-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.StorageSync/storageSyncServices/syncGroups/serverEndpoints@2019-03-01' = {
  parent: parentResource 
  name: 'example'
