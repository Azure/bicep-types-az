...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets@2026-06-01' = {
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/autoUpgradeProfiles@2026-06-01' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/managedNamespaces@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/members@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create an UpdateRun.
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/updateRuns@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/updateStrategies@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    strategy: {
