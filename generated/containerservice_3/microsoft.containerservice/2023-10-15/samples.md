...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets@2023-10-15' = {
  name: 'example'
  location: 'East US'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/members@2023-10-15' = {
...
Create an UpdateRun.
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/updateRuns@2023-10-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/fleets/updateStrategies@2023-10-15' = {
  parent: parentResource 
  name: 'example'
  properties: {
    strategy: {
